...
<div id="hidemenudesktop" class="style-of-all-menu display-none-mo">
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/PAKIJ/ل هات پوینت.webp" alt="تعمیرات پکیج هات پوینت">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی پکیج هات پوینت 
        </h1>
        ...
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات پکیج هات پوینت</p>
        ...
        (پکیج، پکیج، یخچال، ماکروویو، جاروبرقی و پکیج) هات پوینت در خدمت شماست.
        <br>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/PAKIJ/001.webp" alt="تعمیرات پکیج هات پوینت">
        <br><br>

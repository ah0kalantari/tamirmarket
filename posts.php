...
<head>
    ...
    <title> تعمیرات لباسشویی سانیاران سرویس | saniaran service Washing Machine repair</title>
</head>
<body class="styles-of-body-tag">
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/lebasshooee/ل الجی.jpg" alt="تعمیرات لباسشویی ال جی">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی ماشین لباسشویی ال جی 
        </h1>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/LG.png"                    alt="سانیاران سرویس"></a></div>    
        <br>
        <h2 class="style-of-moarefi-shoql">
            عضو رسمی اتحادیه تعمیرکاران لوازم خانگی
        </h2>
        <br>
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لباسشویی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لباسشویی ال‌جی</p>
        ...
        <br><br>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/LG 2.png"                    alt="سانیاران سرویس"></a></div>    
        <br><br>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <p class="about-brand-text">
            ...
            قرار دادن پوشاک داخل آب به تنهایی باعث تمیزی آن نمی‌شود بلکه آب باید با فشار به الیاف‌های پارچه برخورد کند. اکثر ماشین‌های لباسشویی با چرخاندن لباس درون غلطک‌های فلزی پرآب این کار را انجام می‌دهند. جهت نفوذ عمیق‌تر آب درون پارچه و نیز زدودن چربی‌ها و لکه‌ها از مواد شوینده مخصوص ماشین لباسشویی استفاده می‌شود.[۱]
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/WM/001.png" alt="تعمیرات لباسشویی ال جی">
        <br><br>
        ...
        <p class="style-of-mazit-estfade-az-ma-text">  2) اشکالاتی در لاستیک دور در ماشین لباسشویی مشاهده می شود </p>
        <p class="style-of-mazit-estfade-az-ma-text">  3) و...خرابی در سه نظام‌، بلبرینگ‌، کاسه نمد‌، ،شیلنگ های داخلی ماشین لباسشویی، هیدروستات</p>
        <p class="style-of-mazit-estfade-az-ma-text">  4) پاره شدن تسمه ماشین لباسشویی</p>
        <p class="style-of-mazit-estfade-az-ma-text">  5) بسته نشدن درب ماشین لباسشویی</p>
        <p class="style-of-mazit-estfade-az-ma-text">  6) خوب شسته نشدن لباس ها در ماشین لباسشویی</p>
        <p class="style-of-mazit-estfade-az-ma-text">  7) صدای بیش از حد لباسشویی در دور خشک کن</p>
        <p class="style-of-mazit-estfade-az-ma-text">  8) تکان ها و صدا های شدید لباسشویی در زمان انجام دادن کار های معمولی</p>
        <p class="style-of-mazit-estfade-az-ma-text">  9) خرابی تایمر ماشین لباسشویی</p>
        <p class="style-of-mazit-estfade-az-ma-text">  10) قفل و باز نشدن درب ماشین لباسشویی</p>    
        <p class="style-of-mazit-estfade-az-ma-text">  11) روشن نشدن ماشین لباسشویی</p>
        <p class="style-of-mazit-estfade-az-ma-text">  12) نچرخیدن دیگ داخلی ماشین لباسشویی</p>
        <p class="style-of-mazit-estfade-az-ma-text">  13) 
        به محض حرکت دادن ولوم به‌طرف بیرون، لامپ خبر روشن‌شده اما ماشین آبگیری نمی‌کند
        </p>
        <p class="style-of-mazit-estfade-az-ma-text">  14) 
        لباسشویی عمل آبگیری را به اتمام رسانده، اما عملیات بعدی انجام نمی‌شود

        </p>
        <p class="style-of-mazit-estfade-az-ma-text">  15) 
        درحالی‌که ماشین خاموش است، با باز شدن شیر آب، ماشین شروع به آبگیری می‌کند

        </p>
        <p class="style-of-mazit-estfade-az-ma-text">  16) 
        لباسشویی مرتباً در حال آبگیری است و عمل آبگیری قطع نمی‌شود

        </p>
        <p class="style-of-mazit-estfade-az-ma-text">  17) 
        علت نشت آب از ماشین لباسشویی در حین کار

        </p>
        <p class="style-of-mazit-estfade-az-ma-text">  18) 
        Heater لباسشویی آب را گرم نمی‌کند

        </p>
        <p class="style-of-mazit-estfade-az-ma-text">  19) 
        لباسشویی آبگیری کرده اما موتور شستشو کار نمی‌کند

        </p>
        <p class="style-of-mazit-estfade-az-ma-text">  20) 
        لباسشویی عمل شستشو را انجام می‌دهد اما آب کثیف تخلیه نمی‌شود

        </p>
        <p class="style-of-mazit-estfade-az-ma-text">  21) 
        دور تند ماشین عمل نمی‌کند و درنتیجه آب لباس‌ها گرفته نمی‌شود

        </p>
        <p class="style-of-mazit-estfade-az-ma-text">  22) 
        علت حرکت زیاد ماشین لباسشویی به هنگام شستشوی لباس

        </p>
        <p class="style-of-mazit-estfade-az-ma-text">  23) 
        علت صدای زیاد ماشین لباسشویی به هنگام کار

        </p>
        <p class="style-of-mazit-estfade-az-ma-text">  24) 
    ...
    <div class="display-none-mo">
        <div class="style-of-ItemTamirat-radif style-of-ItemTamirat-radif-in-brand-page dtngjdfjiogdrjiogfyhsei">
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/WM/1.png"       alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/WM/2.png"        alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/WM/3.png"             alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/WM/4.png"            alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/WM/8.png"            alt="سانیاران سرویس">
            </div>
        </div>
        <br><br>
        <div class="style-of-ItemTamirat-radif style-of-ItemTamirat-radif-in-brand-page dtngjdfjiogdrjiogfyhsei">
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/WM/5.png"       alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/WM/6.png"        alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/WM/7.png"             alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/WM/9.png"            alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/WM/10.png"            alt="سانیاران سرویس">
            </div>
        </div>
    </div>

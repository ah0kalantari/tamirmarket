...
<div id="hidemenudesktop" class="style-of-all-menu display-none-mo">
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/PAKIJ/ل برفاب.webp" alt="تعمیرات پکیج برفاب">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی پکیج برفاب 
        </h1>
        ...
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات پکیج برفاب</p>
        ...
        (پکیج، پکیج، یخچال، ماکروویو، جاروبرقی و پکیج) برفاب در خدمت شماست.
        <br>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/PAKIJ/001.webp" alt="تعمیرات پکیج برفاب">
        <br><br>

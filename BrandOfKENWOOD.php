...
<head>
    ...
    <title> تعمیرات لوازم خانگی کنوود | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی کنوود 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/KENWOOD.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی کنوود</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) کنوود در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی کنوود را در مدل ها و محصولات مختلف کنوود، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/KENWOOD.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/KENWOOD/factory1.png" alt="کارخانه ی کنوود">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/KENWOOD/factory2.png" alt="کارخانه ی کنوود">
        </div>
        <p class="about-brand-title">درباره شرکت کنوود</p>
        <p class="about-brand-text">
       
  کنوود، (به انگلیسی: Kenwood) شرکت الکترونیکی ژاپنی است، (به ژاپنی: 株式会社ケンウッド) که دفتر مرکزی آن، در منطقه
  هاچی‌اوجی شهر توکیو، ژاپن قرار دارد.

  شرکت کنوود، تولیدکننده انواع رادیو آماتورها، تلویزیونها، کولرها، دستگاه‌های های-فای و بسیاری از تجهیزات صوتی
  می‌باشد.<div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/KENWOOD.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت کنوود</p>
        <p class="about-brand-text">
        
  در سال ۲۰۰۸، این شرکت با جی وی سی ادغام شده و شرکت جی وی سی کنوود کورپوریشن را تأسیس کردند.
  کنوود جایگاه قابل قبولی در بازار داره و در سطح جهانی به عنوان یکی از رهبران بازار در صنعت لوازم خانگی شناخته
  شده. البته به صورت محدود. کنوود راه حل‌های خلاقانه ای برای مشتریان در زمینه لوازم خانگی خانه و آشپزخانه ایجاد
  کرده.، از آغاز کار بر تحویل محصولات با کیفیت بالا و با طراحی‌های خلاقانه تمرکز کرده که در آن جنبه‌های مهندسی و
  طراحی برجسته است از جمله ماشین لباسشویی، یخچال، فریزر و لوازم آشپزخانه منحصر به فرد نسبت به دیگر برندهای موجود
  در بازار.

  امروزه، ما در شرایط نوآوری و فن آوری محصولات را گسترش میدهیم زیرا هدف نهایی ما این است که مصرف کنندگان ما یک
  زندگی سالم با وسایل دوستدار محیط زیست داشته باشند.
  پیشرفت دوره ای کنوود

  1947: در این سال "کنث وود" یک شرکت ایجاد کرد، شرکت کنوود در گاراژی در جنوب لندن شروع به کار کرد. از آن زمان،
  تمام طراحی محصول و مرکز عملیات در انگلستان واقع شده. اولین محصول کنوود که ارائه شد محصولی به نام A100 بود، یک
  توستر با توانایی هوشمند بیرون انداختن نان تست.

  1950: او یک "سرآشپز کنوود" اختراع کرد. این اختراع در واقع یک دستیار آشپز بود که با سیستمی غیرمعمول تجهیز شده
  بود: سه خروجی، که هرکدوم سرعت قدرتی متفاوتی داشتند، و قابلیت تهیه بی نهایت رسپی خوشمزه در زمان خیلی کم داشتند!
  کنوود خیلی زود توانست به یک متخصص تهیه غذا تبدیل شود.

  1962: کنوود به هاوانت در نزدیکی پورتسموث انگلستان رفت، تا امکانات بیشتری برای تولید تجهیزات آشپزخانه داشته باشد،
  سرآشپز کنوود حالا به موفقیت‌های جهانی رسیده است.

  1989: در یک کارخانه در چین سرمایه‌گذاری کرد (تریکوم).

  1993: گروه کنوود با خریدن Waymaster در سال بعد توسعه و گسترش پیدا کرد، Waymaster یک کارخانه ایتالیایی محصولات
  تولیدکننده بخار بود.

  1997: الان شرکت بیش از 80 توزیع‌کننده بین‌المللی داره. متأسفانه آقای کنث وود در سن 81 سالگی درگذشت.

  2001: کنوود جزئی از گروه دلونگی شد که در حال تقویت تولیدات، سرمایه‌گذاری برای محصولات جدید و حتی بیشتر
  سرمایه‌گذاری درتجارت بین‌الملل بود.

  2009: کنوود ماشین سرآشپز را اختراع کرد. اولین ماشین آشپزی با یک المنت گرماساز القایی که داخل دستگاه کار شده بود،
  و همزمان کار مخلوط کردن و پخت رو انجام می‌داد.

  2014: کنوود مفهوم Chef (سرآشپز) را با روشی جدید در ارتباط با مشتریان بکار می‌گیرد. که بیشتر با احساس آن‌ها
  سروکار دارد، این که یک دستگاه آشپزخانه چه کمکی می‌تواند بکند. همانطور که در اصول برند بیان شده، Kenwood می‌خواهد
  به عنوان رهبر بازار جهانی در آماده سازی غذا شناخته شود.

  ماموریت ما این است که، محبوب‌ترین و تحسین شده‌ترین برند در تجهیزات آماده سازی غذا باشیم .

  تا کنون کنوود موقعیت های تحسین برانگیز فراوانی را داشته ؛ که منجر به راهیابی در سطح جهانی و هم در سطح منطقه ای و
  در بسیاری از دسته بندی‌های لوازم خانگی کوچک شده است . در کنوود ما با افتخار، لوازم خانگی شیک و کارآمد و کارساز
  را از سال 1974 طراحی و تولید می‌کنیم.

  به عنوان متخصص در امر آماده سازی غذا، تمرکز ما بر این است که لذت شما رو در آشپزی ارتقا بدیم، تا با راحتی بیشتر
  بهترین نتایج با کیفیت را بگیرید. از هر کدام از محصولات کنوود که استفاده کنید می‌توانید مطمئن باشید همیشه غذایی
  عالی خواهید داشت.
  این شرکت در زمینه لوازم برقی و لوازم خانگی بزرگ فعالیت دارد. برخی از تولیدات این شرکت مانند:ظبط اتوموبیل(صوتی و
  تصویری) لباسشویی، یخچال فریزر، ماکروویو، جاروبرقی و لوازم خانگی خرد مانند: غذاساز، مخلوط کن و.....
</p>
    </div>
    <div class="left">

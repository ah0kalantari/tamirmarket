...
<head>
    ...
    <title> تعمیرات لوازم خانگی کندی | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی کندی 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/CANDY.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی کندی</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) کندی در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی کندی را در مدل ها و محصولات مختلف کندی، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/CANDY.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/CANDY/factory1.png" alt="کارخانه ی کندی">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/CANDY/factory2.png" alt="کارخانه ی کندی">
        </div>
        <p class="about-brand-title">درباره شرکت کندی</p>
        <p class="about-brand-text">
            شرکت “کندی” از بزرگترین تولید کننده های لوازم خانگی است که برای بازار داخلی ایتالیا محصولاتش را عرضه و تولید میکرده است. این شرکت زیر مجموعه هایر میباشد(Haier Home Appliance) ؛ لوازم خانگی کندی در خارج از مرزهای ایران، بیشتر با تبلیغات مداوم آن با برندهای هوور(Hoover) و کلوینیتور(Kelvinator) شناخته میشود. بیش از ۸۰درصد محصولات تولیدی کندی در خارج از ایتالیا به فروش میرسد. دفتر تحقیق و توسعه(یا همان R&D) آن در حال حاضر در ایتالیا مستقر است.
        </p>
    </div>
    <div class="left">

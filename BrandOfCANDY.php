...
<body class="styles-of-body-tag">
    ...
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/CANDY.webp""                    alt="تعمیر مارکت"></a></div>    
    <div class="right">
        ...
        <br><br>
            ...
            <div class="style-of-ItemTamirat-radif">
                <a href="RepairWashingMachineOfCANDY.php">
                ...
                <div class="style-of-ItemTamirat-radif">
                <a href="RepairMicrowaveOfCANDY.php">
                <div class="rotate-ItemTamirat-img style-of-ItemTamirat-div">
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/CANDY.webp"                    alt="تعمیر مارکت"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/CANDY/factory1.webp" alt="کارخانه ی کندی">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/CANDY/factory2.webp" alt="کارخانه ی کندی">
        </div>
        ...
        <img class="style-of-left-ra" src="img/left/orginal.webp" alt="chatre sabz">
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> چرا برخی ظروف استیل در ماشین ظرفشویی آبی می شوند ؟
                            </p>
                        </a>
                    </div>
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> ماشین ظرفشویی چه مقدار آب مصرف می کند ؟
                            </p>
                        </a>
                    </div>
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> بهترین ماشین ظرفشویی قابل حمل
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> طریقه چیدن ظروف داخل ماشین ظرفشویی | همراه با عکس
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> ویژگی های ماشین ظرفشویی و اهمیت آن ها  </p>
                        </a>
                    </div>
            ...
            <tr>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> یخ زدایی با مایکروفر چیست ؟ </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> علت زنگ زدگی و سوراخ شدن کف ماشین ظرفشویی
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> خشک کردن ظروف در ماشین ظرفشویی به وسیله ی حرارت یا هوا </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> مزایای فر های بدون المنت پایینی و قابل رویت </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> نحوه راه اندازی کمپرسور کولرگازی با خازن شوک </p>
                        </a>
                    </div>

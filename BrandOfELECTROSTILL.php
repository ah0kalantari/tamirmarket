...
<head>
    ...
    <title> تعمیرات لوازم خانگی الکترواستیل | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی الکترواستیل 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ELECTROSTILL.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی الکترواستیل</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) الکترواستیل در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی الکترواستیل را در مدل ها و محصولات مختلف الکترواستیل، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ELECTROSTILL.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/ELECTROSTILL/factory1.png" alt="کارخانه ی الکترواستیل">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/ELECTROSTILL/factory2.png" alt="کارخانه ی الکترواستیل">
        </div>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ELECTROSTILL.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت الکترواستیل</p>
        <p class="about-brand-text">
            شرکت الکترواستیل با سابقه بیش از 50 سال در امر تولید محصولات مختلف برودتی فعال می باشد. در حال حاضر این شرکت در فضایی بالغ بر 200000 (دویست هزار) متر مربع و با 100000 (صد هزار) متر مربع سالن های تولید و انبار و بیش از 3000 (سه هزار) نفر نیروی کار قادر به تولید سالانه 30000 (سی هزار) عدد انواع یخچال، سردخانه، فریزرهای صنعتی و 500000 (پانصد هزار) عدد یخچال و فریزر خانگی می باشد. لازم به ذکر است که شرکت الکترواستیل دارای مجوز ها و اختراعات و... می باشد که این امتیاز ها به شرح ذیل اعلام می گردد:

            - دارای اداره مستقل مهندسی و R&D با 60 (شصت) عضو دائم و فعال.
            - دارای اختراعات بیشمار در زمینه تولید لوازم خانگی (همچنان که الکترواستیل سه اختراع جدید در 6 ماه گذشته به ثبت رسانده است.) 
            - تنها دارنده مجوز آزمایشگاه اکرودیته صنعتی و خانگی در شرق کشور مجهز به آخرین تکنولوژی روز دنیا جهت آزمایش محصولات مختلف خانگی و صنعتی با 17 (هفده) ایستگاه مختلف.
            - طراحی و تولید اواپراتور ها و کندانسور ها با به روزترین و جدیدترین نرم افزار ها و ماشین آلات در داخل شرکت الکترواستیل و توسط زیر مجموعه های شرکت الکترواستیل (حامی صنعت و نگین صنعت) تولید می شود.</p>
    </div>
    <div class="left">

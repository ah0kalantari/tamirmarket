...
<head>
    ...
    <title>تعمیرات کولرگازی جنرال الکتریک | تعمیر مارکت</title>
</head>
<body class="styles-of-body-tag">
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/AIR/ل جنرال الکتریک.jpg" alt="تعمیرات کولرگازی جنرال الکتریک">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی کولرگازی جنرال الکتریک 
        </h1>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/GENERAL ELECTRICE.png"                    alt="تعمیر مارکت"></a></div>    
        <br>
        <h2 class="style-of-moarefi-shoql">
        ...
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات کولرگازی جنرال الکتریک</p>
        ...
        <br><br>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/GENERAL ELECTRICE 2.png"                    alt="تعمیر مارکت"></a></div>    
        <br><br>
        ...
        (کولرگازی، کولرگازی، یخچال، ماکروویو، جاروبرقی و کولرگازی) جنرال الکتریک در خدمت شماست.
        <br>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/AIR/001.png" alt="تعمیرات کولرگازی جنرال الکتریک">
        <br><br>
...
<tr>
    <td class="style-of-footer-td">
        <p class="style-of-footer-asli-title">شرکت آداک <span class="color-green">تعمیر مارکت</span> تعمیرگر</p>
    </td>
    <td class="style-of-footer-td">

...
<head>
    ...
    <title> تعمیرات ساید بای ساید | تعمیر مارکت</title>
</head>
<body class="styles-of-body-tag">
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/sbs/ل جنرال الکتریک.webp" alt="تعمیرات ساید بای ساید جنرال الکتریک">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی ساید بای ساید جنرال الکتریک 
        </h1>
        ...
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات ساید بای ساید جنرال الکتریک</p>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/WM/001.webp" alt="تعمیرات ساید بای ساید جنرال الکتریک">
        <br><br>
        <p class="about-brand-title">مشکلات رایج انواع ساید بای ساید</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) نشتی آب در ساید بای ساید</p>
        <p class="style-of-mazit-estfade-az-ma-text">  2) اتومات نکردن ساید بای ساید</p>
        <p class="style-of-mazit-estfade-az-ma-text">  3) برفک زدن ساید بای ساید</p>
        <p class="style-of-mazit-estfade-az-ma-text">  4) سرد شدن بیش از حد ساید بای ساید</p>
        <p class="style-of-mazit-estfade-az-ma-text">  5) گرم شدن بیش از حد ساید بای ساید</p>
        <p class="style-of-mazit-estfade-az-ma-text">  6) وجود سر و صدای بیش از اندازه در ساید بای ساید</p>
        <p class="style-of-mazit-estfade-az-ma-text">  7) روشن نشدن لامپ ساید بای ساید</p>
    </div>
    <div class="left">
    ...
    <div class="display-none-mo">
        <div class="style-of-ItemTamirat-radif style-of-ItemTamirat-radif-in-brand-page dtngjdfjiogdrjiogfyhsei">
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/1.webp"       alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/2.webp"        alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/3.webp"             alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/4.webp"            alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/8.webp"            alt="تعمیر مارکت">
            </div>
        </div>
        <br><br>
        <div class="style-of-ItemTamirat-radif style-of-ItemTamirat-radif-in-brand-page dtngjdfjiogdrjiogfyhsei">
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/5.webp"       alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/6.webp"        alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/7.webp"             alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/9.webp"            alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/10.webp"            alt="تعمیر مارکت">
            </div>
        </div>
    </div>

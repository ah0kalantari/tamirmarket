...
<body class="styles-of-body-tag" onscroll="hide_menu_desktop()">
    ...
    <table class="blog-etelaat display-none-pc">
        ...
        <tr>
            <p class="test-shode">تست شده توسط تیم بررسی صحت محتوای تعمیر مارکت</p>
        </tr>
        <tr>
            <p class="pish-sardabir">پیشنهاد شده توسط سر دبیر تعمیر مارکت</p>
        </tr>
    </table>
    <br>
    <img class="style-of-orginal-brand-image" src="img/blog/9005/1.webp" alt="تعمیرات کولرگازی ارج">
    <br>   
    <br> 
        <p class="blog-text-p">
        در این مقاله از تیم توسعه و تولید محتوای تعمیر مارکت با برد الکترونیکی و کاربرد های این قطعه و موارد مشابه آشنا خواهید شد . 
        </p>
        <br>
        ...
        <br>
        <p class="blog-text-p">
            همان طور که احتمالا می دانید برد الکترونیکی را مغز دستگاه می نامیم 
                <br>
            این قطعه وظیفه مدیریت کار های یک دستگاه را بر عهده دارد .
        </p>
        <br>
        ...
        <p id="fehrest-blog"  class="fehrest-titr">فهرست</p>
            <ul id="bbvbsm1" class="ol-fehrest-blog">
                <li>
                    <a class="text-decoration-none text-color-darkblue-5" href="#f-1">برد الکترونیکی چیست ؟</a> 
                </li>
                <li>
                    <a class="text-decoration-none text-color-darkblue-5" href="#f-2">کاربرد های برد الکترونیکی در صنایع مختلف</a> 
                </li>
                <li>
                    <a class="text-decoration-none text-color-darkblue-5" href="#f-3">انواع برد الکترونیکی</a> 
                </li>
            </ul>
...
‍        <br>
        ...
        <p id="mataleb-pish" class="fehrest-titr text-color-red-5">مطالب پیشنهادی</p>
            <ul id="bbvbsm2" class="ol-fehrest-blog">
                <li>
                    <a class="text-decoration-none text-color-darkblue-5" href="9005.php">چرا برد الکترونیکی ماشین لباسشویی خراب می شود ؟</a> 
                </li>
            </ul>

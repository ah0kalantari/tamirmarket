...
<head>
    ...
    <title> تعمیرات لوازم خانگی ویرپول | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی ویرپول 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/WHIRLPOOL.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی ویرپول</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) ویرپول در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی ویرپول را در مدل ها و محصولات مختلف ویرپول، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/WHIRLPOOL.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/WHIRLPOOL/factory1.png" alt="کارخانه ی ویرپول">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/WHIRLPOOL/factory2.png" alt="کارخانه ی ویرپول">
        </div>
        <p class="about-brand-title">درباره شرکت ویرپول</p>
        <p class="about-brand-text">
       
  ویرپول، (به انگلیسی: Whirlpool) شرکت لوازم خانگی آمریکایی و چندملیتی است، که در زمینه تولید و عرضه وسایل الکترونیکی خانگی و تجاری فعالیت می‌نماید. این شرکت از سال ۲۰۰۶ در پی پیشی گرفتن از شرکت سوئدی الکترولوکس، به‌عنوان بزرگترین تولیدکننده لوازم خانگی جهان شناخته می‌شود.<div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/WHIRLPOOL.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت ویرپول</p>
        <p class="about-brand-text">
        
  شرکت ویرپول در سال ۱۹۱۱ توسط لوئیز آپتون در سنت. جوسف، میشیگان تأسیس شد و در حال حاضر دارای ۷۰ کارخانه تولیدی و مرکز تحقیق و توسعه در سراسر جهان بوده و مالک بیش از ۸۰ برند معتبر در حوزه لوازم برقی خانگی می‌باشد، که برای نمونه می‌توان به: شرکت هوور، مِی‌تگ، آدمیرال، امانا، جان اینگلس و کیچن‌اِید اشاره کرد.

  دفتر مرکزی این شرکت در شهر بنتون چارتر تاونشیپ، میشیگان قرار دارد و سهام آن در بازار بورس نیویورک معامله می‌شود. شرکت ویرلپول در سال ۲۰۱۳ در فهرست فرچون ۵۰۰ در رتبه ۱۳۲ از بزرگترین شرکت‌های ایالات متحده قرار گرفت.</p>
    </div>
    <div class="left">

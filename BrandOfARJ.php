...
<head>
    ...
    <title> تعمیرات لوازم خانگی ارج | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی ارج 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ARJ.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی ارج</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) ارج در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی ارج را در مدل ها و محصولات مختلف ارج، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ARJ.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/ARJ/factory1.png" alt="کارخانه ی ارج">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/ARJ/factory2.png" alt="کارخانه ی ارج">
        </div>
        <p class="about-brand-title">درباره شرکت ارج</p>
        <p class="about-brand-text">
  
            ارج یک سازنده محصولات لوازم خانگی در کشور ایران است. این شرکت از سال ۱۳۱۶ مشغول به تولید شد و با قدمتی ۷۹ ساله قدیمی‌ترین سازنده لوازم خانگی ایران است که در آغاز کارهای آهنگری، ریخته‌گری و جوشکاری انجام می‌داد و همچنین صندلی‌های تاشو نیز تولید می‌کرد. در دهه ۱۳۵۰ فعالیتش گسترش یافت و به تولید لوازم خانگی، از جمله یخچال، بخاری، ماشین لباس‌شویی و کولر نیز رو آورد. تا سال ۱۳۵۷، ارج تعداد کارکنانش را به نزدیک سه هزار ارجر افزایش داد و به بزرگ‌ترین کارخانه صنعتی خاورمیانه تبدیل شد. پس از انقلاب ۱۳۵۷، در جریان مصادره اموال و دارایی‌ها، این کارخانهٔ متعلق به خانواده ارجمند، بابت مشکلات پیش‌آمدۀ پس از انقلاب به سازمان صنایع ملی ایران منقل گردید. این کارخانه به مرور دچار ضرر و زیان شد و در دهه ۷۰ با یک اختلاس ۲۰ میلیارد تومانی نیز مواجه شد و پس از مشکلات دیگری که به وجود آمد، نهایتاً در روز ۲۴ خرداد ۱۳۹۵ با پلمب قضایی انبار ارج، این کارخانه ۷۹ ساله رسماً تعطیل شد.

            طی واگذاری‌های اصل ۴۴، این کارخانه و دارایی‌های آن که به گفته هاشمی -مدیر کل دفتر صنایع فلزی و لوازم خانگی وزارت صنعت- فقط زمین و سوله کارخانه بوده مقرر بوده واگذار بشود که فرایند واگذاری مدتی طولانی شده و نهایتاً واگذاری آن قطعی شد. گفته می‌شود شرکت ارج بعد واگذاری در حال مذاکره با تولیدکنندگان لوازم خانگی خارجی برای شروع مجدد تولید است. درسال۱۳۹۷سهام عمده شرکت توسط گروه سرمایه‌گذاری توسعه ملی از طریق مزایده به فروش گذاشته شد و گروه صنعتی آریاوا با برنده شدن مزایده مالک سهام عمده شرکت ارج گردید. 
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ARJ.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت ارج</p>
        <p class="about-brand-text">
            
  کارخانه ارج در سال ۱۳۱۶ در یک کارگاه کوچک واقع در خیابان سی متری تهران به اتفاق ۸ کارگر ساده با هدایت خلیل ارجمند، استاد دانشکده فنی دانشگاه تهران، به صنایع غیردولتی ایران پیوست. پس از درگذشت خلیل ارجمند، مدیریت این کارخانه تا انقلاب اسلامی، بر عهده برادران ارجمند قرار گرفت و توانست به موفقیت‌های چشم‌گیری برسد. پس از انقلاب کارخانهٔ ارج،بابت بدهی به سازمان صنایع ملی ایران منتقل گردید و پس از آن به سوی ورشکستگی قدم‌ها را به سرعت برداشت.

  این شرکت در دهه ۷۰ با یک اختلاس ۲۰ میلیارد تومانی هم مواجه شد. در پی مشکلات مالی، کارخانه ارج رو به سقوط گذاشت تا سرانجام در روز ۲۴ خرداد ۱۳۹۵ با پلمب قضایی انبار ارج، پس از ۷۹ سال به‌طور رسمی تعطیل شد و میان سهام‌داران متعدد دست به دست گشت. 
        </p>
    </div>
    <div class="left">

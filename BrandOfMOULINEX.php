...
<head>
    ...
    <title> تعمیرات لوازم خانگی مولینکس | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی مولینکس 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/MOULINEX.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی مولینکس</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) مولینکس در خدمت شماست.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/MOULINEX.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/MOULINEX/factory1.png" alt="کارخانه ی مولینکس">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/MOULINEX/factory2.png" alt="کارخانه ی مولینکس">
        </div>
        <p class="about-brand-title">درباره شرکت مولینکس</p>
        <p class="about-brand-text">

            در اوایل دهه 1960 ژان مانتوله چند خردکن برقی مولینکس را به آمریکا فرستاد. و پاسخ نماینده ی آمریکایی در جواب این بود: این خردکن های فرانسوی مولینکس برای مردم فرانسه جذاب هستند و برای سلیقه مردم آمریکا جذاب نیست و تنها شکل ظاهریش است که باعث میشود این محصول در آمریکا به فروش نرسد! او به مانتوله پیشنهاد داد که از یک طراح خلاق و واقعی استفاده کند. پیشنهادی که باعث شد مولینکس در بازارهای جهانی محبوب شود.

            مولینکس در طی چندین دهه فعالیت خود از رنگ های قهوه ای، نارنجی، سفید و قرمز استفاده کرده است که هر کدام از رنگ ها  بیانگر نوعی پیام به مصرف کننده است. از آن زمان به بعد محصولات مولینکس مورد توجه و سلیقه عموم مردم قرار گرفت و در بازار عرضه گردید. و همین طور به ایران هم راه پیدا کرد و مورد توجه مردم ایران نیز قرار گرفت.
            
            لوازم خانگی مولینکس در ایران
            در ایران مولینکس فعالیتش را با شرکت بدرسان الکتریک شروع کرد، که این شرکت در طی سال های متوالی از فعالیتش به عنوان نماینده انحصاری توزیع، فروش و خدمات پس از فروش لوازم خانگی مولینکس، کروپس، توشیبا و تک الکتریک در ایران است. که محصولات را با ضمانت نامه بدر عرضه میکند. همچنین این شرکت برای رضایت و راحتی مشتری، فروشگاه اینترنتی بدر 24 را راه اندازی کرد تا  کالای مولینکس را در کم ترین زمان و با مناسب ترین بسته بندی به صورت رایگان در سراسر ایران به دست مشتری برساند.
            
            ضمانت نامه بدر 
            شرکت بدرسان الکتریک در تلاش است با گسترش نمایندگی خدمات  پس از فروش در سراسر کشور موجب رضایت مشتریان شوند.
            شما می توانید با خرید کالای مولینکس با ضمانت بدر، علاوه بر اصالت کالا، از  18 ماه ضمانت بدر و 10 سال خدمات پس از فروش مولینکس بهره مند شوید.
    <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/MOULINEX.png""                    alt="سانیاران سرویس"></a></div>
    </div>
    <div class="left">

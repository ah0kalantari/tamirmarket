...
<head>
    ...
    <title> تعمیرات لوازم خانگی هارد استون | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی هارد استون 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/HARDSTONE.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی هارد استون</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) هارد استون در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی هارد استون را در مدل ها و محصولات مختلف هارد استون، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/HARDSTONE.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/HARDSTONE/factory1.png" alt="کارخانه ی هارد استون">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/HARDSTONE/factory2.png" alt="کارخانه ی هارد استون">
        </div>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/HARDSTONE.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت هارد استون</p>
        <p class="about-brand-text">
             تاریخچه و بیوگرافی شرکت لوازم خانگی هاردستون HARDSTONE
             شرکت هاردستون در سال ۲۰۰۱ میلادی در دو بخش لوازم خانگی کوچک و بزرگ تاسیس و شروع به فعالیت نمود. از محصولات هاردستون که در همان اوایل در بازار لوازم خانگی عرضه شد میتوان به محصولات ذیل اشاره کرد.
  
             آرام پزهاردستون– چرخ گوشت هاردستون – جاروبرقیهاردستون– غذاسازهاردستون – سرخ کن هاردستون – گرم و سرد نگهدارنده هاردستون – پلوپزهاردستون – آبمیوه گیریهاردستون– محصولات آرایشی هاردستون – لوازم بهداشتی هاردستون– ماشین لباسشویی هاردستون– ماشین ظرفشویی هاردستون– اجاق گازهاردستون– یخچال فریزر هاردستون– مایکروویو هاردستون – توستر هاردستون و اتو هاردستون اشاره کرد. البته اخیرا محصولات لوازم خانگی هاردستون گسترش یافته و تلویزیون و کولر گازی نیز به این سبد اضافه گردیده است.
  
             هاردستون ساخت کجاست – HARDSTONE
             در واقع اگر صریح موضوع را شفاف سازی کنم، شرکت لوازم خانگی هاردستون هیچگونه کارخانه ای برای تولید لوازم خانگی ندارد و در عمل یک شرکت بازرگانی می باشد که با ثبت برند لوازم خانگی، محصولات خود را از دیگر کارخانه ها و وارد کننده ها تامین کرده و با برند هاردستون وارد بازار می نماید. به عنوان مثال من یک برند لوازم خانگی ثبت میکنم به نام اریسون. بعد از انجام این کار میتوانم با یک قرارداد کاری با کارخانه های لوازم خانگی واقع در ایران یا خارج، کلیه محصولات خود را با برند اریسون تامین کرده و بدون هیچ مشکلی و به طور قانونی وارد بازار کنم. اما اینکه هاردستون، محصولات خود را از داخل یا خارج از کشور تامین می کند، اخباری در دست نیست و به طور قاطع نمی توان گفت هاردستون به صورت ۱۰۰ درصد ساخت کجاست.
  
             کیفیت و قیمت لوازم خانگی هاردستون
             اما اگر کیفیت محصولات هاردستون به همراه قیمت را بخواهیم مورد نقد و بررسی قرار دهیم. میتوانیم ذکر کنیم، هدف این شرکت ارائه ی کالاهای لوکس و با تکنولوژی بالا می باشد که اگر گذری به قیمت برخی از محصولات هاردستون بزنید متوجه این موضوع خواهید شد. در واقع کیفیت لوازم خانگی هاردستون میتواند متفاوت باشد به دلیل اینکه با کارخانه های گوناگون و متفاوتی همکاری دارد ولی این نکته را باید مد نظر داشت، هاردستون بخاطر دریافت رضایت کامل مشتریان و ارائه یک برند خوب و مطمئن در ذهن افراد، تلاش می نماید تا با بهترین کارخانه های تولیدی لوازم خانگی همکاری نماید پس نباید زیاد نگران این موضوع بود. اما شاید از دید برخی از افراد، قیمت لوازم خانگی هاردستون نسبتا تند به نظر برسد، ولی این تصور اشتباه می باشد چرا که قیمت بر اساس کیفیت قطعات و تکنولوژی بکار رفته در محصول می باشد. در کل اگر قصد خرید لوازم خانگی هاردستون Hardstone را دارید، این برند میتواند یک خرید ایده آل برای منزل شما باشد.
        </p>
    </div>
    <div class="left">

...
<body class="styles-of-body-tag">
    ...
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ARISTON.webp""                    alt="تعمیر مارکت"></a></div>    
    <div class="right">
        ...
        <br><br>
            ...
            <div class="style-of-ItemTamirat-radif">
                <a href="RepairWashingMachineOfARISTON.php">
                ...
                <div class="style-of-ItemTamirat-radif">
                <a href="RepairMicrowaveOfARISTON.php">
                <div class="rotate-ItemTamirat-img style-of-ItemTamirat-div">
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ARISTON.webp"                    alt="تعمیر مارکت"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/ARISTON/factory1.webp" alt="کارخانه ی آریستون">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/ARISTON/factory2.webp" alt="کارخانه ی آریستون">
        </div>
        <p class="about-brand-title">درباره شرکت آریستون</p>
        <p class="about-brand-text">
       
  Ariston Thermo SpA یک شرکت ایتالیایی است که سیستم های گرمایشی و محصولات مرتبط را تولید می کند و عمدتا تحت مارک های Ariston ، Chaffoteaux ، Elco ، Racold ، Régent ، Atag ، NTI ، HTP ، Cuenod ، Ecoflam و Thermowatt به بازار عرضه می شود.<div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ARISTON.webp""                    alt="تعمیر مارکت"></a></div>
        ...
        <img class="style-of-left-ra" src="img/left/orginal.webp" alt="chatre sabz">
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> مزایای یخچال فریزر با فریزر پایین
                            </p>
                        </a>
                    </div>
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> مزایا و معایب یخچال درب فرانسوی 
                            </p>
                        </a>
                    </div>
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> قرار دادنمیوه در بخش رطوبتی یخچال
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> تفاوت بین جاروبرقی بدون کیسه و جاروبرقی کیسه دار
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> آموزش تعمیر موتور جاروبرقی </p>
                        </a>
                    </div>
            ...
            <tr>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> بخار پز کردن سبزیجات تازه در ماکروویو | آموزش های جالب  </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> مقایسه اجاق گازی و برقی 
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> راهکار های کاهش مصرف برق ماشین لباسشویی </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> سه توصیه برای نگهداری و جلوگیری از خرابی یخچال فریزر </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> طریقه نگهداری تازه مواد غذایی در یخچال فریزر </p>
                        </a>
                    </div>

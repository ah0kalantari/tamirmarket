...
<body class="styles-of-body-tag">
    ...
    <div id="slider">
        <div class="slide activate">
            <img src="img/slide show/MIC/1.jpg" alt="تعمیرات ماشین ماکروفر (مایکرویو) در استان های تهران و البرز">
        </div>

        <div class="slide">
            <img src="img/slide show/MIC/2.jpg" alt="تعمیرات ماشین ماکروفر (مایکرویو) در استان های تهران و البرز">
        </div>
    ...
    <div class="right">
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/MIC/00001.png" alt="تعمیرات ماکروفر (مایکرویو) ال جی">
        <br><br>
        <p class="about-brand-text">

...
<head>
    ...
    <title> تعمیرات یخچال تعمیر مارکت | Tamir Market Washing Machine repair</title>
</head>
<body class="styles-of-body-tag">
                                             ...
                                             <ul>
                                                <li class="style-of-menu-text-in-mo" onclick="displayOfZirMenuInMo2()"><a>لوازم خانگی</a><hr class="white-hr">
                                                    <ul id="display-of-zir-menu-in-mo2" class="display-of-zir-menu-in-mo2">
                                                        <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="RepairRefrigerator.php">   ساید بای ساید</a></li><hr class="white-hr">
                                                        ...
                                                        <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="RepairDishwasher.php">   ظرفشویی</a></li><hr class="white-hr">
    ...
    <div id="slider">
        <div class="slide activate">
            <img src="img/slide show/SBS/1.webp" alt="">
        </div>

        <div class="slide">
            <img src="img/slide show/SBS/2.webp" alt="">
        </div>

        <div class="slide">
            <img src="img/slide show/SBS/3.webp" alt="">
        </div>
    ...
    <h1 class="animation-of-title-brand">
        تعمیرات تخصصی انواع ساید بای ساید 
    </h1>
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات ساید بای ساید  تعمیر مارکت :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات انواع ساید بای ساید</p>
        <p class="style-of-mazit-estfade-az-ma-text">  2) استفاده از لوازم و قطعات اصلی (اورجینال ) در تعمیرات ساید بای ساید </p>
        ...
        <br><br>
            ...
            <br>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfLG.php">             <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/LG.webp"                    alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfSAMSUNG.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/SAMSUNG.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfDAEWOO.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/DAEWOO.webp"                alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfSNOWA.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/SNOWA.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfPARS.php">           <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PARS.webp"                  alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfBEHI.php">           <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/BEHI.webp"                  alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfAEG.php">            <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/AEG.webp"                   alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfBOSCH.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/BOSCH.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfSIEMENC.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/SIEMENC.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfKENWOOD.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/KENWOOD.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfINDESIT.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/INDESIT.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfCANDY.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/CANDY.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfARJ.php">            <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ARJ.webp"                   alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfHIMALIA.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HIMALIA.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfSEPEHRELECTRICE.php"><img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/SEPEHR ELECTRICE.webp"      alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfPAKSHOOMA.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PAKSHOOMA.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfEMERSAN.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/EMERSAN.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfHAIER.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HAIER.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfYAKHSARAN.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/YAKHSARAN.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfBARFAB.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/BARFAB.webp"                alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfBEKO.php">           <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/BEKO.webp"                  alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfELECTROLUX.php">     <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ELECTROLUX.webp"            alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfPHIVER.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PHILVER.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfSHARP.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/SHARP.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfMOULINEX.php">       <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/MOULINEX.webp"              alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfPANASONIC.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PANASONIC.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfHARDSTONE.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HARDSTONE.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfPHILIPS.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PHILIPS.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfCORAL.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/CORAL.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfTOSHIBA.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/TOSHIBA.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfKENMORE.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/KENMORE.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfHOOVER.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HOOVER.webp"                alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfZANUSSI.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ZANUSSI.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfZEROWATT.php">       <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ZEROWATT.webp"              alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfGENERALELECTRIC.php"><img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/GENERAL ELECTRIC.webp"      alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfBAUKNECHT.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/BAUKNECHT.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfMIDEA.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/MIDEA.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfWHIRLPOOL.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/WHIRLPOOL.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfFAGOR.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/FAGOR.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfHOTPOINT.php">       <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HOTPOINT.webp"              alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfVESTEL.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/VESTEL.webp"                alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfARISTON.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ARISTON.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfMABE.php">           <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/MABE.webp"                  alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfGORENJE.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/GORENJE.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfPHILCO.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PHILCO.webp"                alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfWESTINGHOUSE.php">   <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/WESTINGHOUSE.webp"          alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfAZMAYESH.php">       <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/AZMAYESH.webp"              alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfELECTROSTILL.php">   <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ELECTROSTILL.webp"          alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfOGENERAL.php">       <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/OGENERAL.webp"              alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfHYUNDAI.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HYUNDAI.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfMAGIC.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/MAGIC.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfADMIRAL.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ADMIRAL.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfAMANA.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/AMANA.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairSideBySideOfTEFAL.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/TEFAL.webp"                 alt="تعمیر مارکت"></a></div>
            <br><br><br>
        ...
        <br><br>
        <p class="about-brand-title">کار هایی برای پیشگیری از خراب شدن   ساید بای ساید </p>
        <p class="about-brand-text">
            ...
            <br><br>
            6) اگر برای اولین بار است که ساید بای ساید خود را روشن میکنید یا ساید بای ساید شما مدت زمانی است که کار نکرده است، دمای آن را روی حالت متوسط قرار دهیم.</p>
    
        <p class="about-brand-title">درباره ساید بای ساید</p>
        <p class="about-brand-text">
        ...
        <br><br>
        <p class="about-brand-title">انواع   ساید بای ساید</p>
        <div class="style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/0001.webp"       alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/0002.webp"        alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/0003.webp"             alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/0004.webp"            alt="تعمیر مارکت">
         </div>
        <br><br>
        <p class="about-brand-title">ساختار داخلی  ساید بای ساید</p>
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/SBS/00001.webp" alt="تعمیرات ساید بای ساید ال جی">
        <br><br>
        <p class="about-brand-text">
            هر یخچال به صورت پایه دارای: کمپرسور، کندانسور، اواپراتور و گاز و ترموستات، موتورفن، ترموفیوز، ترمودیسک، المنتدر بعضی مدل‌ها برد فرمان با تایمر است. هریک از این‌ها جزو لاینفک وسایل سرماساز هستند که در صورت نبود هریک این فرایند امکانپذیر نمی‌باشد.
        </p>
        <br><br>
        <p class="about-brand-title">کمپرسور ساید بای ساید چیست ؟</p>
        <div class="style-of-ItemTamirat-radif style-of-ItemTamirat-radif-in-brand-page">
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/Q/1.webp"       alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/Q/2.webp"        alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/Q/3.webp"             alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/Q/4.webp"            alt="تعمیر مارکت">
            </div>
        </div>
        <p class="about-brand-text">
            کمپرسور یخچال خانگی از دو بخش الکتریکی و مکانیکی تشکیل گردیده‌است که هر دو قسمت درون محفظه‌ای فولادی قرار دارند.

            قسمت الکتریکی در اغلب یخچال‌های خانگی یک الکتروموتور از نوع آسنکرون می‌باشد که وظیفهٔ به حرکت درآوردن قسمت مکانیکی را به عهده دارد. البته در سال‌های اخیر کمپرسورهای ساید بای سایدها هم تغییرات زیادی داشته‌اند؛ و قسمت الکتریکی آن اینورتری یا موتور خطی شده‌اند.
            ...
            مقدار مشخصی از روغنی که مخصوص این کار ساخته شده داخل پوسته وجود دارد که وظیفهٔ روانکاری و خنک‌کردن قسمت الکتریکی و مکانیکی را بر عهده دارد.</p>
        <br><br>
        <p class="about-brand-title">اواپراتور ساید بای ساید چیست ؟</p>
        <div class="style-of-ItemTamirat-radif style-of-ItemTamirat-radif-in-brand-page">
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/SBS/5.webp "       alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/SBS/6.webp"        alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/SBS/7.webp"             alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/SBS/8.webp"            alt="تعمیر مارکت">
            </div>
        </div>
        <br><br>
        <p class="about-brand-text">
            کار اواپراتور به این صورت است زمانی که گاز مبرد توسط موتور وارد کندانسور می‌شود و متراکم می‌شود تحت فشار بالا از حالت گاز به مایع تبدیل می‌شود و وارد درایر(drier) یا خشک کن و سپس وارد لوله موئی یا کاپیلاری تیوپ می‌شود و این باعث می‌شود که فشار کاهش پیدا کند. سپس وارد اواپراتور می‌شود. یک سر اواپراتور به سر لوله موئی و سر دیگر اواپراتور به ساکشن موتور متصل می‌باشد و زمانی که ساکشن اتفاق می‌افتد باعث می‌شود که سطح فشار داخل اواپراتور پایین بیاید و مبرد به جوشش در بیاید واز حالت مایع آرام آرام به گاز تبدیل شود و این تبخیر باعث ایجاد سرما و برودت می‌شود. در اصل اواپراتور یک تبخیرکننده است.</p>
        <br><br>
        <p class="about-brand-title">برد الکترونیکی ساید بای ساید چیست ؟</p>
        <div class=" style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/SBS/1.webp"       alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/SBS/2.webp"        alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/SBS/3.webp"             alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/SBS/4.webp"            alt="تعمیر مارکت">
         </div>
        <p class="about-brand-text">
            وظیفه اصلی انواع برد ساید بای ساید کنترل و نظارت بر عملکرد دستگاه می باشد 
            برد ساید بای ساید قطعه‌ای حساس و تاثیرگذار در تنظیمات قطعات وابسته به آن در ساید بای ساید به حساب می‌آید.      
        <br><br>
        <br><br>
        <p class="about-brand-title">فیلتر ساید بای ساید چیست ؟</p>
        <div class=" style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/SBS/9.webp"       alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/SBS/10.webp"        alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/SBS/11.webp"             alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/SBS/12.webp"            alt="تعمیر مارکت">
         </div>
        <p class="about-brand-text">
            فیلتر یخچال ساید بر اساس مدل و نوع یخچال باید تهیه شود و هر یک از این فیلترهای ساید تفاوت‌هایی با یکدیگر دارند ولی برای برخی از انواع یخچال‌ها که فیلتر تصفیه آب داخلی ندارند، برخی از کارشناسان می‌توانند فیلتر بیرونی تعبیه نمایند. البته در صورتی که فیلتر ساید بای ساید شما از نوع قدیمی‌تر باشد و یا آلودگی زیادی در آب مصرفی شما وجود داشته باشد، می‌توانید از یک فیلتر ساید بیرونی هم برای کمک به فیلتر داخلی استفاده نمایید.
            فیلتر یخچال ساید بای ساید بیرونی خیلی به نوع و برند یخچال ارتباطی ندارد و یک متخصص تعمیر و یا تعویض فیلتر ساید می‌تواند به راحتی هر یک از فیلترهای بیرونی را برای یخچال ساید شما تعبیه نماید. معمولاً فیلتر ساید بای ساید باید در هر شش ماه یک بار تعویض شود و این موضوع به داخلی و بیرونی بودن فیلتر ارتباطی ندارد. عدم تعویض فیلتر ساید بای ساید باعث می‌شود باکتری‌ها در این فیلترها رشد کرده و نه تنها باعث بهبود آب آشامیدنی و سلامت بیشتر افراد خانواده نمی‌شود، بلکه خود عاملی برای بیماری خواهد بود و در ضمن به یاد داشته باشید این موضوع تداخل در فرآیند تصفیه آب ایجاد خواهد کرد و باعث می‌شود تا سیستم داخلی یخچال آسیب جدی ببیند.

            فیلتر یخچال ساید بای ساید در دو نوع می‌باشد: نوع اول از فیلترهای با جنس پلی‌پروپیلن است. این نوع فیلتر ساید بای ساید برای تصفیه محلولات جامد و سخت در آب مانند گل و لای، آهک، آرسنیک، جلبک و سایر رسوبات دیگر آب استفاده می‌شود که اصلی‌ترین مواد آسیب‌زا برای یخچال هستند. نوع دوم فیلتر ساید بای ساید از نوع کربن فعال می‌‌باشد. فیلتر کربن فعال علاوه بر حذف انواع مواد شیمیایی مانند سموم و شوینده‌ها، آفت‌کش‌ها، کلر و... بوی بد آب را از بین می‌برد و طعم و مزه‌ای مناسب برای آب آشامیدنی فراهم می‌کند. تمامی فیلترهای یخچال ساید بای ساید که در داخل یخچال استفاده می‌شوند، از نوع فیلتر کربن فعال هستند.
        <br><br>
        <p class="about-brand-title">تاریخچه یخچال در ایران</p>
        <p class="about-brand-text">
            حدود ۱۷۰۰ سال پیش از میلاد پادشاهی ایرانی دستور ساخت نخستین یخچال عمومی را داد. این یخچال یک بنای معماری متشکل از یک استخر، دیواری بلند به نام حصار در ضلع جنوبی و مخزنی گنبدی شکل به نام خزانه بود. حصار به گونه ای ساخته می‌شد که در فصول سرد سال یعنی موعد یخسازی تمام روز بر روی استخر سایه می‌افکند و از گرم شدن آب یخزدهٔ استخر جلوگیری می‌کرد. سپس یخ تشکیل شده در استخر یخچال را شکسته و در انبار ذخیره می‌کردند. این یخ‌های ذخیره شده در فصول گرم سال مورد استفاده قرار می‌گرفتند. این یخ‌ها تا فصل سرمای بعدی دوام می‌آوردند. یخچال سازی در ایران بر دو اصل عایق بندی هوشمندانه و سازگاری با طبیعت استوار بود.</p>
        <br><br>
        <p class="about-brand-title">کندانسور ساید بای ساید چیست؟</p>
        <div class=" style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/SBS/13.webp"       alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/SBS/14.webp"        alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/SBS/15.webp"             alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/SBS/16.webp"            alt="تعمیر مارکت">
         </div>
        <p class="about-brand-text">
            کندانسور (به انگلیسی: Condenser) (چگالنده) قسمتی از سیستم است که وظیفه خنک‌سازی سیال عامل و عمدتاً تبدیل بخار به مایع را بر عهده دارد. در واقع گاز فریون بس از فشرده شدن توسط کمپرسور در کندانسور خنک شده و تبدیل به مایع می‌گردد. در یخچال‌های خانگی معمولاً به صورت شبکه‌ای لوله‌ای بر روی دیواره پشت یخچال نصب شده‌است و در یخچال‌های بزرگ فروشگاهی معمولاً شبیه رادیاتور اتوموبیل است که اغلب از یک فن جهت بهبود فرایند میعان نیز استفاده شده‌است.</p>
        <br><br>
        <p class="about-brand-title">گاز یا ماده مبرد</p>
        <div class="style-of-ItemTamirat-radif style-of-ItemTamirat-radif-in-brand-page">
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/Q/17.webp"       alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/Q/18.webp"        alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/Q/19.webp"             alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/RG/Q/20.webp"            alt="تعمیر مارکت">
            </div>
        </div>
        <p class="about-brand-text">
            در یخچال‌های اولیه از گاز آمونیاک (NH3) به عنوان گاز مبرد استفاده می‌شد، اما به علت عوارض ناگوار آن در برخورد با بدن انسان، ترکیب شدن حالت مرطوب آن با مس و آلمینیوم، و نیز خاصیت انفجاری‌اش، و خطر خفگی ان برای انسان، رفته‌رفته از گاز فریون به جای آن استفاده گشت. در یخچال‌های رایج امروزی معمولاً از فریون ۱۲ با ترکیب CCl2F2 استفاده می‌شود که گازی بی‌بو است و حتی در صورت ترکیب شدن با رطوبت موجب خوردگی فلزات نمی‌شود؛ همچنین فریون قابل اشتعال نیست. از معایب استفاده از فریون در یخچال‌ها می‌توان به حجم زیاد آن‌ها در مقایسه با آمونیاک، و تخریب لایه اوزون و ایجاد اثر گلخانه‌ای اشاره کرد. با توجه به این معایب تلاش‌هایی برای یافتن گازهای جایگزین فریون به عمل آمده که گاز جدیدی به نام 134A و مبرد هیدروکربن R600 حاصل آن است. در کولرهای گازی از فریون ۲۲ استفاده می‌شود که به علت دارا بودن هیدروژن، اثر تخریبی آن در لایهٔ اوزون به مراتب کمتر از فریون‌های ۱۱ و ۱۲ است. بعد از کار با گازهای R134 و R12، مشکلاتی مانند راندمان پایین، نیاز به تعمیر یخچال، قیمت بالا، مقدار زیاد مورد استفاده در مسیر برودتی یخچال و غیره باعث شد گاز ارزان و خطرناک R600 (ایزوبوتان) با راندمان بالا جایگزین گاز قبل بشود؛ و برای کولر گازی‌ها به جای R22، از گاز R410 , R407 استفاده مکنند. مبردهای یخچال و کولر گازی به دو دسته کلی تقسیم می‌شوند از نظر ترکیب مولکولی. گازهای قدیمی مثل R12,R22,R134 همگی از یک نوع مولکول هستند؛ ولی گازهای جدید مثل R600,R410,R436,R407 همگی از چند نوع گاز تشکیل شده‌اند و موقع شارژ گاز باید به صورت مایع شارژ شوند تا میزان ورودی به ساید بای ساید یا کولر گازی متعادل باشد</p>
        <br><br>
        <p class="about-brand-title">معرفی انواع ساید بای ساید بر اساس طراحی و کاربری</p>
        <p class="about-brand-text">

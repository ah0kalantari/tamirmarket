...
<body class="styles-of-body-tag">
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/MIC/ل الکترواستیل.jpg" alt="تعمیرات کولرگازی الکترواستیل">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی مایکروویو الکترواستیل 
        </h1>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/ELECTROSTILL.png"                    alt="سانیاران سرویس"></a></div>    
        <br>
        <h2 class="style-of-moarefi-shoql">
        ...
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات مایکروویو الکترواستیل</p>
        ...
        <br><br>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/ELECTROSTILL 2.png"                    alt="سانیاران سرویس"></a></div>    
        <br><br>
        ...
        (مایکروویو، مایکروویو، یخچال، ماکروویو، جاروبرقی و مایکروویو) الکترواستیل در خدمت شماست.
        <br>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/MIC/001.png" alt="تعمیرات مایکروویو الکترواستیل">
        <br><br>

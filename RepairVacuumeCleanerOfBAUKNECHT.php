...
<body class="styles-of-body-tag">
                                         ...
                                         <ul id="style-of-zirmenu-of-tamirat" class="style-of-zirmenu-of-tamirat">
                                            <li onmouseover="showzirmajmoee2()" onmouseout="hidezirmajmoee2()" class="style-of-sdf background-color-0e4797-hover"><a class="style-of-text-of-zirmenus style-of-sdf"  >لوازم خانگی</a>
                                                <ul id="style-of-zirmenu-of-tamirat2" class="style-of-zirmenu-of-tamirat2" class="style-of-all-of-zirmajmoee">
                                                    <li class="style-of-sdf"><a class="style-of-text-of-zirmenus style-of-sdf" href="RepairWashingMachine.php"> جاروبرقی</a></li>
                                             ...
                                             <ul>
                                                <li class="style-of-menu-text-in-mo" onclick="displayOfZirMenuInMo2()"><a>لوازم خانگی</a><hr class="white-hr">
                                                    <ul id="display-of-zir-menu-in-mo2" class="display-of-zir-menu-in-mo2">
                                                        <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="RepairWashingMachine.php"> جاروبرقی</a></li><hr class="white-hr">
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/VC/ل آدمیرال.webp" alt="تعمیرات جاروبرقی آدمیرال">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی جاروبرقی آدمیرال 
        </h1>
        ...
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات جاروبرقی آدمیرال</p>
        ...
        (جاروبرقی، جاروبرقی، یخچال، ماکروویو، جاروبرقی و جاروبرقی) آدمیرال در خدمت شماست.
        <br>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/VC/001.webp" alt="تعمیرات جاروبرقی آدمیرال">
        <br><br>
    ...
    <div class="display-none-mo">
        <div class="style-of-ItemTamirat-radif style-of-ItemTamirat-radif-in-brand-page dtngjdfjiogdrjiogfyhsei">
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/1.webp"       alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/2.webp"        alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/3.webp"             alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/4.webp"            alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/8.webp"            alt="تعمیر مارکت">
            </div>
        </div>
        <br><br>
        <div class="style-of-ItemTamirat-radif style-of-ItemTamirat-radif-in-brand-page dtngjdfjiogdrjiogfyhsei">
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/5.webp"       alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/6.webp"        alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/7.webp"             alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/8.webp"            alt="تعمیر مارکت">
            </div>

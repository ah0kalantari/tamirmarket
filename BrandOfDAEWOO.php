...
<br><br><br><br><br>
        <img id="first-logo" class="display-inline styles-of-first-logo-in-all-pages-1" src="img/firstlogo/لوگوی تعمیر مارکت.webp"             alt="Tamir Market تعمیر مارکت">
   ...
   <br>
    ...
    <div  id="slider">
        <div class="slide activate">
            <img src="img/slide show/1.webp" alt="تعمیرات لوازم آشپزخانه (اشپزخانه) | تعمیر لوازم اشپزخانه (آشپزخانه) | juldvhj g,hcl Hamcohki )hamcohki(">
        </div>

        <div class="slide">
            <img src="img/slide show/2.webp" alt="تعمیرات برد های الکترونیکی | تعمیرات برد های الکترونیکی | juldvhj fvn ihd hg;jv,kd;d | juldv fvn ihd hg;jv,kd;d">
        </div>
    
        <div class="slide">
            <img src="img/slide show/3.webp" alt="تعمیرات ماشین ظرفشویی | تعمیر ماشین ظرفشویی |‌ juldvhj lhadk zvta,dd | juldv lhadk zvta,dd">
        </div>

        <div class="slide">
            <img src="img/slide show/4.webp" alt="تعمیرات لوازم خانگی | تعمیر لوازم خانگی |juldvhj g,hcl ohk'd | juldv g,hcl ohk'd">
        </div>

        <div class="slide">
            <img src="img/slide show/5.webp" alt="تعمیرات کولر گازی | تعمیر کولر گازی | juldvhj ;,gv 'hcd | juldv ;,gv 'hcd">
        </div>

        <div class="slide">
            <img src="img/slide show/6.webp" alt="تعمیرات لباسشویی | تعمیر لباسشویی | juldvhj gfhsa,dd | juldv gfhsa,dd">
        </div>

        <div class="slide">
            <img src="img/slide show/7.webp" alt="سیم پیچی انواع موتور | سیم پیچی موتور |sdl md]d l,j,v | sdl md]d hk,hu l,j,v">
        </div>

        <div class="slide">
            <img src="img/slide show/8.webp" alt="تعمیرات ماکروویو | تعمیر ماکروویو | juldvhj lh;v,,d, | juldv lh;v,,d,">
        </div>

        <div class="slide">
            <img src="img/slide show/9.webp" alt="تعمیرات جاروبرقی | تعمیر جاروبرقی | juldvhj [hv,fvrd | juldv [hv,fvrd">
        </div>
...
<div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/DAEWOO.webp" alt="تعمیر مارکت"></a></div>    
<div class="right">
...
<div class="style-of-ItemTamirat-box style-of-ItemTamirat-box-in-brand-page">
    ...
    <br><br><br>
            ...
            <div class="style-of-ItemTamirat-radif">
                <a href="RepairWashingMachineOfDAEWOO.php">
                ...
                <div class="style-of-ItemTamirat-radif">
                <a href="RepairMicrowaveOfDAEWOO.php">
                <div class="rotate-ItemTamirat-img style-of-ItemTamirat-div">
...
<br><br>
<div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/DAEWOO.webp" alt="تعمیر مارکت"></a></div>
<br><br>
<div>
    <img class="style-of-factory-img-in-brand-page" src="img/brand images/DAEWOO/factory1.webp" alt="کارخانه ی دوو">
    <img class="style-of-factory-img-in-brand-page" src="img/brand images/DAEWOO/factory2.webp" alt="کارخانه ی دوو">
</div>
        ...
        <table>
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> علت سخت باز شدن درب یخچال
                            </p>
                        </a>
                    </div>
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> راهنمای استفاده از ماکروویو
                            </p>
                        </a>
                    </div>
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> علت فاسد شدن مواد غذایی در یخچال
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> نمک ماشین ظرفشویی چیست و چه کاری انجام می دهد ؟
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> علت پایین آمدن دمای فریزر </p>
                        </a>
                    </div>
            ...
            <tr>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> چند پنکه با یک کولر گازی برابری می کند ؟ </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> علت نوسان درجه ی دمای یخچال چیست ؟
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> مدت زمان پخت انواع کیک در فر </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> هفت نکته برای شستن حوله با ماشین ظرفشویی </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> چرا بعد از زدن یخچال به برق فیوز می پرد ؟ </p>
                        </a>
                    </div>

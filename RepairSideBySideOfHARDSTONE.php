...
<body class="styles-of-body-tag">
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/sbs/ل هارد استون.webp" alt="تعمیرات ساید بای ساید هارد استون">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی ساید بای ساید هارد استون 
        </h1>
        ...
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات ساید بای ساید هارد استون</p>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/WM/001.webp" alt="تعمیرات ساید بای ساید هارد استون">
        <br><br>

...
<body class="styles-of-body-tag" onscroll="hide_menu_desktop()">
    ...
    <table class="blog-etelaat display-none-mo">
        <captiion>
            <h1 class="blog-titr">
            چرا برد الکترونیکی ماشین لباسشویی خراب می شود ؟                                                              
            </h1>
        </captiion>
        <tr>
    ...
    <br>
    <img class="style-of-orginal-brand-image" src="img/blog/9003/1.webp" alt="تعمیرات کولرگازی ارج">
    <br>   
    <br> 
        <p class="blog-text-p">
        در این مقاله از تیم توسعه و تولید محتوای تعمیر مارکت شما را با صفر تا صد فرآیند خراب شدن برد الکترونیکی ماشین لباسشویی آشنا خواهیم کرد 
        </p>
        <br>
        <p class="blog-text-p">با ما همراه باشید ... 
        </p>
        <br>
        <p class="blog-text-p">
            برد الکترونیکی را مغز دستگاه می نامیم و این موضوع در مورد ماشین لباسشویی نیز صادق است .
                <br>
            برد الکترونیکی مانند بقیه ی قطعات ماشین لباسشویی طول عمر محدودی دارد . 
            در مقاله چرا برد الکترونیکی ماشین لباسشویی خراب می شود ؟ به بررسی مواردی خواهیم پرداخت که عمر برد الکترونیکی ماشین لباسشویی را کم یا به پایان می رسانند.
        </p>
        <br>
        <div  class="fehrest-blog cursor-pointer">
        <p id="fehrest-blog"  class="fehrest-titr">فهرست</p>
            <ul id="bbvbsm1" class="ol-fehrest-blog">
                <li>
                    <a class="text-decoration-none text-color-darkblue-5" href="#f-1">برد الکترونیکی چیست و چه وظایفی دارد ؟</a> 
                </li>
                <li>
                    <a class="text-decoration-none text-color-darkblue-5" href="#f-2">چرا برد الکترونیکی ماشین لباسشویی خراب می شود ؟</a> 
                </li>
                <li>
                    <a class="text-decoration-none text-color-darkblue-5" href="#f-3">علائم خراب شدن برد الکترونیکی ماشین لباسشویی چیست ؟</a> 
                </li>
            </ul>
        
        </div>
    <br>
        <p class="blog-alarm">رعایت نکردن روش های اصولی استفاده از ماشین لباسشویی می تواند منجر به خرابی برد الکترونیکی دستگاه شود </p>
    <br>
        <br>
        <br><br>
        <div class="fehrest-blog">
        <a class="text-decoration-none text-color-purple-5" href="RepairDishwasherOfPAKSHOOMA.php">
        <p class="fehrest-titr">بیشتر بدانید : تعمیرات ظرفشویی پاکشوما</p>
        </a>
        </div>
        <br>
        <p class="blog-alarm">هشدار : برد الکترونیکی مجموعه ای از قطعات بسیار حساس است . از تعمیر کردن آن جدا خودداری کنید</p>
        <br>
        <br>
        <br>
        <p id="f-1" class="blog-first-text-p">برد الکترونیکی ماشین لباسشویی چیست و چه وظایفی دارد؟</p>
        <br>
        <br>
        <p class="blog-text-p">
        اغلب برد الکترونیکی را مغز دستگاه می نامیم و این موضوع در مورد ماشین های لباسشویی نیز صادق است . 
        برد الکترونیکی مشتکل از قطعات نسبتا کوچکی است که روی یک صفحه دارای مدار های چاپی در مکان های معینی قرار می گیرند 
        برای اطلاعات بیشتر در مورد برد الکترونیکی به 
        <a class="text-decoration-none text-color-darkblue-5" href="M9004.php">این لینک</a>
        مراجعه کنید .
        این قطعه وظیفه ی کنترل تمامی عملکرد های دستگاه شما را به عهده دارد. 
        از جمله کنترل زمان ورود آب به دستگاه ، شروع به کار کردن پمپ تخلیه و... 
        <br>
        با توجه به برنامه ای که توسط شما انتخاب شده است .
        </p>
‍        <br>
        <div class="fehrest-blog">
        <a class="text-decoration-none text-color-darkblue-5" href="">
        <p class="fehrest-titr">بیشتر بدانید : موتور ماشین لباسشویی چیست ؟</p>
        </a>
        </div>
        <br>
        <p id="f-2" class="blog-first-text-p">چرا برد الکترونیکی ماشین لباسشویی خراب می شود ؟</p>
        <br>
        <br>
        <p class="blog-text-p">
        نوسان برق از شایع ترین مواردی است که باعث خراب شدن انواع برد الکترونیکی مثل برد الکترونیکی ماشین لباسشویی می شود .
        <br>
        همان طور که می دانید ، ماشین لباسشویی برای شستشوی لباس ها در بخش های مختلف خود دارای جریان آب است . در صورتی که در این جریا نها نشتی ایجاد شود ، آب از آنها خارج و در صورت برخورد با برد الکترونیکی ، به آن آسیب می رساند . 
        </p>
        <br>
        <p id="f-3" class="blog-first-text-p">علائم خراب شدن برد الکترونیکی ماشین لباسشویی چیست ؟</p>
        <br>
        <br>
        <p class="blog-text-p">
            اشکال در اجرای برنامه ها توسط ماشین لباسشویی
        <br>
            واکنش نشان ندادن پنل جلوی دستگاه (Display Panel)
        <br>
            خاموشی ناگهانی ماشین لباسشویی ( در حین کار کردن )
        <br>
            خاموش شدن پنل جلویی دستگاه (Display Panel)
        <br>
        </p>
‍        <br>
        ...
        <!-- <br>
        <p id="f-2" class="blog-first-text-p text-center">چگونه تعمیر مارکت مشکل برد الکترونیکی شما را رفع خواهد کرد  ؟</p>
        <br>
        <br>
                ویدیو
        <br> -->
        <div class="fehrest-blog">
        <a class="text-decoration-none text-color-darkblue-5" href="M9005.php">
        <p class="fehrest-titr">بیشتر بدانید : چگونه ماشین لباسشویی خود را ریست کنیم ؟</p>
        </a>
        </div>
        <br>
        <div  class="fehrest-blog cursor-pointer">
        <p id="mataleb-pish" class="fehrest-titr text-color-red-5">مطالب پیشنهادی</p>
            <ul id="bbvbsm2" class="ol-fehrest-blog">
                <li>
                    <a class="text-decoration-none text-color-darkblue-5" href="">چرا برد الکترونیکی ماشین لباسشویی خراب می شود ؟</a> 
                </li>
            </ul>
        
        </div>
        <br>
        <div  class="keywords-tag-style fehrest-blog cursor-pointer list-style-none">
        <p id="BVB2"  class="fehrest-titr ">کلمات کلیدی</p>
            <ul id="BVBZ2" class="ol-fehrest-blog">
                <li>
                    <p class="keywords-tag-style-p">
                    دلایل ، چرا ، برد ، الکترونیکی ، ماشین ، لباسشویی ، خراب ، می ، شود ، خرابی ، ایرادات ، بررسی ، تعمیر ، مارکت ، لوازم ،آموزش ، بر ، طرف ، کردن ، مشکلات ، خانگی ، صنعتی ، اموزش 
                    </p>
                </li>
            </ul>
        </div>
...
<table class="style-of-footer-title display-none-mo">
    ...
    <!-- end *** footer *** -->
    <!-- ---------------------------------------------------------------------------------------------------- -->
    <h2 class="style-pf-secret-key-words">دلایل ، چرا ، برد ، الکترونیکی ، ماشین ، لباسشویی ، خراب ، می ، شود ، خرابی ، ایرادات ، بررسی ، تعمیر ، مارکت ، لوازم ،آموزش ، بر ، طرف ، کردن ، مشکلات ، خانگی ، صنعتی ،اموزش</h2>
    <h3 class="style-pf-secret-key-words">دلایل ، چرا ، برد ، الکترونیکی ، ماشین ، لباسشویی ، خراب ، می ، شود ، خرابی ، ایرادات ، بررسی ، تعمیر ، مارکت ، لوازم ،آموزش ، بر ، طرف ، کردن ، مشکلات ، خانگی ، صنعتی ،اموزش</h3>
    <h4 class="style-pf-secret-key-words">دلایل ، چرا ، برد ، الکترونیکی ، ماشین ، لباسشویی ، خراب ، می ، شود ، خرابی ، ایرادات ، بررسی ، تعمیر ، مارکت ، لوازم ،آموزش ، بر ، طرف ، کردن ، مشکلات ، خانگی ، صنعتی ،اموزش</h4>
    <h5 class="style-pf-secret-key-words">دلایل ، چرا ، برد ، الکترونیکی ، ماشین ، لباسشویی ، خراب ، می ، شود ، خرابی ، ایرادات ، بررسی ، تعمیر ، مارکت ، لوازم ،آموزش ، بر ، طرف ، کردن ، مشکلات ، خانگی ، صنعتی ،اموزش</h5>
    <h6 class="style-pf-secret-key-words">دلایل ، چرا ، برد ، الکترونیکی ، ماشین ، لباسشویی ، خراب ، می ، شود ، خرابی ، ایرادات ، بررسی ، تعمیر ، مارکت ، لوازم ،آموزش ، بر ، طرف ، کردن ، مشکلات ، خانگی ، صنعتی ،اموزش</h6>
<!-- script files  -->
...
<!-- <script>
    ...
    $hrefs.click(function(e) {
        ...
        $("html, body").animate({scroolTop: this_top},500)
    });
});
</script> -->
<!-- end script files  -->

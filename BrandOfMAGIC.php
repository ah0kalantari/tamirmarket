...
<head>
    ...
    <title> تعمیرات لوازم خانگی مجیک | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی مجیک 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/MAGIC.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی مجیک</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) مجیک در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی مجیک را در مدل ها و محصولات مختلف مجیک، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/MAGIC.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/MAGIC/factory1.png" alt="کارخانه ی مجیک">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/MAGIC/factory2.png" alt="کارخانه ی مجیک">
        </div>
        <p class="about-brand-title">درباره شرکت مجیک</p>
        <p class="about-brand-text">
            حضور محصولات مجیک در بازار کره‌ی جنوبی از سال 1985 آغاز شد و این شرکت در زمانی کوتاه توانست به جایگاه اول تولید کننده‌ی اجاق‌گاز در کشور کره برسد و پس از آن با تولید انواع لوازم خانگی توانست جایگاه خود را در بازار آن کشور به عنوان یک شرکت پیشرو در طراحی و تولید لوازم خانگی برقی ارتقا دهد. امروزه محصولات مجیک به 60 کشور دنیا صادر می‌شوند. به علاوه ی این موارد دریافت گواهینامه‌های بین‌المللی کیفیت و جوایز متعدد باعث شد تا گروه مجیک بتواند سه جایزه‌ی برتر دنیا را در زمینه‌ی طراحی دریافت کند.
        </p>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/MAGIC.png""                    alt="سانیاران سرویس"></a></div>
    </div>
    <div class="left">

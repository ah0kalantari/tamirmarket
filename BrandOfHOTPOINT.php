...
<head>
    ...
    <title> تعمیرات لوازم خانگی هات پوینت | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی هات پوینت 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/HOTPOINT.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی هات پوینت</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) هات پوینت در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی هات پوینت را در مدل ها و محصولات مختلف هات پوینت، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/HOTPOINT.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/HOTPOINT/factory1.png" alt="کارخانه ی هات پوینت">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/HOTPOINT/factory2.png" alt="کارخانه ی هات پوینت">
        </div>
        <p class="about-brand-title">درباره شرکت هات پوینت</p>
        <p class="about-brand-text">
         Hotpoint مارک لوازم خانگی است. مالکیت این برند بین شرکت آمریکایی Whirlpool که دارای حقوقی در اروپا است ، [1] و شرکت چینی Haier تقسیم شده است که از طریق خرید لوازم خانگی GE در سال 2016 از این حقوق در قاره آمریکا برخوردار است.
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/HOTPOINT.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت هات پوینت</p>
        <p class="about-brand-text">
             در سال 1918 ، این شرکت که از سال 1912 به عنوان شرکت گرمایش الکتریکی Hotpoint شناخته می شود ، با بخش دستگاه گرمایش جنرال الکتریک ادغام شد و به شرکت لوازم خانگی الکتریک ادیسون تبدیل شد ، و بعداً فقط یک بخش از GE در سال 1927 بود ، هنگامی که کارخانه را خریداری کرد و کل شرکت در سال 1931 به عنوان شرکت عمومی الکتریک ادیسون شناخته شد.

             بیشترین تولیدات Hotpoint در ابتدای دهه 1950 به مجتمع تولیدی لوازم خانگی ماموت GE در لوئیزویل ، KY نقل مکان کرد. تا به امروز بسیاری از لوازم هات پوینت در لوئیزویل ، بزرگترین کارخانه تولید لوازم خانگی در جهان ساخته می شود.
  
            در سپتامبر 2014 ، الکترولوکس توافق کرد که تجارت لوازم خانگی جنرال الکتریک از جمله مارک Hotpoint را در آمریکای شمالی با قیمت 2 میلیارد پوند (3.3 میلیارد دلار) خریداری کند. انتظار می رفت این معامله در سال 2015 بسته شود. [4] به دلیل مسدود شدن توسط رگولاتورهای ایالات متحده ، معامله الکترولوکس خاتمه یافت و GE متعاقباً بخش لوازم خود را به حایر چین فروخت تا در سال 2016 بسته شود
        </p>
    </div>
    <div class="left">

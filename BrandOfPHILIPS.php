...
<head>
    ...
    <title> تعمیرات لوازم خانگی فیلیپس | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<header class="position-of-menu style-of-menu">
    <div class="style-of-all-menu display-none-mo">
                ...
                <img onclick="bardispalymenuitems()" src="img/menu/zarbdar.png" id="display-of-menu-zarbdar" alt="سانیاران سرویس" class="style-of-menu-icon-zarbdar-in-mo"></img>
                    <nav id="style-of-all-menu-mo">
                        <ul class="display-inline">
                            ...
                            <br class="display-none-pc">
                                <li class="display-inline z-index-of-orginal-item-of-menu"> <a class="style-of-sdf z-index-of-orginal-item-of-menu">ارور ها</a></ul>
                                </li>
                            <br class="display-none-pc">
        ...
        <div class="style-of-all-menu display-none-pc">
            <div>
                <div>
                    ...
                    <img onclick="ChangeAlamatOfMenu()" id="style-x-in-menu-mo" class="style-x-in-menu-mo" src="img/menu/zarbdar.png"    alt="سانیاران سرویس"></img>
                        <nav id="display-of-all-menu-in-mo" class="display-of-all-menu-in-mo">
                            <ul>
                                ...
                                <div>
                                    <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" onclick="displayOfZirMenuInMo1()">تعمیرات</a>
                                       <div id="display-of-zir-menu-in-mo1" class="display-of-zir-menu-in-mo1">
                                         <ul>
                                            <li class="style-of-menu-text-in-mo" onclick="displayOfZirMenuInMo2()"><a>لوازم خانگی</a>
                                                <ul id="display-of-zir-menu-in-mo2" class="display-of-zir-menu-in-mo2">
                                                    <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="RepairWashingMachine.php"> ماشین لباسشویی</a></li>
                                                    <br>
                                                    <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="RepairRefrigerator.php">یخچال/فریزر </a></li>
                                                    <br>
                                                    <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="RepairSideBySide.php">ساید بای ساید</a></li>
                                                    <br>
                                                    <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="RepairDishwasher.php"> ماشین ظرفشویی</a></li>
                                                    <br>
                                                    <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="RepairMicrowave.php"> ماکروویو</a></li>
                                                    <br>
                                                    <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="RepairAirConditioning.php"> کولر آبی/گازی</a></li>
                                                    <br>
                                                    <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="RepairVacuumeCleaner.php"> جاروبرقی </a></li>
                                                    <br>
                                                    <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="RepairKitchenAppliances.php">لوازم آشپزخانه </a></li>
                                                    <br>
                                                </ul>
                                            </li>
                                            <li class="style-of-menu-text-in-mo" onclick="displayOfZirMenuInMo3()"><a>برد های الکترونیکی</a>
                                                <ul id="display-of-zir-menu-in-mo3" class="display-of-zir-menu-in-mo3">
                                                    <li class="style-of-menu-text-in-mo">
                                                         <a class="style-of-menu-text-in-mo" href="RepairHomeBoard.php">برد لوازم خانگی</a> 
                                                    </li>
                                                    <li class="style-of-menu-text-in-mo">
                                                         <a class="style-of-menu-text-in-mo" href="RepairFactoryBoard.php">برد دستگاه های صنعتی</a> 
                                                    </li>
                                                </ul>
                                            </li>
                                            <!-- سیم پیچی = sim -->
                                            <li class="style-of-menu-text-in-mo" onclick="displayOfZirMenuInMo4()"><a>سیم پیچی موتور</a>
                                                <ul id="display-of-zir-menu-in-mo4" class="display-of-zir-menu-in-mo4">
                                                    <li class="style-of-menu-text-in-mo">
                                                         <a class="style-of-menu-text-in-mo" href="SimSeFazMotor.php">سه فاز</a> 
                                                    </li>
                                                    <li class="style-of-menu-text-in-mo">
                                                        <a class="style-of-menu-text-in-mo" href="SimTakFazMotor.php">تک فاز</a>
                                                    </li>
                                                    <li class="style-of-menu-text-in-mo">
                                                        <a class="style-of-menu-text-in-mo" href="SimTrans.php">ترانس</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>  
                                    ...
                                    <li class="style-of-menu-text-in-mo"> <a class="style-of-menu-text-in-mo">ارور ها</a>
                                    </li>
                                <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="learn.php">آموزش</a></li>
                                <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="EtalaatOmomee.php">بیشتر بدانیم</a></li>
                                <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="AboutUs.php">درباره ما</a></li>
                                <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="ContactUs.php">تماس با ما</a></li>
                                <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="SabtSefaresh.php">ثبت سفارش</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی فیلیپس 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/PHILIPS.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی فیلیپس</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) فیلیپس در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی فیلیپس را در مدل ها و محصولات مختلف فیلیپس، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/PHILIPS.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/PHILIPS/factory1.png" alt="کارخانه ی فیلیپس">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/PHILIPS/factory2.png" alt="کارخانه ی فیلیپس">
        </div>
        <p class="about-brand-title">درباره شرکت فیلیپس</p>
        <p class="about-brand-text">
       
  فیلیپس (به هلندی: Philips)، شرکت هلندی و چندملیتی تجهیزات الکترونیکی است، که دفتر مرکزی آن در شهر آمستردام، هلند قرار دارد. این شرکت، در سال ۱۸۹۱ توسط جرارد فیلیپس در شهر آیندهوون تأسیس شد.

  شرکت فیلیپس، یکی از بزرگترین شرکت‌های تولیدکننده لوازم و تجهیزات الکترونیکی جهان است، که شمار کارکنان آن بیش از ۱۲۲٫۰۰۰ فیلیپسر می‌باشد و در ۱۰۰ کشور جهان، خدمات خود را ارائه می‌نماید. در سال ۲۰۱۲ شرکت فیلیپس به‌عنوان بزرگترین تولیدکننده تجهیزات روشنایی و نورپردازی در جهان، شناخته شد.
  
  سهام این شرکت در بازار بورس یورونکست آمستردام معامله می‌شود. شرکت فیلیپس، همچنین در فهرست ثانویه بازار بورس نیویورک ذکر شده‌است.
 <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/PHILIPS.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت فیلیپس</p>
        <p class="about-brand-text">
       
  جرارد فیلیپس در سال ۱۸۹۱ شرکت فیلیپس را، با هدف تولید انبوه لامپ‌های الکتریکی، در کشور هلند تأسیس کرد[۵] و به مرور، خط تولید سایر تجهیزات و وسایل برقی را، به کارخانجات تولیدی خود افزود. در سال ۱۹۱۴ نخستین آزمایشگاه پژوهشی مجهز، در زمینه‌های فیزیکی و شیمیایی راه‌اندازی و توسط این شرکت به دنیای الکترونیک و پزشکی معرفی شد.

  در سال ۱۹۲۵ این شرکت، محصول لامپ خلأ خود را تولید کرد. دو سال بعد، برای نخستین بار، تولید رادیو را تجربه نمود و چهار سال پس از آن، در ۱۹۳۱ فیلیپس وارد عرصه تولید تلویزیون شد. در فاصله دهه ۱۹۳۰ این شرکت توانست، یک میلیون محصول خود را به فروش برساند. در سال ۱۹۳۹ زمانی که شمار کارکنان فیلیپس، به ۴۵ هزار فیلیپسر رسیده بود، نخستین دستگاه ریش‌تراش با برند فیلیپس به بازار عرضه شد.
  
  در سال ۱۹۴۹ شرکت، فروش ست‌های تلویزیون را آغاز نمود[۶] و در ۱۹۵۰ شرکت فیلیپس رکوردز، را راه‌اندازی کرد.
  
  در سال ۱۹۶۳ نوار کاست صوتی توسط شرکت فیلیپس ارائه شد، که در زمان خود، موفقیت بزرگی برای این شرکت محسوب می‌شد. کمی پس از آن، برای نخستین بار، دستگاه رادیو ضبط با برند فیلیپس را تولید کرد. سپس دستگاه ضبط نوار کاست را، جهت استفاده به عنوان پیغام‌گیر، با دستگاه تلفن ترکیب نمود.
  
  در طول دهه ۱۹۷۰ فروش این محصولات ادامه داشت و حتی در چندین سری از رایانه‌های شخصی از این کاست‌ها استفاده می‌شد. در گام بعدی نوار کاست‌هایی با نام تجاری "مینی کاست" در مقیاسی کوچکتر تولید شد که گمان می‌رفت به عنوان پیغام‌گیر تلفن‌های اداری، فروش خوبی داشته باشد ولی در عمل این محصول به جهت تولید میکروکاست‌های شرکت المپوس، عملأ به موفقیت تجاری نرسید.
  
  در سال ۱۹۷۲ نخستین سیستم ویدئو خانگی، یا دستگاه وی‌اچ‌اس در بازار تجهیزات الکترونیکی انگلیس ارائه شد.[۷] این محصول، عملاً در مواجهه با استانداردهای بتاماکس که توسط شرکت سونی تولید شده بود، در سطح بین‌المللی فروش زیادی نداشت. در ۱۹۷۸ وسایل صوتی فیلیپس، با لوح نوری به بازار عرضه شد. در سال ۱۹۸۲ لوح فشرده، با همکاری شرکت سونی تولید و به بازار وارد شد. سپس این محصول به‌ترتیب در سال‌های ۱۹۹۷ و ۲۰۰۶ به دی‌وی‌دی و دیسک بلو-ری تجهیز گردید.
  
  دهه ۱۹۹۰ برای این شرکت، دوران تجدید ساختار و بازسازی فشرده محدوده فعالیت تجاری بود. در سال ۲۰۰۱ مرکزیت شرکت که تا آن زمان، در شهر آیندهوون، هلند بود، به شهر آمستردام منتقل شد.
  
  حوزه های کسب و کار
  شرکت فیلیپس که فعالیت خود را در حوزه روشنایی آغاز کرده بود، امروز در حوزه‌های دیگر نظیر لوازم خانگی و وسایل شخصی، سیستم‌های پزشکی، لوازم و تجهیزات الکترونیکی حضور گسترده‌ای در سطح بین‌المللی دارد.
  
  فیلیپس از سال ۱۹۵۳ وارد صنعت تولید و ارائه نیم‌رسانا شد. پیشرفت و توسعه بخش تولید نیمه‌رساناهای فیلیپس، بگونه‌ای بود که در سال ۲۰۰۶ مقام دهم برترین شرکت‌های فروشنده نیمه‌هادی‌ها را در جهان به خود اختصاص داده بود.
  
  بخش روشنایی فیلیپس با ۴۷٫۸۰۰ پرسنل در زمینه تولید انواع مختلف لامپ و نورافکن، بخش سیستم‌های پزشکی با ۳۳٫۰۰۰ پرسنل، در زمینه سیستم‌های عکس‌برداری عارضه‌یابی پزشکی و خدمات بالینی و بخش وسایل و محصولات الکترونیکی فیلیپس، با ۱۴٫۵۰۰ پرسنل در زمینه تولید نمایشگرها، وسایل صوتی و تجهیزات چندرسانه‌ای، ویدئو و شبکه‌های خانگی فعال است.
  
  درحال‌حاضر، باتوجه به سیاست این شرکت، مبنی بر روان‌سازی کارها و ساده‌سازی ساختار سازمانی، تمامی فعالیت‌ها در سه حوزه اصلی فناوری، بهداشت و شیوه‌های زندگی، متمرکز شده‌است.</p>
    </div>
    <div class="left">

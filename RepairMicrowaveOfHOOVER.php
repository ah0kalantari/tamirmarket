...
<head>
    ...
    <title> تعمیرات ظرفشویی تعمیر مارکت | saniaran service Washing Machine repair</title>
</head>
<body class="styles-of-body-tag">
                                         ...
                                         <ul id="style-of-zirmenu-of-tamirat" class="style-of-zirmenu-of-tamirat">
                                            <li onmouseover="showzirmajmoee2()" onmouseout="hidezirmajmoee2()" class="style-of-sdf background-color-0e4797-hover"><a class="style-of-text-of-zirmenus style-of-sdf"  >لوازم خانگی</a>
                                                <ul id="style-of-zirmenu-of-tamirat2" class="style-of-zirmenu-of-tamirat2" class="style-of-all-of-zirmajmoee">
                                                    <li class="style-of-sdf"><a class="style-of-text-of-zirmenus style-of-sdf" href="RepairWashingMachine.php"> ماشین ظرفشویی</a></li>
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/zarfshooi/ل هوور.jpg" alt="تعمیرات ظرفشویی هوور">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی ماشین ظرفشویی هوور 
        </h1>
        ...
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات ظرفشویی هوور</p>
        ...
        (ظرفشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) هوور در خدمت شماست.
        <br>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
      ...
      <p class="about-brand-text">
            ماشین ظرف‌شویی یک دستگاه الکترومکانیکی است که برای شستن و تمیز کردن ظروف به کار می‌رود. از ماشین ظرف‌شویی در رستوران‌ها و آشپزخانه‌های منازل استفاده می‌شود.
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/DW/001.png" alt="تعمیرات ظرفشویی هوور">
        <br><br>

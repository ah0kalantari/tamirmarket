...
<head>
    ...
    <title> تعمیرات لوازم خانگی ایندزیت | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی ایندزیت 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/INDESIT.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی ایندزیت</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) ایندزیت در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی ایندزیت را در مدل ها و محصولات مختلف ایندزیت، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/INDESIT.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/INDESIT/factory1.png" alt="کارخانه ی ایندزیت">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/INDESIT/factory2.png" alt="کارخانه ی ایندزیت">
        </div>
        <p class="about-brand-title">درباره شرکت ایندزیت</p>
        <p class="about-brand-text">
            
  ایندزیت، (به ایتالیایی: Indesit) شرکت لوازم خانگی ایتالیایی و چندملیتی است، که دفتر مرکزی آن، در شهر فابریانو، استان آنکونا، ایتالیا قرار دارد.

  شرکت ایندزیت، از پیشروهای تولید لوازم خانگی در اروپا است و به‌عنوان دومین تولیدکننده بزرگ لوازم خانگی مدرن در اروپا و پنجمین در جهان به‌شمار می‌آید.
        </p>
        <br><br>
        <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/INDESIT.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت ایندزیت</p>
        <p class="about-brand-text">
        
  شرکت ایندزیت در سال ۱۹۷۵ با نام صنایع مرلونی در شهر فابریانو ایتالیا و توسط ویتوریو مرلونی تأسیس گردید. در طول ۳ دهه با کسب موفقیت در صنایع و تولیدات خود، با گسترش حوزه فعالیت سیر تکاملی خود را پیموده و با رشدی قابل توجه یکی از بزرگترین تولیدکنندگان لوازم خانگی دنیا به شمار می‌آید.

  در طول این سال‌ها، میلیون‌ها خانواده در سراسر جهان محصولات ایندزیت را انتخاب و مورد استفاده قرار داده‌اند، که برخی شیفته نوآوری و طرح‌های متنوع آن شده و برخی دیگر کیفیت بالای آن‌را ملاک این انتخاب گذاشته‌اند.
  برندها
  شرکت لوازم خانگی ایندزیت محصولات و لوازم تولیدی خود را تحت نام ۷ برند اصلی به‌فروش می‌رساند، این برندها عبارتند از:
  ایندزیت
  هات‌پوینت-آریستون
  شولتز
  استینول
  ...
  ترموگاما
  کارخانه‌های تولیدی
  شرکت ایندزیت در سال ۲۰۱۱ فروشی معادل ۲٫۸ میلیارد دلار داشته‌است. این شرکت دارای ۱۶ کارخانه تولید لوازم خانگی می‌باشد، که ۸ کارخانه آن در کشور ایتالیا و در مناطق: فابریانو، آلباسینا و میلانو، برمبت، کارینارو، کامیونانزا، نونه، رفرانتولو و تیورولا قرار دارند. ۸ کارخانه دیگر ایندزیت نیز در ۴ کشور لهستان، بریتانیا، روسیه و ترکیه مستقر می‌باشند.</p>
    </div>
    <div class="left">

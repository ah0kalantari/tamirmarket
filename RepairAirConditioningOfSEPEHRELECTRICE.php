...
<head>
    ...
    <title>تعمیرات کولرگازی سپهر الکتریک | سانیاران سرویس</title>
</head>
<body class="styles-of-body-tag">
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/AIR/ل سپهر الکتریک.jpg" alt="تعمیرات کولرگازی سپهر الکتریک">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی کولرگازی سپهر الکتریک 
        </h1>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/SEPEHR ELECTRICE.png"                    alt="سانیاران سرویس"></a></div>    
        <br>
        <h2 class="style-of-moarefi-shoql">
        ...
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات کولرگازی سپهر الکتریک</p>
        ...
        <br><br>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/SEPEHR ELECTRICE 2.png"                    alt="سانیاران سرویس"></a></div>    
        <br><br>
        ...
        (کولرگازی، کولرگازی، یخچال، ماکروویو، جاروبرقی و کولرگازی) سپهر الکتریک در خدمت شماست.
        <br>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <p class="about-brand-title">درباره کولرگازی</p>
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/AIR/001.png" alt="تعمیرات کولرگازی سپهر الکتریک">
        <br><br>
        <p class="about-brand-title">مشکلات رایج انواع ماشین های کولرگازی</p>
        <p class="about-brand-text">
            1) به موقع شارژ کردن کولرگازی
            <br><br>
            2) بررسی کردن کایل های کولر گازی هر چند وقت یکبار .
            <br><br>
            3) بررسی کردن نشتی کولر گازی .
            <br><br>
            4) رعایت فاصله کندانسور .
            <br><br>
            5) نباید کولر آبی و کولر گازی هم زمان روشن باشند .
            <br><br>
            6) بستن پنجره ها در هنگام کار کولرگازی .
            <br><br>
            7) تعویض به موقع فن کولر گازی .
            <br><br>    
        </p>
    </div>
    <div class="left">
    ...
    <div class="display-none-mo">
        <div class="style-of-ItemTamirat-radif style-of-ItemTamirat-radif-in-brand-page dtngjdfjiogdrjiogfyhsei">
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/AIR/1.png"       alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/AIR/2.png"        alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/AIR/3.png"             alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/AIR/4.png"            alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/AIR/8.png"            alt="سانیاران سرویس">
            </div>
        </div>
        <br><br>
        <div class="style-of-ItemTamirat-radif style-of-ItemTamirat-radif-in-brand-page dtngjdfjiogdrjiogfyhsei">
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/AIR/5.png"       alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/AIR/6.png"        alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/AIR/7.png"             alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/AIR/9.png"            alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/AIR/10.png"            alt="سانیاران سرویس">
            </div>
        </div>
    </div>

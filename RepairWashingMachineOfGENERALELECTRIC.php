...
<body class="styles-of-body-tag">
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/lebasshooee/ل جنرال الکتریک.jpg" alt="تعمیرات لباسشویی جنرال الکتریک">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی ماشین لباسشویی جنرال الکتریک 
        </h1>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/GENERAL ELECTRIC.png"                    alt="تعمیر مارکت"></a></div>    
        <br>
        <h2 class="style-of-moarefi-shoql">
        ...
        <br><br>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/GENERAL ELECTRIC 2.png"                    alt="تعمیر مارکت"></a></div>    
        <br><br>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/WM/001.png" alt="تعمیرات لباسشویی جنرال الکتریک">
        <br><br>

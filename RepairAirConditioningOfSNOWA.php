...
<head>
    ...
    <title>تعمیرات کولرگازی اسنوا | سانیاران سرویس</title>
</head>
<body class="styles-of-body-tag">
    ...
    <br><br>
        ...
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/SNOWA.png"                    alt="سانیاران سرویس"></a></div>    
        <br>
        <h2 class="style-of-moarefi-shoql">
        ...
        <br><br>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/SNOWA 2.png"                    alt="سانیاران سرویس"></a></div>    
        <br><br>

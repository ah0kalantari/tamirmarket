...
<head>
    ...
    <title> تعمیرات لوازم خانگی بوش | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی بوش 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/BOSCH.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی بوش</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) بوش در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی بوش را در مدل ها و محصولات مختلف بوش، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/BOSCH.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/BOSCH/factory1.png" alt="کارخانه ی بوش">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/BOSCH/factory2.png" alt="کارخانه ی بوش">
        </div>
        <p class="about-brand-title">درباره شرکت بوش</p>
        <p class="about-brand-text">
       
  روبرت بوش گ‌ام‌ب‌ها، یا به مختصر بوش (به آلمانی: Robert Bosch GmbH) یک شرکت بر پایه فناوری است که در سال ۱۸۸۶ توسط روبرت بوش در شهر اشتوتگارت آلمان بنیان نهاده شد. این شرکت بزرگ‌ترین تأمین‌کننده لوازم خودکار در جهان است.

  دفتر مرکزی این شرکت در شهر گرلینگن در آلمان قرار دارد.
  
  با فعالیت در حوزه فناوری‌های خودکار و صنعتی، کالاهای مصرفی و فناوری‌های ساختمانی، این شرکت در سال ۲۰۱۰ فروشی معادل ۴۷٬۵ میلیارد یورو داشت که با رشدی معادل ۲۷ درصد در سال، سریعترین رشد سالانه را در تاریخ ۱۲۵ ساله خود ثبت کرد. این شرکت همچنین شهرت بسیاری در تولید لوازم خانگی بوش با کیفیت دارد. 
   <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/BOSCH.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت بوش</p>
        <p class="about-brand-text">

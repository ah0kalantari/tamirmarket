...
<head>
    ...
    <title> تعمیرات لوازم خانگی زیرووات | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <div class="first-logo-styles">
        <br><br><br><br><br><br class="display-none-pc">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی زیرووات 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ZEROWATT.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی زیرووات</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) زیرووات در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی زیرووات را در مدل ها و محصولات مختلف زیرووات، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ZEROWATT.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/ZEROWATT/factory1.png" alt="کارخانه ی زیرووات">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/ZEROWATT/factory2.png" alt="کارخانه ی زیرووات">
        </div>
        <p class="about-brand-title">درباره شرکت زیرووات</p>
        <p class="about-brand-text">
       
  برند زیرووات از معتبرترین برندهای قاره اروپا و از زیرمجموعه‌های مجموعه ی  کندی است . بیشتر فعالیت برند زیرووات در زمینه تولید  لوازم خانگی و دارای بیشترین هدف در عرصه ی لوازم خانگی  از قبيل ماشين لباسشويي و ظرفشويي  است . این برند می خواهد  تا با ارائه کردن محصولاتی با كيفيت بالا  و خدمات دهی مناسب، سهم مهمی را از تولید لوازم خانگي کسب کند .<div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ZEROWATT.png""                    alt="سانیاران سرویس"></a></div>
    </div>
    <div class="left">

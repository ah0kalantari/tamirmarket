...
<head>
    ...
    <title> تعمیرات لوازم خانگی اجنرال | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی اجنرال 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/OGENERAL.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی اجنرال</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) اجنرال در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی اجنرال را در مدل ها و محصولات مختلف اجنرال، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/OGENERAL.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/OGENERAL/factory1.png" alt="کارخانه ی اجنرال">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/OGENERAL/factory2.png" alt="کارخانه ی اجنرال">
        </div>
        <p class="about-brand-title">درباره شرکت اجنرال</p>
        <p class="about-brand-text">
       
  اجنرال با نیم قرن تجربه توانسته سهم بالایی از بازار ژاپن، اروپا، اقیانوسیه و خاورمیانه در اختیار خود قرار دهد. این مجموعه به طور مستمر با استفاده از ایده های خلاقانه و نو آوری باعث پیشرفت در عمر عملکرد محصولات خود در شرایط محیطی مختلف شده است و به لطف طراحی و تکنولوژی منحصر به فرد دارای بیشترین صرفه جویی انرژی است.

  اولین کولر گازی پنجره ای اجنرال<div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/OGENERAL.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت اجنرال</p>
        <p class="about-brand-text">
        
  کمپانی فوجیتسو در سال ۱۹۳۶ در کشور ژاپن تاسیس شد و فوجیتسو جنرال که در ایران با نام تجاری اجنرال شناخته شده است در سال ۱۹۶۰ کار خود را در صنعت تهویه مطبوع آغاز کرد. اولین کولر گازی اجنرال از نوع  پنجره ای بود که در ابتدای کار به بازار عرضه شد. همچنین در سال ۱۹۷۱ با ورود به خاورمیانه (کویت) بازار فروش آن گسترش پیدا کرد و به سرعت از نظر کیفیت بالای برند و توانایی عملکرد در دماهای بالای ۵۰ درجه سانتیگراد شهرت یافت.</p>
    </div>
    <div class="left">

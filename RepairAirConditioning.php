...
<head>
    ...
    <title> تعمیرات کولرگازی سانیاران سرویس </title>
</head>
<body class="styles-of-body-tag">
                                         ...
                                         <ul id="style-of-zirmenu-of-tamirat" class="style-of-zirmenu-of-tamirat">
                                            <li onmouseover="showzirmajmoee2()" onmouseout="hidezirmajmoee2()" class="style-of-sdf background-color-0e4797-hover"><a class="style-of-text-of-zirmenus style-of-sdf"  >لوازم خانگی</a>
                                                <ul id="style-of-zirmenu-of-tamirat2" class="style-of-zirmenu-of-tamirat2" class="style-of-all-of-zirmajmoee">
                                                    ...
                                                    <li class="style-of-sdf"><a class="style-of-text-of-zirmenus style-of-sdf" href="RepairDishwasher.php"> ماشین کولرگازی</a></li>
                                             ...
                                             <ul>
                                                <li class="style-of-menu-text-in-mo" onclick="displayOfZirMenuInMo2()"><a>لوازم خانگی</a><hr class="white-hr">
                                                    <ul id="display-of-zir-menu-in-mo2" class="display-of-zir-menu-in-mo2">
                                                        ...
                                                        <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="RepairDishwasher.php"> ماشین کولرگازی</a></li><hr class="white-hr">
    ...
    <div id="slider">
        <div class="slide activate">
            <img src="img/slide show/AIR/1.jpg" alt="تعمیرات ماشین کولرگازی در استان های تهران و البرز">
        </div>

        <div class="slide">
            <img src="img/slide show/AIR/2.jpg" alt="تعمیرات ماشین کولرگازی در استان های تهران و البرز">
        </div>
    
        <div class="slide">
            <img src="img/slide show/AIR/3.jpg" alt="تعمیرات ماشین کولرگازی در استان های تهران و البرز">
        </div>
    ...
    <div class="right">
        ...
        <br><br>
        <p class="about-brand-title">کار هایی برای پیشگیری از خراب شدن ماشین کولرگازی </p>
        ...
        <br><br>
        <p class="about-brand-title">کولرگازی اینورتر</p>
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/AIR/00001.png" alt="تعمیرات کولرگازی ال جی">
        <br><br>
        <p class="about-brand-text">
        ...
        <p class="about-brand-text">
            کمپرسور یا موتور کولر گازی یکی از اصلی‌ترین اجزاء کولر گازی است که وظیفه گردش گاز را در مدار (سیکل) کولر گازی دارد. کمپرسورهای کولر گازی بر اساس نوع عملکرد و نوع گاز انواع متفاوتی دارند و هر کدام معایب و مزایای خاص خود را دارد.
        </p>
        <br><br>
        ...
        <br><br>
        <p class="about-brand-title">نکاتی در مورد نگهداری ماشین کولرگازی</p>
        <p class="about-brand-text">
            1) به موقع شارژ کردن کولرگازی
            <br><br>
            2) بررسی کردن کایل های کولر گازی هر چند وقت یکبار .

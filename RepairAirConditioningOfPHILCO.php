...
<head>
    ...
    <title>تعمیرات کولرگازی فیلکو | سانیاران سرویس</title>
</head>
<body class="styles-of-body-tag">
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/AIR/ل فیلکو.jpg" alt="تعمیرات کولرگازی فیلکو">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی کولرگازی فیلکو 
        </h1>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/PHILCO.png"                    alt="سانیاران سرویس"></a></div>    
        <br>
        <h2 class="style-of-moarefi-shoql">
        ...
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات کولرگازی فیلکو</p>
        ...
        <br><br>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/PHILCO 2.png"                    alt="سانیاران سرویس"></a></div>    
        <br><br>
        ...
        (کولرگازی، کولرگازی، یخچال، ماکروویو، جاروبرقی و کولرگازی) فیلکو در خدمت شماست.
        <br>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/AIR/001.png" alt="تعمیرات کولرگازی فیلکو">
        <br><br>

...
<body class="styles-of-body-tag">
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/yakhchal/ل سپهر الکتریک.webp" alt="تعمیرات یخچال / فریزر سپهر الکتریک">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی یخچال / فریزر سپهر الکتریک 
        </h1>
        ...
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات یخچال / فریزر سپهر الکتریک</p>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/WM/001.webp" alt="تعمیرات یخچال / فریزر سپهر الکتریک">
        <br><br>

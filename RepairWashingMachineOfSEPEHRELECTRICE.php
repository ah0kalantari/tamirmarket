...
<head>
    ...
    <title>تعمیرات لباسشویی سپهرالکتریک | تعمیر مارکت</title>
</head>
<body class="styles-of-body-tag">
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/lebasshooee/ل سپهر الکتریک.webp" alt="تعمیرات لباسشویی سپهر الکتریک">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی ماشین لباسشویی سپهر الکتریک 
        </h1>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/SEPEHR ELECTRICE.webp"                    alt="تعمیر مارکت"></a></div>    
        <br>
        <h2 class="style-of-moarefi-shoql">
        ...
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لباسشویی سپهر الکتریک</p>
        ...
        <br><br>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/SEPEHR ELECTRICE 2.webp"                    alt="تعمیر مارکت"></a></div>    
        <br><br>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/WM/001.webp" alt="تعمیرات لباسشویی سپهر الکتریک">
        <br><br>

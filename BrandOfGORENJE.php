...
<head>
    ...
    <title> تعمیرات لوازم خانگی گرنیه | تعمیر مارکت</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h1 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی گرنیه 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/GORENJE.webp""                    alt="تعمیر مارکت"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیر مارکت :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی گرنیه</p>
        ...
        <br><br>
            ...
            <div class="style-of-ItemTamirat-radif">
                <a href="RepairWashingMachineOfGORENJE.php">
                ...
                <div class="style-of-ItemTamirat-radif">
                <a href="RepairMicrowaveOfGORENJE.php">
                <div class="rotate-ItemTamirat-img style-of-ItemTamirat-div">
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) گرنیه در خدمت شماست.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/GORENJE.webp"                    alt="تعمیر مارکت"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/GORENJE/factory1.webp" alt="کارخانه ی گرنیه">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/GORENJE/factory2.webp" alt="کارخانه ی گرنیه">
        </div>
        <p class="about-brand-title">درباره شرکت گرنیه</p>
  ...
  در ژوئن 2018 ، هایسنس 95٪ اکثریت را در گروه Gorenje کسب کرد.<div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/GORENJE.webp""                    alt="تعمیر مارکت"></a></div>
        <p class="about-brand-title">تاریخچه شرکت گرنیه</p>
        <p class="about-brand-text">
  ...
  طی دهه 1970 ، دامنه محصولات به واحدهای آشپزخانه ، سرامیک ، تجهیزات پزشکی ، دستگاه های مخابراتی ، تلویزیون و سایر کالاهای الکتریکی گسترش یافت. گورنجه به گسترش خود ادامه داد و طی دهه 1970 بیش از 20،000 گرنیهر مشغول به کار شد. همچنین ایجاد شبکه توزیع و فروش در اروپای غربی (آلمان ، اتریش ، فرانسه ، دانمارک و ایتالیا) و استرالیا.
        ...
        <img class="style-of-left-ra" src="img/left/orginal.webp" alt="chatre sabz">
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> تشخیص اصل بودن فیلتر یخچال
                            </p>
                        </a>
                    </div>
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> شش نکته برای تعمیر مشکلات رایج ماشین ظرفشویی
                            </p>
                        </a>
                    </div>
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> علل روشن نشدن یخچال
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> علل یخ زدن لوله پشت یخچال
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> اصطلاحات تخصصی اجاق فر دار </p>
                        </a>
                    </div>
            ...
            <tr>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> تعمیر نشتی آب در یخچال های آمریکایی </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> واژگان و اصطلاحات ماشین ظرفشویی | راهنمای خرید ظرفشویی
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> ارور یخچال وستینگ هاوس </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> سه توصیه برای اجتناب از تعمیر ماشین ظرفشویی </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> ارور یخچال برفاب </p>
                        </a>
                    </div>

...
<body class="styles-of-body-tag">
    ...
    <header class="position-of-menu style-of-menu">
        <div class="style-of-all-menu display-none-mo">
                                         ...
                                         <ul id="style-of-zirmenu-of-tamirat" class="style-of-zirmenu-of-tamirat">
                                            <li onmouseover="showzirmajmoee2()" onmouseout="hidezirmajmoee2()" class="style-of-sdf background-color-0e4797-hover"><a class="style-of-text-of-zirmenus style-of-sdf"  >لوازم خانگی</a>
                                                <ul id="style-of-zirmenu-of-tamirat2" class="style-of-zirmenu-of-tamirat2" class="style-of-all-of-zirmajmoee">
                                                    ...
                                                    <li class="style-of-sdf"><a class="style-of-text-of-zirmenus style-of-sdf" title="تعمیرات لوازم خانگی" href="RepairKitchenAppliances.php">لوازم آشپزخانه </a></li>
                                                </ul>
                                            </li>
            ...
            <div id="style-of-all-menu" class="style-of-all-menu display-none-pc">
                <div>
                    <div>
                        <img onclick="ChangeAlamatOfMenu()" id="style-hamberger-in-menu-mo" class="style-hamberger-in-menu-mo" src="img/menu/menu icon.webp"  alt="تعمیر پکیج در کرج"></img>
                        <img onclick="ChangeAlamatOfMenu()" id="style-x-in-menu-mo" class="style-x-in-menu-mo" src="img/menu/zarbdar.webp"    alt="تعمیر پکیج در تهران"></img>
    ...
    <div class="first-logo-styles">
        ...
        <img class="display-inline styles-of-first-logo-in-all-pages-1" src="img/firstlogo/لوگوی تعمیر مارکت.webp"             alt="تعمیرات پکیج در کرج">
        <img class="display-inline styles-of-first-logo-in-all-pages-2" src="img/firstlogo/تعمیر مارکت.webp" alt="تعمیرات پکیج در تهران">
    ...
    <h2 class="style-of-moarefi-shoql">
        ...
        <br>
        لباسشویی , پکیج, ساید بای ساید , یخچال, پکیج و آبی, مایکروویو , جاروبرقی
    </h2>
    <br>
    <br>
    <div id="slider">
        <div class="slide activate">
            <img src="img/slide show/PAKIJ/1.webp" alt="تعمیرات پکیج در استان های تهران و البرز">
        </div>

        <div class="slide">
            <img src="img/slide show/PAKIJ/2.webp" alt="تعمیرات پکیج در استان های تهران و البرز">
        </div>
    ...
    <h1 class="animation-of-title-brand">
        تعمیرات تخصصی انواع پکیج 
    </h1>
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات پکیج تعمیر مارکت :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات انواع پکیج</p>
        <p class="style-of-mazit-estfade-az-ma-text">  2) استفاده از لوازم و قطعات اصلی (اورجینال ) در تعمیرات پکیج </p>
        ...
        <br><br>
            ...
            <br>
                    <div class="scale-brand-img"><a href="RepairPakijOfLG.php">             <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/LG.webp"                    alt="تعمیر پکیج در کرج"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfSAMSUNG.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/SAMSUNG.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfDAEWOO.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/DAEWOO.webp"                alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfSNOWA.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/SNOWA.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfPARS.php">           <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PARS.webp"                  alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfBEHI.php">           <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/BEHI.webp"                  alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfAEG.php">            <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/AEG.webp"                   alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfBOSCH.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/BOSCH.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfSIEMENC.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/SIEMENC.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfKENWOOD.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/KENWOOD.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfINDESIT.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/INDESIT.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfCANDY.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/CANDY.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfARJ.php">            <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ARJ.webp"                   alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfHIMALIA.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HIMALIA.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfSEPEHRELECTRICE.php"><img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/SEPEHR ELECTRICE.webp"      alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfPAKSHOOMA.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PAKSHOOMA.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfEMERSAN.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/EMERSAN.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfHAIER.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HAIER.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfYAKHSARAN.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/YAKHSARAN.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfBARFAB.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/BARFAB.webp"                alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfBEKO.php">           <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/BEKO.webp"                  alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfELECTROLUX.php">     <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ELECTROLUX.webp"            alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfPHIVER.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PHILVER.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfSHARP.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/SHARP.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfMOULINEX.php">       <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/MOULINEX.webp"              alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfPANASONIC.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PANASONIC.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfHARDSTONE.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HARDSTONE.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfPHILIPS.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PHILIPS.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfCORAL.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/CORAL.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfTOSHIBA.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/TOSHIBA.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfKENMORE.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/KENMORE.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfHOOVER.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HOOVER.webp"                alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfZANUSSI.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ZANUSSI.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfZEROWATT.php">       <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ZEROWATT.webp"              alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfGENERALELECTRIC.php"><img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/GENERAL ELECTRIC.webp"      alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfBAUKNECHT.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/BAUKNECHT.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfMIDEA.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/MIDEA.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfWHIRLPOOL.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/WHIRLPOOL.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfFAGOR.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/FAGOR.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfHOTPOINT.php">       <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HOTPOINT.webp"              alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfVESTEL.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/VESTEL.webp"                alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfARISTON.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ARISTON.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfMABE.php">           <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/MABE.webp"                  alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfGORENJE.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/GORENJE.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfPHILCO.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PHILCO.webp"                alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfWESTINGHOUSE.php">   <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/WESTINGHOUSE.webp"          alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfAZMAYESH.php">       <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/AZMAYESH.webp"              alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfELECTROSTILL.php">   <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ELECTROSTILL.webp"          alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfOGENERAL.php">       <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/OGENERAL.webp"              alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfHYUNDAI.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HYUNDAI.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfMAGIC.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/MAGIC.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfADMIRAL.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ADMIRAL.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfAMANA.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/AMANA.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairPakijOfTEFAL.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/TEFAL.webp"                 alt="تعمیر مارکت"></a></div>
            <br><br><br>
        ...
        (لباسشویی، پکیج، یخچال، ماکروویو، جاروبرقی و پکیج) در خدمت شماست.
        <br>
        ...
        <br><br>
        <p class="about-brand-title">کار هایی برای پیشگیری از خراب شدن پکیج </p>
        <p class="about-brand-text">
            1) چک کردن سنسور ها 
            <br><br>
            2) بررسی کردن شیلنگ ها و کابل های پکیج .
            <br><br>
            3) تنظیم پلی فسفات .
            <br><br>
            4) تنظیم شیر گاز .
        ...
        <p class="about-brand-title">درباره پکیج</p>
        <p class="about-brand-text">
            پکیج به نوعی سیستم گرمایشی گفته می‌شود که امروزه جایگزین موتور خانه‌ها شده اند. پکیج‌ها در دو نوع زمینی و دیواری می‌باشند<br><br>
        <p class="about-brand-title">انواع پکیج</p>
        <div class="style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/PAKIJ/0001.webp"       alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/PAKIJ/0002.webp"        alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/PAKIJ/0003.webp"             alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/PAKIJ/0004.webp"            alt="تعمیر مارکت">
         </div>
        <p class="about-brand-text">
            رایج‌ترین گونه‌های پکیج عبارتند از
            <br>
            پکیج گازسوز
            <br>
            پکیج گازوئیل سوز
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/PAKIJ/00001.webp" alt="تعمیرات پکیج | تعمیر مارکت">
        <br><br>
        <p class="about-brand-text">
        ...
        <div class="style-of-ItemTamirat-radif style-of-ItemTamirat-radif-in-brand-page">
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/PAKIJ/Q/1.webp"       alt="تامین قطعات پکیج | تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/PAKIJ/Q/2.webp"       alt="تامین قطعات پکیج | تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/PAKIJ/Q/3.webp"      alt="تامین قطعات پکیج | تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/PAKIJ/Q/4.webp"      alt="تامین قطعات پکیج | تعمیر مارکت">
            </div>
        </div>
        <br><br>
        <p class="about-brand-title">ترموستات پکیج</p>
        <div class=" style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/PAKIJ/Q/9.webp"          alt="تامین قطعات پکیج | تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/PAKIJ/Q/10.webp"         alt="تامین قطعات پکیج | تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/PAKIJ/Q/11.webp"        alt="تامین قطعات پکیج | تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/PAKIJ/Q/12.webp"        alt="تامین قطعات پکیج | تعمیر مارکت">
         </div>
        <br><br>
        <p class="about-brand-title">برد الکترونیکی پکیج</p>
        <div class=" style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/PAKIJ/Q/21.webp"         alt="تامین قطعات پکیج | تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/PAKIJ/Q/22.webp"         alt="تامین قطعات پکیج | تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/PAKIJ/Q/23.webp"        alt="تامین قطعات پکیج | تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/PAKIJ/Q/24.webp"        alt="تامین قطعات پکیج | تعمیر مارکت">
         </div>
        <p class="about-brand-text">
            وظیفه برد الکترونیکی پکیج کنترل و فرماندهی تمامی عملکرد های پکیج شماست.
        </p>
        <br><br>
        <p class="about-brand-title">نکاتی در مورد نگهداری پکیج</p>
        <p class="about-brand-text">
            <p class="about-brand-text">
                1) چک کردن سنسور ها 
                <br><br>
    ...
    <table class="style-of-naqshe-iran-box">
        <tr>
            <td>
                <img class="style-of-naqshe-iran-img" src="img/naqshe iran/naqsh iran.webp" alt="محدوده ی تحت پوشش خدمات | تعمیر مارکت">
            </td>
            <td>

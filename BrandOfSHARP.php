...
<body class="styles-of-body-tag">
    ...
    <div id="slider">
        ...
        <div class="slide">
            <img src="img/slide show/2.webp" alt="">
        </div>
    
        <div class="slide">
            <img src="img/slide show/3.webp" alt="">
        </div>

        <div class="slide">
            <img src="img/slide show/4.webp" alt="">
        </div>

        <div class="slide">
            <img src="img/slide show/5.webp" alt="">
        </div>

        <div class="slide">
            <img src="img/slide show/6.webp" alt="">
        </div>

        <div class="slide">
            <img src="img/slide show/7.webp" alt="">
        </div>

        <div class="slide">
            <img src="img/slide show/8.webp" alt="">
        </div>

        <div class="slide">
            <img src="img/slide show/9.webp" alt="">
        </div>

        <div class="slide">
            <img src="img/slide show/10.webp" alt="">
        </div>
    ...
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/SHARP.webp""                    alt="تعمیر مارکت"></a></div>    
    <div class="right">
        ...
        <br><br>
            ...
            <div class="style-of-ItemTamirat-radif">
                <a href="RepairWashingMachineOfSHARP.php">
                <div class="rotate-ItemTamirat-img style-of-ItemTamirat-div">
                        <img class="style-of-ItemTamirat-img" src="img/ItemTamirat/lebasshoee.webp"       alt="تعمیر مارکت">
                </div>
                </a>
                <a href="RepairDishwasherOfSHARP.php">
                <div class="rotate-ItemTamirat-img style-of-ItemTamirat-div">
                        <img class="style-of-ItemTamirat-img" src="img/ItemTamirat/zarfshoee.webp"        alt="تعمیر مارکت">
                </div>
                </a>
                <a href="RepairSideBySideOfSHARP.php">
                <div class="rotate-ItemTamirat-img style-of-ItemTamirat-div">
                        <img class="style-of-ItemTamirat-img" src="img/ItemTamirat/side.webp"             alt="تعمیر مارکت">
                </div>
                </a>
                ...
                <a href="RepairVacuumeCleanerOfSHARP.php">
                <div class="rotate-ItemTamirat-img style-of-ItemTamirat-div">
                        <img class="style-of-ItemTamirat-img" src="img/ItemTamirat/jarobarqi.webp"        alt="تعمیر مارکت">
                </div>
                </a>
                <a href="RepairAirConditioningOfSHARP.php">
                <div class="rotate-ItemTamirat-img style-of-ItemTamirat-div">
                        <img class="style-of-ItemTamirat-img" src="img/ItemTamirat/kooler gazi.gif"      alt="تعمیر مارکت">
                </div>
                </a>
                </a>
                <a href="RepairKitchenAppliancesOfSHARP.php">
                <div class="rotate-ItemTamirat-img style-of-ItemTamirat-div">
                        <img class="style-of-ItemTamirat-img" src="img/ItemTamirat/la.gif"  alt="تعمیر مارکت">
                </div>
                </a>    
                <a href="RepairPakijOfSHARP.php">
                    <div class="rotate-ItemTamirat-img style-of-ItemTamirat-div">
                            <img class="style-of-ItemTamirat-img" src="img/ItemTamirat/pakij.gif"  alt="تعمیر مارکت">
                    </div>
                </a> 
                <a href="SimTakFazMotorOfSHARP.php">
                    <div class="rotate-ItemTamirat-img style-of-ItemTamirat-div">
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/SHARP.webp"                    alt="تعمیر مارکت"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/SHARP/factory1.webp" alt="کارخانه ی شارپ">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/SHARP/factory2.webp" alt="کارخانه ی شارپ">
        </div>
...
<!-- end script files  -->
 <div class="style-pf-secret-key-words">
<h2 class="style-pf-secret-key-words">تعمیرات تعمیرگاه خدمات تهران کرج البرز ایراد خرابی رفع مشکل علت دللی چرا تخصصی لوازم خانگی آداک تعمیر مارکت تعمیرگر لباسشویی یخچال فریزر ساید بای ماشین ظرفشویی ماکروفر ماکروویو سولاردام کولر ابی آبی گازی جارو برقی شارژی آشپزخانه اشپزخانه</h2>
<h3 class="style-pf-secret-key-words">تعمیرات تعمیرگاه خدمات تهران کرج البرز ایراد خرابی رفع مشکل علت دللی چرا تخصصی لوازم خانگی آداک تعمیر مارکت تعمیرگر لباسشویی یخچال فریزر ساید بای ماشین ظرفشویی ماکروفر ماکروویو سولاردام کولر ابی آبی گازی جارو برقی شارژی آشپزخانه اشپزخانه</h3>
<h4 class="style-pf-secret-key-words">تعمیرات تعمیرگاه خدمات تهران کرج البرز ایراد خرابی رفع مشکل علت دللی چرا تخصصی لوازم خانگی آداک تعمیر مارکت تعمیرگر لباسشویی یخچال فریزر ساید بای ماشین ظرفشویی ماکروفر ماکروویو سولاردام کولر ابی آبی گازی جارو برقی شارژی آشپزخانه اشپزخانه</h4>
<h5 class="style-pf-secret-key-words">تعمیرات تعمیرگاه خدمات تهران کرج البرز ایراد خرابی رفع مشکل علت دللی چرا تخصصی لوازم خانگی آداک تعمیر مارکت تعمیرگر لباسشویی یخچال فریزر ساید بای ماشین ظرفشویی ماکروفر ماکروویو سولاردام کولر ابی آبی گازی جارو برقی شارژی آشپزخانه اشپزخانه</h5>
<h6 class="style-pf-secret-key-words">تعمیرات تعمیرگاه خدمات تهران کرج البرز ایراد خرابی رفع مشکل علت دللی چرا تخصصی لوازم خانگی آداک تعمیر مارکت تعمیرگر لباسشویی یخچال فریزر ساید بای ماشین ظرفشویی ماکروفر ماکروویو سولاردام کولر ابی آبی گازی جارو برقی شارژی آشپزخانه اشپزخانه</h6>

...
<head>
    ...
    <title> تعمیرات لوازم خانگی زانوسی | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی زانوسی 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ZANUSSI.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی زانوسی</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) زانوسی در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی زانوسی را در مدل ها و محصولات مختلف زانوسی، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ZANUSSI.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/ZANUSSI/factory1.png" alt="کارخانه ی زانوسی">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/ZANUSSI/factory2.png" alt="کارخانه ی زانوسی">
        </div>
        <p class="about-brand-title">درباره شرکت زانوسی</p>
        <p class="about-brand-text">
       
  زانوسی، (به انگلیسی: Zanussi) شرکت تولیدکنندهٔ لوازم خانگی ایتالیایی است که در سال ۱۹۸۴ توسط شرکت سوئدی الکترولوکس خریده شد. زانوسی از سال ۱۹۴۶ صادرات از ایتالیا را شروع کرد.

  شرکت زانوسی کار خود را در سال ۱۹۱۶ از یک کارگاه کوچک در شهر پوردنونه توسط آنتونی زانوسی با تولید اجاق و کورهٔ خانگی شروع کرد. این روزها محصولات زانوسی در ایتالیا، چین، تایلند و اکراین تولید می‌شوند.
  
  محصولات این شرکت عبارتند از : ابگرمکن لباسشویی ظرفشویی یخچال اجاق گاز و...
        </p>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ZANUSSI.png""                    alt="سانیاران سرویس"></a></div>
    </div>
    <div class="left">

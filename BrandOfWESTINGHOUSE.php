...
<head>
    ...
    <title> تعمیرات لوازم خانگی وستینگ هاوس | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی وستینگ هاوس 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/WESTINGHOUSE.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی وستینگ هاوس</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) وستینگ هاوس در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی وستینگ هاوس را در مدل ها و محصولات مختلف وستینگ هاوس، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/WESTINGHOUSE.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/WESTINGHOUSE/factory1.png" alt="کارخانه ی وستینگ هاوس">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/WESTINGHOUSE/factory2.png" alt="کارخانه ی وستینگ هاوس">
        </div>
        <p class="about-brand-title">درباره شرکت وستینگ هاوس</p>
        <p class="about-brand-text">
       
  اولین تجسم Westinghouse Electric Corporation ، یک شرکت تولیدی آمریکایی ، در 8 ژانویه 1886 توسط جورج وستینگهاوس تأسیس شد. نام اصلی این شرکت Westinghouse Electric & Manufacturing Company بود و در سال 1945 به نام Westinghouse Electric Corporation تغییر نام یافت. این شرکت شبکه تلویزیونی CBS را در سال 1995 خریداری کرد و قبل از اینکه توسط Viacom در سال 1999 خریداری شود ، به اولین تجسم شرکت CBS تغییر نام داد.
  از آگوست 2019 ، نام تجاری Westinghouse توسط Westinghouse Licensing Corporation ، یک شرکت تابعه از ViacomCBS ، مدیریت می شود. تجارت انرژی هسته ای ، شرکت الکتریکی وستینگهاوس ، در سال 1999 از شرکت الکتریک وستینگهاوس منصرف شد.<div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/WESTINGHOUSE.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت وستینگ هاوس</p>
        <p class="about-brand-text">
        
  وستینگهاوس الکتریک در سال 1886 توسط جورج وستینگهاوس در پیتسبورگ ، پنسیلوانیا تاسیس شد. این شرکت در زمینه توسعه زیرساخت های برق در سراسر ایالات متحده فعال شد. بزرگترین کارخانه های این شرکت در شرق پیتسبورگ پنسیلوانیا ، و لستر ، پنسیلوانیا [1] و در همیلتون ، انتاریو واقع شدند ، جایی که آنها توربین ، ژنراتور ، موتور و دنده سوئیچ برای تولید ، انتقال و استفاده از برق ساختند. [2] علاوه بر جورج وستینگهاوس ، مهندسان اولیه ای که در این شرکت کار می کردند شامل فرانک کنراد ، بنیامین گارور لامه ، برتا لام (اولین زن مهندس مکانیک آمریکا) ، الیور بی شالنبرگر ، ویلیام استنلی ، نیکولا تسلا ، استفان تیموشنکو و ولادیمیر زوریکین بودند.
  اوایل ، وستینگهاوس رقیب شرکت برق توماس ادیسون بود. در سال 1892 ، ادیسون با رقیب اصلی AC وستینگهاوس ، شرکت الکتریک تامسون-هوستون ادغام شد ، و یک رقیب حتی بزرگتر ، جنرال الکتریک بود. شرکت تولیدی و برق Westinghouse نام خود را در سال 1945 به Westinghouse Electric Corporation تغییر داد.
  وستینگهاوس CBS Inc. را در سال 1995 ، به مبلغ 5.4 میلیارد دلار خریداری کرد. [3] [4] شرکت الکتریک وستینگهاوس نام خود را تغییر داده و در سال 1997 به CBS تبدیل شد. [5] همچنین در سال 1997 ، واحد تجاری تولید برق با مقر اصلی در اورلاندو ، فلوریدا ، به زیمنس AG ، از آلمان فروخته شد. [6] یک سال بعد ، CBS تمام تجارت انرژی هسته ای تجاری خود را به British Nuclear Fuels Limited (BNFL) فروخت. [7] در رابطه با آن فروش ، حقوق خاصی برای استفاده از علائم تجاری Westinghouse به شرکت تابعه تازه تاسیس BNFL ، شرکت الکتریک وستینگهاوس اعطا شد. [7] آن شرکت در سال 2006 به توشیبا فروخته شد.</p>
    </div>
    <div class="left">

...
<head>
    ...
    <title> تعمیرات لوازم خانگی وستل | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی وستل 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/VESTEL.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی وستل</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) وستل در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی وستل را در مدل ها و محصولات مختلف وستل، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/VESTEL.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/VESTEL/factory1.png" alt="کارخانه ی وستل">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/VESTEL/factory2.png" alt="کارخانه ی وستل">
        </div>
        <p class="about-brand-title">درباره شرکت وستل</p>
        <p class="about-brand-text">
       
  وستل یک شرکت تولید کننده لوازم خانگی و حرفه ای در ترکیه است که متشکل از 18 شرکت متخصص در زمینه الکترونیک ، لوازم اصلی و فناوری اطلاعات است. دفتر مرکزی و کارخانه تولید وستل در مانیسا واقع شده است ، در حالی که شرکت مادر اصلی این شرکت هولدینگ Zorlu مستقر در استانبول است.<div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/VESTEL.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت وستل</p>
        <p class="about-brand-text">
         
  وستل به همراه مارک های تابعه خود سهم قابل توجهی در بازار الکترونیکی مصرفی و لوازم خانگی اروپا ، به ویژه تلویزیون ها دارد. از سال 2006 ، وستل با فروش بیش از 8 میلیون واحد ، بزرگترین تولیدكننده تلویزیون در اروپا بود كه یك چهارم بازار اروپا را به خود اختصاص داد. وستل همچنین دارای یک مارک تابعه Vestfrost است که برای کالاهای سفید استفاده می شود و Luxor که برای تلویزیون استفاده می شود و در کشورهای شمال اروپا به فروش می رسد. در سال 2014 ، وستل وارد بازار گوشی های هوشمند شد.</p>
    </div>
    <div class="left">

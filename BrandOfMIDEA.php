...
<head>
    ...
    <title> تعمیرات لوازم خانگی مدیا | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی مدیا 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/MIDEA.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی مدیا</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) مدیا در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی مدیا را در مدل ها و محصولات مختلف مدیا، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/MIDEA.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/MIDEA/factory1.png" alt="کارخانه ی مدیا">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/MIDEA/factory2.png" alt="کارخانه ی مدیا">
        </div>
        <p class="about-brand-title">درباره شرکت مدیا</p>
        <p class="about-brand-text">
       
  گروه مایدیا (میدیا) یک تولیدکننده لوازم الکتریکی در چین است که در بیجیااو، شاندی، فوشان و گوانگ‌دونگ واقع‌شده و در لیست بورس اوراق بهادار شنژن قراردارد. از سال ۲۰۱۸، این شرکت حدود ۱۳۵٬۰۰۰ مدیار در چین و خارج از کشور با ۲۰۰ شرکت تابعه و بیش از ۶۰ شعبه خارج از کشور کار می‌کند.این شرکت در فهرست فورچون جهانی ۵۰۰ در ژوئن ۲۰۱۶ ذکر شده‌است.مایدیا بزرگترین تولیدکننده ربات و لوازم‌خانگی در جهان است.<div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/MIDEA.png""                    alt="سانیاران سرویس"></a></div>
        </p>
    </div>
    <div class="left">

...
<head>
    ...
    <title> تعمیرات لوازم خانگی کورال | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی کورال 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/CORAL.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی کورال</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) کورال در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی کورال را در مدل ها و محصولات مختلف کورال، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/CORAL.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/CORAL/factory1.png" alt="کارخانه ی کورال">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/CORAL/factory2.png" alt="کارخانه ی کورال">
        </div>
       <p class="about-brand-title">تاریخچه شرکت کورال</p>
        <p class="about-brand-text">
      
  کرال، دیزاین و طراحی کره ای (Korean Design) مشتمل بر سبد کاملی از لوازم خانگی است که تحت گارانتی و خدمات مشتریان پاک سرویس در کشورهای ایران، آذربایجان، عراق، تاجیکستان، ترکمنستان و ارمنستان توزیع می شود.

  کُرال، دیزاین و طراحی کُره‌ای (Korean Design)
  تغییر شرایط محیطی و الگوی خرید ایرانیان، گروه-برند پاکشوما را به این تدبیر انداخت که با همکاری شرکت ها و موسسات تولیدی و طراحی لوازم خانگی کره جنوبی (South Korean) به خلق یک برند جدید با ترکیب عنصر هیجان، نشاط جوانی و سبک زندگی مدرن و امروزین در سال 2010 میلادی پرداخته که نام این متولد، کُرال است.
  
  کُرال، دیزاین و طراحی کُره ای (Korean Design) مشتمل بر سبد کاملی از محصولات ماشین لباسشوئی، ماشین ظرفشوئی، جاروبرقی، یخچال فریزر، کولرگازی و … است که تحت گارانتی و خدمات مشتریان پاک سرویس (Pak Service) در کشورهای ایران، آذربایجان، عراق، تاجیکستان، ترکمنستان و ارمنستان توزیع می شود. شعار اصلی برند کُرال قلب خانه (Core Of Life) می باشد. این شعار نشات گرفته از نوع طراحی و رنگ آمیزی محصول و نیز نوع کارکرد محصولات است که تعامل پایداری را میان مشتری و خود ایجاد می کند به نحوی که در آخرین تحقیقات بازاریابی داخلی گروه پاکشوما ضریبِ دوست داشتنی ترین، برندِ این گروه پس از پاکشوما، اختصاص به برند کُرال پیدا کرده است.</p>
    </div>
    <div class="left">

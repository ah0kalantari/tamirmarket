...
<body class="styles-of-body-tag">
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/yakhchal/ل جنرال الکتریک.webp" alt="تعمیرات یخچال / فریزر جنرال الکتریک">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی یخچال / فریزر جنرال الکتریک 
        </h1>
        ...
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات یخچال / فریزر جنرال الکتریک</p>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/WM/001.webp" alt="تعمیرات یخچال / فریزر جنرال الکتریک">
        <br><br>
        <p class="about-brand-title">مشکلات رایج انواع یخچال / فریزر</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) نشتی آب در یخچال فریزر</p>
        <p class="style-of-mazit-estfade-az-ma-text">  2) اتومات نکردن یخچال فریزر</p>
        <p class="style-of-mazit-estfade-az-ma-text">  3) برفک زدن یخچال فریزر</p>
        <p class="style-of-mazit-estfade-az-ma-text">  4) سرد شدن بیش از حد یخچال فریزر</p>
        <p class="style-of-mazit-estfade-az-ma-text">  5) گرم شدن بیش از حد یخچال فریزر</p>
        <p class="style-of-mazit-estfade-az-ma-text">  6) وجود سر و صدای بیش از اندازه در یخچال فریزر</p>
        <p class="style-of-mazit-estfade-az-ma-text">  7) روشن نشدن لامپ یخچال فریزر</p>
    </div>
    <div class="left">

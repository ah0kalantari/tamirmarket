...
<body class="styles-of-body-tag">
    ...
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/BEHI.webp""                    alt="تعمیر مارکت"></a></div>    
    <div class="right">
        ...
        <br><br>
            ...
            <div class="style-of-ItemTamirat-radif">
                <a href="RepairWashingMachineOfBEHI.php">
                ...
                <div class="style-of-ItemTamirat-radif">
                <a href="RepairMicrowaveOfBEHI.php">
                <div class="rotate-ItemTamirat-img style-of-ItemTamirat-div">
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/BEHI.webp"                    alt="تعمیر مارکت"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/BEHI/factory1.webp" alt="کارخانه ی بهی">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/BEHI/factory2.webp" alt="کارخانه ی بهی">
        </div>
        ...
        <img class="style-of-left-ra" src="img/left/orginal.webp" alt="chatre sabz">
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> اندازه مناسب ماشین لباسشویی | راهنمای خرید
                            </p>
                        </a>
                    </div>
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> ترفند هایی برای پاک کردن اجاق گاز 
                            </p>
                        </a>
                    </div>
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> پخت و پز در مایکروفر (مایکروویو) و تغذیه سالم
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> راهنمای خرید ماکروفر
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> راهنمای استفاده از کولر گازی قابل حمل ( پرتابل ) </p>
                        </a>
                    </div>
            ...
            <tr>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> اگر شستشوی ماشین ظرفشویی خیلی طولانی شد ، چه باید کرد ؟
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> کارایی دمای پخت فر </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> چرا اجاق گازی از اجاق برقی بهتر است ؟ </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> اجاق القایی چیست ؟ </p>
                        </a>
                    </div>

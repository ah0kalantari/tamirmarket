...
<head>
    ...
    <title> تعمیرات لوازم خانگی حایر | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی حایر 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/HAIER.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی حایر</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) حایر در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی حایر را در مدل ها و محصولات مختلف حایر، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/HAIER.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/HAIER/factory1.png" alt="کارخانه ی حایر">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/HAIER/factory2.png" alt="کارخانه ی حایر">
        </div>
        <p class="about-brand-title">درباره شرکت حایر</p>
        <p class="about-brand-text">
       
  کمپانی حایر یا گروه شرکت های حایر یک شرکت چندملیتی است که در چینگدائو، استان شاندونگ، چین قرار دارد. این شرکت تولیدکننده لوازم الکترونیکی مصرفی و لوازم خانگی است. محصولات مختلف مانند سیستم های تهویه، تلفن همراه، کامپیوتر، ماشین لباسشویی، فریزر و غیره را طراحی، توسعه و تولید کرده و به فروش می رساند.<div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/HAIER.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت حایر</p>
        <p class="about-brand-text">
            
  شرکت حایر تهران در سال ۱۳۶۸ با نام اولیه سپیدگاز با هدف تولید اجاق گاز تأسیس شد. این شرکت در سال ۱۳۷۸ با هدف تولید لباسشویی به حایر تهران تغییر نام داد.

  این مجموعه به عنوان مادر شرکتهای گروه صنعتی انتخاب شروع به کار کرد. از همان ابتدا با هدف رشد تکنولوژی و بدست آوردن دانش فنی روز دنیا با شرکت حایر چین بصورت مشترک و تحت لیسانس این شرکت شروع به تولید لباسشویی دوقلو نمود. ظرف مدت ۴ سال علاوه بر تولید محصول لباسشویی دوقلو، محصول لباسشویی اتوماتیک نیز به سبد محصولی حایر تهران اضافه شد. باتوجه به بومی شدن تولید محصول لباسشویی این شرکت نسبت به تجهیز نمودن خود در زمینه پرسکاری قطعات فلزی اقدام و با راه اندازی خطوط پرسکاری عملاً بسیاری از قطعات فلزی مورد نیاز خود را در داخل شرکت تامین نمود.
  
  در سال ۱۳۹۰، شرکت حایر تهران تبدیل به یک مجموعه فلزکاری و تولید قطعات فلزی گردید و خطوط مونتاژ لباسشویی به کارخانه دیگری از زیر مجموعه های گروه واگذار گردید. همچنین در این سال با استقرار ۲۲ دستگاه پرس ضربه ای دیگر با تکنولوژی روز دنیا و تنوع ظرفیت از ۱۱۰ تا ۵۰۰ تن در خطوط پرسکاری حایر تهران تحولی عظیم رخ داد.
        </p>
    </div>
    <div class="left">

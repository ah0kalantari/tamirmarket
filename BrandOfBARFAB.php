...
<body class="styles-of-body-tag">
    ...
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/BARFAB.webp""                    alt="تعمیر مارکت"></a></div>    
    <div class="right">
        ...
        <br><br>
            ...
            <div class="style-of-ItemTamirat-radif">
                <a href="RepairWashingMachineOfBARFAB.php">
                ...
                <div class="style-of-ItemTamirat-radif">
                <a href="RepairMicrowaveOfBARFAB.php">
                <div class="rotate-ItemTamirat-img style-of-ItemTamirat-div">
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/BARFAB.webp"                    alt="تعمیر مارکت"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/BARFAB/factory1.webp" alt="کارخانه ی برفاب">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/BARFAB/factory2.webp" alt="کارخانه ی برفاب">
        </div>
        ...
        <img class="style-of-left-ra" src="img/left/orginal.webp" alt="chatre sabz">
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> یخچال را چگونه رنگ آمیزی کنیم ؟
                            </p>
                        </a>
                    </div>
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> آموزش ریست کردن فیلتر یخچال ، تمام برند ها و مدل ها 
                            </p>
                        </a>
                    </div>
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> جای صحیح مواد غذایی در یخچال
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> افزایش بازدهی انرژی یخچال
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> شیوه آب کردن برفک های یخچال </p>
                        </a>
                    </div>
            ...
            <tr>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> ترموستات های یخچال و فریزر  </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> حفظ تازگی میوه و سبزیجات در یخچال فریزر
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> علت داغ شدن کمپرسور یخچال </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> چگونه متوجه شویم آیا گاز یخچال خالی شده یا خیر ؟ </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> یخچال و فریزر مدل حرفه ای فریجیدر </p>
                        </a>
                    </div>

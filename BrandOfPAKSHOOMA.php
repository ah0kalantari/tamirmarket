...
<head>
    ...
    <title> تعمیرات لوازم خانگی پاکشوما | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی پاکشوما 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/PAKSHOOMA.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی پاکشوما</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) پاکشوما در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی پاکشوما را در مدل ها و محصولات مختلف پاکشوما، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/PAKSHOOMA.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/PAKSHOOMA/factory1.png" alt="کارخانه ی پاکشوما">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/PAKSHOOMA/factory2.png" alt="کارخانه ی پاکشوما">
        </div>
        <p class="about-brand-title">درباره شرکت پاکشوما</p>
        <p class="about-brand-text">
       
  پاکشوما شرکتی تولیدی صنعتی است که فعالیت خود را در سال ۱۳۵۴ با تولید ماشین‌های لباسشویی نیمه اتوماتیک آغاز نمود. در سال ۱۳۷۶ مالکیت و مدیریت آن تغییر کرد و به تولید محصولاتی چون لباس‌شویی اتوماتیک و نیمه اتوماتیک درِ جلو و بالا، ظرفشویی، مایکروفر، جاروبرقی و کولر آبی و گازی و یخچال ساید بای ساید روی آورد.<div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/PAKSHOOMA.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت پاکشوما</p>
        <p class="about-brand-text">
       
  شرکت پاکشوما دارای چهل سال سابقه در تولید انواع لباسشویی می‌باشد. سبد محصولات آن شامل ماشین لباسشویی، ماشین ظرفشویی، یخچال ساید بای ساید، جاروبرقی، مایکروفر و کولر می‌باشد. پاکشوما دارای بیش از ۶۰۰ مرکز نمایندگی خدمات پس از فروش و ۴۰۰ نمایندگی فروش در سطح ایران و حدود ۱۰۰ مدل مختلف انواع لوازم خانگی است.
  ساخت کارخانه
  ساخت کارخانه جدید پاکشوما در اردیبهشت ۱۳۹۳ در شهرک صنعتی محمودآباد قم با وسعت ۱۰۰٫۰۰۰ متر مربع و ۳۰٫۰۰۰ متر سالن و انبار برای تولید قطعات و دو خط کامل به بهره‌برداری رسید و در خرداد ۱۳۹۴ ۳۰٫۰۰۰ متر مربع دیگر به سالن‌های تولیدی افزوده شد و۶۰٫۰۰۰ متر مربع شامل ۳ خط کامل تولید به بهره‌برداری رسید. این کارخانه پاکشوما دارای حدود ۱۰۰۰  نیرو می‌باشد.
  گواهینامه‌ها
  گواهینامه‌های سیستم‌های مدیریتی: (10004 ISO 10002, ISO 14001, ISO و ISO 9001).
  تندیس زرین در گروه ماشین ظرفشویی در سومین جشنواره برند محبوب مصرف‌کنندگان برگزار شد.
  برند پاکشوما:تندیس زرین برند محبوب ایرانی در نظرسنجی سال ۹۲.</p>
    </div>
    <div class="left">

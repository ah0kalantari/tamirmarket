...
<body class="styles-of-body-tag">
    ...
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/GENERAL ELECTRIC.webp""                    alt="تعمیر مارکت"></a></div>    
    <div class="right">
        ...
        <br><br>
            ...
            <div class="style-of-ItemTamirat-radif">
                <a href="RepairWashingMachineOfGENERALELECTRIC.php">
                ...
                <div class="style-of-ItemTamirat-radif">
                <a href="RepairMicrowaveOfGENERALELECTRIC.php">
                <div class="rotate-ItemTamirat-img style-of-ItemTamirat-div">
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/GENERAL ELECTRIC.webp"                    alt="تعمیر مارکت"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/GENERAL ELECTRIC/factory1.webp" alt="کارخانه ی جنرال الکتریک">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/GENERAL ELECTRIC/factory2.webp" alt="کارخانه ی جنرال الکتریک">
        </div>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/GENERAL ELECTRIC.webp""                    alt="تعمیر مارکت"></a></div>
        ...
        <img class="style-of-left-ra" src="img/left/orginal.webp" alt="chatre sabz">
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> آیا ماکروفر ها با گذشت زمان قدرتشان را از دست می دهند ؟
                            </p>
                        </a>
                    </div>
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> آیا می توانیم ماشین ظرفشویی را به آب گرم وصل کنیم ؟
                            </p>
                        </a>
                    </div>
            ...
            <tr class="left-tr-poshesh">
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> راهنمای تعمیر سیستم دیفراست یخچال
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> علل برق داشتن بدنه یخچال
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> سه نکته در مورد تمیز کردن ماشین ظرفشویی بوش </p>
                        </a>
                    </div>
            ...
            <tr>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> مقایسه انواع فر بخار پز ، سرعتی و کانوکشن </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> علت روشن نشدن لامپ یخچال
                            </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> تعویض روغن موتور یخچال </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> نو آوری های جدید برای اجاق گاز </p>
                        </a>
                    </div>
                ...
                <td class="left-poshesh">
                    <div class="left-left">
                        <a class="left-a" href="">
                            <p class="left-left-p"> ده راهنمایی برای کارآمد تر کردن ماشین ظرفشویی تان </p>
                        </a>
                    </div>

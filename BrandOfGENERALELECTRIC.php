...
<head>
    ...
    <title> تعمیرات لوازم خانگی جنرال الکتریک | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی جنرال الکتریک 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/GENERAL ELECTRIC.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی جنرال الکتریک</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) جنرال الکتریک در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی جنرال الکتریک را در مدل ها و محصولات مختلف جنرال الکتریک، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/GENERAL ELECTRIC.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/GENERAL ELECTRIC/factory1.png" alt="کارخانه ی جنرال الکتریک">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/GENERAL ELECTRIC/factory2.png" alt="کارخانه ی جنرال الکتریک">
        </div>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/GENERAL ELECTRIC.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت جنرال الکتریک</p>
        <p class="about-brand-text">
        
  جنرال الکتریک (به انگلیسی: General Electric) ابرشرکت خوشه‌ای آمریکایی است، که در زمینه تولید تجهیزات پزشکی، تاسیسات تولید و توزیع برق، توربین‌های گازی و بادی، موتورهای الکتریکی و لکوموتیو، لوازم خانگی، ابزارهای الکترونیکی و نورپردازی، جنگ‌افزارها، تجهیزات هوافضا فعالیت می‌کند.]

  ابرشرکت جنرال الکتریک مالک ۴ شرکت تابعه؛ جی‌ای انرژی، جی‌ای فناوری، جی‌ای کپیتال و جی‌ای هلت‌کر می‌باشد.این ابرشرکت در سال ۲۰۱۸ در فهرست فرچون ۵۰۰ در رتبه ۱۸ از بزرگترین شرکت‌های آمریکا قرار گرفت. جنرال الکتریک در سال ۲۰۱۲ در فهرست فوربز جهانی ۲۰۰۰ در رتبه سوم از بزرگترین شرکت‌های جهان قرار داشت.[۷][۸][۹] دفتر عملیاتی این ابرشرکت در سکنکتدی، نیویورک قرار دارد و دفتر مرکزی آن در فیرفیلد، کنتیکت مستقر می‌باشد.</p>
    </div>
    <div class="left">

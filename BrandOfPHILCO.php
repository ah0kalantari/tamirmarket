...
<head>
    ...
    <title> تعمیرات لوازم خانگی فیلکو | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی فیلکو 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/PHILCO.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی فیلکو</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) فیلکو در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی فیلکو را در مدل ها و محصولات مختلف فیلکو، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/PHILCO.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/PHILCO/factory1.png" alt="کارخانه ی فیلکو">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/PHILCO/factory2.png" alt="کارخانه ی فیلکو">
        </div>
        <p class="about-brand-title">درباره شرکت فیلکو</p>
        <p class="about-brand-text">
            شرکت فیلکو با نام هلیوس الکتریک در سال 1892 تاسیس شد. این شرکت در تولید باتری، رادیو و تلویزیون پیشرو بود. این شرکت توسط کمپانی فورد خریداری شده و به فیلکو تغییر نام داد . در سال 1974 این شرکت توسط  کمپانی فیلیپس خریداری شد تلویزیون لوله خلا یکی از اختراعاتی است که به نام این شرکت ثبت شده است <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/PHILCO.png""                    alt="سانیاران سرویس"></a></div>
        </p>
    </div>
    <div class="left">

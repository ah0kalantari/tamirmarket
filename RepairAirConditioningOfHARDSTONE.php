...
<head>
    ...
    <title>تعمیرات کولرگازی هارداستون | سانیاران سرویس</title>
</head>
<body class="styles-of-body-tag">
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/AIR/ل هارداستون.jpg" alt="تعمیرات کولرگازی هارداستون">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی کولرگازی هارداستون 
        </h1>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/HARDSTONE.png"                    alt="سانیاران سرویس"></a></div>    
        <br>
        <h2 class="style-of-moarefi-shoql">
        ...
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات کولرگازی هارداستون</p>
        ...
        <br><br>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/HARDSTONE 2.png"                    alt="سانیاران سرویس"></a></div>    
        <br><br>
        ...
        (کولرگازی، کولرگازی، یخچال، ماکروویو، جاروبرقی و کولرگازی) هارداستون در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی هارداستون را در مدل ها و محصولات مختلف هارداستون، گذرانده اند.
        <br>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/AIR/001.png" alt="تعمیرات کولرگازی هارداستون">
        <br><br>

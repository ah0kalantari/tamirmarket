...
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی اسنوا 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/SNOWA.png"                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی اسنوا</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) اسنوا در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی اسنوا را در مدل ها و محصولات مختلف اسنوا، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/SNOWA.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/snowa/factory1.png" alt="کارخانه ی اسنوا">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/snowa/factory2.png" alt="کارخانه ی اسنوا">
        </div>
        <p class="about-brand-title">درباره شرکت اسنوا</p>
        <p class="about-brand-text">
            ابرشرکت اسنوا، (به انگلیسی: SNOWA Corporation) ابرشرکت خوشه‌ای کره‌ای است. این ابرشرکت پس از سامسونگ، دومین شرکت خوشه‌ای (فعال در چند صنعت) در کشور کره جنوبی می‌باشد. دفتر مرکزی گروه اسنوا در برج دوقلوی اسنوا، در شهر سئول قرار دارد.

            اسنوا محصولات خود را در سه بخش: وسایل الکترونیکی، مواد شیمیایی و تجهیزات مخابراتی تقسیم نموده، که هر کدام از بخش‌ها، تحت مدیریت یک یا چند شرکت تابعه و زیرمجموعه قرار دارند.
            
            شرکت‌های تابعه گروه اسنوا عبارتند از: اسنوا الکترونیکس، زنیت الکترونیکس، اسنوا دیسپلی، اسنوا تلکام و اسنوا کمیکال که در بیش از ۸۰ کشور جهان فعالیت می‌کنند.           
        </p>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/SNOWA.png"                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت اسنوا</p>
        <p class="about-brand-text">
            ...
            در ژانویه ۲۰۱۳، اسنوا الکترونیکس نخستین تلویزیون تجاری بر پایه دیود گسیل نور ارگانیک (OLED) را روانه بازار کرد. صفحه تلویزیونی این نسل از نمایشگرها به نسبت تلویزیون‌های ال‌سی‌دی متداول و نمایشگرهای پلاسما بسیار نازک‌تر و واضح‌تر هستند.
        </p>
    </div>
    <div class="left">

...
<head>
    ...
    <title> تعمیرات لوازم خانگی پارس | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی پارس 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/PARS.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی پارس</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) پارس در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی پارس را در مدل ها و محصولات مختلف پارس، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/PARS.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/PARS/factory1.png" alt="کارخانه ی پارس">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/PARS/factory2.png" alt="کارخانه ی پارس">
        </div>
        <p class="about-brand-title">درباره شرکت پارس</p>
        <p class="about-brand-text">
       
  شرکت کارخانجات لوازم خانگی پارس (سهامی عام) در تاریخ 06/02/1354 بصورت شرکت سهامی خاص تاسیس شده و طی شماره 21482 در اداره ثبت شرکتها و مالکیت صنعتی تهران به ثبت رسیده است و در تاریخ 23/09/1373 به شرکت سهامی عام تبدیل و در تاریخ 08/11/1373 در بورس اوراق بهادار پذیرفته شده است و در مورخ 16/09/1391 به بازار پایه فرابورس منتقل شده است.
  ...
  مجموع زیربنای هر دو کارخانه حدود 114 هزار مترمربع میباشد.
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/PARS.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت پارس</p>
        <p class="about-brand-text">
        
  با توجه به سرعت رشد صنعت لوازم خانگی و رقابت فشرده در این صنعت و نیازهای متنوع و جدید مصرف کنندگان محصولات لوازم خانگی پارس استراتژی تولید خود را بر تنوع محصولات با کیفیت و با هدف برآوردن نیاز مشتریان و بهبود مستمر بنا نهاده و خصوصاً از سال 1376 سرمایه گذاریهای اساسی در نوسازی ماشین آلات بر اساس آخرین تکنولوژی روز به عمل آورده است.

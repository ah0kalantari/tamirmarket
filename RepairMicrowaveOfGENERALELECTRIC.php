...
<head>
    ...
    <title> تعمیرات مایکروویو سانیاران سرویس | saniaran service Washing Machine repair</title>
</head>
<body class="styles-of-body-tag">
                                         ...
                                         <ul id="style-of-zirmenu-of-tamirat" class="style-of-zirmenu-of-tamirat">
                                            <li onmouseover="showzirmajmoee2()" onmouseout="hidezirmajmoee2()" class="style-of-sdf background-color-0e4797-hover"><a class="style-of-text-of-zirmenus style-of-sdf"  >لوازم خانگی</a>
                                                <ul id="style-of-zirmenu-of-tamirat2" class="style-of-zirmenu-of-tamirat2" class="style-of-all-of-zirmajmoee">
                                                    <li class="style-of-sdf"><a class="style-of-text-of-zirmenus style-of-sdf" href="RepairWashingMachine.php"> لباسشویی</a></li>
                                             ...
                                             <ul>
                                                <li class="style-of-menu-text-in-mo" onclick="displayOfZirMenuInMo2()"><a>لوازم خانگی</a><hr class="white-hr">
                                                    <ul id="display-of-zir-menu-in-mo2" class="display-of-zir-menu-in-mo2">
                                                        <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="RepairWashingMachine.php"> لباسشویی</a></li><hr class="white-hr">
    ...
    <h2 class="style-of-moarefi-shoql">
        ...
        <br>
        لباسشویی , کولرگازی, ساید بای ساید , یخچال, کولر گازی و آبی, مایکروویو , جاروبرقی
    </h2>
    <br>
    <br>
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/MIC/ل جنرال الکتریک.jpg" alt="تعمیرات کولرگازی جنرال الکتریک">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی مایکروویو جنرال الکتریک 
        </h1>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/GENERAL ELECTRIC.png"                    alt="سانیاران سرویس"></a></div>    
        <br>
        <h2 class="style-of-moarefi-shoql">
            عضو رسمی اتحادیه تعمیرکاران لوازم خانگی
        </h2>
        <br>
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات مایکروویو سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات مایکروویو جنرال الکتریک</p>
        <p class="style-of-mazit-estfade-az-ma-text">  2) استفاده از لوازم و قطعات اصلی (اورجینال ) در تعمیرات مایکروویو </p>
        <p class="style-of-mazit-estfade-az-ma-text">  3) تمامی خدمات شرکت سانیاران سرویس دارای 100 روز گارانتی بی قید و شرط می باشد</p>
        <br><br>
        <div><a><img class="style-of-brand-img-in-brand-page2" src="img/brand images/GENERAL ELECTRIC 2.png"                    alt="سانیاران سرویس"></a></div>    
        <br><br>
        ...
        (مایکروویو، مایکروویو، یخچال، ماکروویو، جاروبرقی و مایکروویو) جنرال الکتریک در خدمت شماست.
        <br>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <p class="about-brand-title">درباره مایکروویو</p>
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/MIC/001.png" alt="تعمیرات مایکروویو جنرال الکتریک">
        <br><br>
    ...
    <div class="display-none-mo">
        <div class="style-of-ItemTamirat-radif style-of-ItemTamirat-radif-in-brand-page dtngjdfjiogdrjiogfyhsei">
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/MIC/1.png"       alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/MIC/2.png"        alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/MIC/3.png"             alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/MIC/4.png"            alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/MIC/8.png"            alt="سانیاران سرویس">
            </div>
        </div>
        <br><br>
        <div class="style-of-ItemTamirat-radif style-of-ItemTamirat-radif-in-brand-page dtngjdfjiogdrjiogfyhsei">
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/MIC/5.png"       alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/MIC/6.png"        alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/MIC/7.png"             alt="سانیاران سرویس">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/MIC/8.png"            alt="سانیاران سرویس">
            </div>

...
<head>
    ...
    <title> تعمیرات لوازم خانگی الکترولوکس | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی الکترولوکس 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ELECTROLUX.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی الکترولوکس</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) الکترولوکس در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی الکترولوکس را در مدل ها و محصولات مختلف الکترولوکس، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ELECTROLUX.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/ELECTROLUX/factory1.png" alt="کارخانه ی الکترولوکس">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/ELECTROLUX/factory2.png" alt="کارخانه ی الکترولوکس">
        </div>
        <br><br>
        <!-- <p class="about-brand-title">درباره شرکت الکترولوکس</p>
        <p class="about-brand-text">
  الکترولوکس (به آلمانی: AlELECTROLUXemeine Elektrizitäts-Gesellschaft AG) (اختصاری ELECTROLUX) به معنای «شرکت برق عمومی» یکی از بزرگترین شرکت‌های تولیدکننده تجهیزات الکتریکی در جهان بود که در سال ۱۸۸۳ به دست امیل راتناو (به آلمانی: Emil Rathenau) در برلین بنیان گذاشته شد و در سال ۱۹۵۱ دفتر مرکزی آن به فرانکفورت منتقل شد.[۱]
  ...
  نام تجاری ELECTROLUX در سال ۱۹۹۶ توسط الکترولوکس تصاحب شد و از سال ۲۰۰۵ در بعضی محصولات این شرکت استفاده می‌شود، نام تجاری آ.اِ.گ همچنین توسط شرکای گوناگون الکترولوکس تحت "برنامهٔ همگانی صدور مجوز نام تجاری" شرکت الکترولوکس کسب مجوز شده‌است. </p>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/ELECTROLUX.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت الکترولوکس</p>
        <p class="about-brand-text">
            
  امیل راتناو در سال ۱۸۸۳ شرکت "آلمانی برق ادیسون " را در برلین تأسیس نمود. این شرکت به شرکت آ ا گ در سال ۱۸۸۷ تغییر نام یافت. در ابتدا درگیر تولید تجهیزات الکتریکی (مانند لامپ، موتور و ژنراتور) شد، شرکت خیلی زود در سیستم‌های انتقال برق AC وارد شد. در سال ۱۹۰۷ پتر بهرنس به عنوان مشاور هنری ELECTROLUX منصوب شد. این امر منجر به ایجاد اولیه هویت سازمانی این شرکت با محصولات و به اشتراک گذاری تبلیغات ویژگی‌های طراحی مشترک گشت.
  ...
  پس از جنگ جهانی دوم، آ ا گ کسب و کار خود را در بخش شرقی آلمان از دست داد. پس از ادغام در سال ۱۹۶۷ این شرکت به آ.اِ.گ-تِلِفونکِن تغییر نام داد. آ ا گ مشکلات مالی فراوانی را در طول سال‌های ۱۹۷۰ تجربه نمود، و در نتیجه برخی از دارایی خود را فروخت. در سال ۱۹۸۳ بخش لوازم الکترونیکی مصرفی Telefunken Fernseh und Rundfunk GmbH فروخته شد. در سال ۱۹۸۵ این شرکت دوباره نام ELECTROLUX را توسط دایملر بنز بدست آورد. قسمت‌های باقی مانده در درجه اول مربوط به توزیع و انتقال برق و فناوری موتور الکتریکی بود. تحت مالکیت دایملر بنز، شرکت‌های تشکیل دهنده ELECTROLUX در نهایت در سال ۱۹۹۵ بخشی از شرکت جدید ادترنز تبدیل شدند. الکترولوکس، که در حال حاضر حق استفاده از مجوز نام تجاری آ ا گ را در بخش لوازم خانگی ELECTROLUX از سال ۱۹۹۴ به دست آورده‌است. 

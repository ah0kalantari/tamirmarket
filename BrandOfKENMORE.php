...
<head>
    ...
    <title> تعمیرات لوازم خانگی کنمور | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی کنمور 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/KENMORE.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی کنمور</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) کنمور در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی کنمور را در مدل ها و محصولات مختلف کنمور، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/KENMORE.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/KENMORE/factory1.png" alt="کارخانه ی کنمور">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/KENMORE/factory2.png" alt="کارخانه ی کنمور">
        </div>
        <p class="about-brand-title">درباره شرکت کنمور</p>
        <p class="about-brand-text">
       
  کنمور جزو محبوب ترین و بهترین برندهای لوازم خانگی درایالات متحده است . در حال حاضر از هر ۳ آمریکایی، یک نفر محصولات برند کنمور را داراست . محصولات کنمور به دلیل قیمت مناسب و داشتن کیفیت بالا از بهترین و محبوب ترین برند در ایالات متحده است .

  کنمور مجموعه ای از اولین ها را در لیست لوازم  خود آورده است. اولین لوازم خانگی های اتومات، زیباترین ظاهر را دارند و از کم مصرف ترین لوازم خانگی هستند .
  
  خط تولید لوازم خانگی کنمور انواع مختلفی از محصولات مثل لامپ های خورشیدی،  لباسشویی، جاروبرقی، ظرفشویی، ماکروویو  و … را تولید می کند.
        </p>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/KENMORE.png""                    alt="سانیاران سرویس"></a></div>

...
<head>
    ...
    <title> تعمیرات لوازم خانگی آاگ | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی آاگ 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/AEG.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی آاگ</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) آاگ در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی آاگ را در مدل ها و محصولات مختلف آاگ، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/AEG.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/AEG/factory1.png" alt="کارخانه ی آاگ">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/AEG/factory2.png" alt="کارخانه ی آاگ">
        </div>
        <p class="about-brand-title">درباره شرکت آاگ</p>
        <p class="about-brand-text">
       
  آاگ (به آلمانی: Alaegemeine Elektrizitäts-Gesellschaft AG) (اختصاری AEG) به معنای «شرکت برق عمومی» یکی از بزرگترین شرکت‌های تولیدکننده تجهیزات الکتریکی در جهان بود که در سال ۱۸۸۳ به دست امیل راتناو (به آلمانی: Emil Rathenau) در برلین بنیان گذاشته شد و در سال ۱۹۵۱ دفتر مرکزی آن به فرانکفورت منتقل شد.[۱]

  این شرکت در سال ۱۹۶۷ به شرکت تابع خود تِلِفونکِن آ.گ. ملحق شد و شرکت جدید آ.اِ.گ-تِلِفونکِن را به وجود آورد. در سال ۱۹۸۵ شرکت دایملر بنز، شرکت آ.اِ.گ-تِلِفونکِن را خریداری نمود و در سال ۱۹۹۶ با این شرکت کاملاً یکپارچه شد و تحت نام دایملِر-بِنز آ.گ. در آمدند، بخش‌های باقی‌ماندهٔ آ.اِ.گ به دایملِر-کرایسلِر-هوافضا که از شرکت‌های وابسته دایملر-بنز بود و ادترنز الحاق شدند.
  
  نام تجاری AEG در سال ۱۹۹۶ توسط الکترولوکس تصاحب شد و از سال ۲۰۰۵ در بعضی محصولات این شرکت استفاده می‌شود، نام تجاری آ.اِ.گ همچنین توسط شرکای گوناگون الکترولوکس تحت "برنامهٔ همگانی صدور مجوز نام تجاری" شرکت الکترولوکس کسب مجوز شده‌است. </p>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/AEG.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت آاگ</p>
        <p class="about-brand-text">

...
<head>
    ...
    <title>تعمیرات کولرگازی آریستون | سانیاران سرویس</title>
</head>
<body class="styles-of-body-tag">
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/AIR/ل آریستون.jpg" alt="تعمیرات کولرگازی آریستون">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی کولرگازی آریستون 
        </h1>
        ...
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات کولرگازی آریستون</p>
        ...
        (کولرگازی، کولرگازی، یخچال، ماکروویو، جاروبرقی و کولرگازی) آریستون در خدمت شماست.
        <br>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/AIR/001.png" alt="تعمیرات کولرگازی آریستون">
        <br><br>

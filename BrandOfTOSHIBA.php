...
<head>
    ...
    <title> تعمیرات لوازم خانگی توشیبا | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی توشیبا 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/TOSHIBA.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی توشیبا</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) توشیبا در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی توشیبا را در مدل ها و محصولات مختلف توشیبا، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/TOSHIBA.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/TOSHIBA/factory1.png" alt="کارخانه ی توشیبا">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/TOSHIBA/factory2.png" alt="کارخانه ی توشیبا">
        </div>
        <p class="about-brand-title">درباره شرکت توشیبا</p>
        <p class="about-brand-text">
       
  توشیباشرکت خوشه‌ای ژاپنی و چندملیتی  است، که در حوزه‌های تجهیزات ارتباطاتی، قطعات الکترونیکی، سیستم‌های برق، زیرساخت‌های شهری و صنعتی، لوازم خانگی، تجهیزات پزشکی، لوازم اداری و دفتری، ابزارهای روشنایی، تجهیزات نورپردازی و نیز ارائه خدمات لجیستیک فعالیت می‌نماید.

  ریشه‌های تأسیس این شرکت به سال ۱۸۷۵ و راه‌اندازی شرکت تاناکا سیزو-شا توسط تاناکا هیساشیگ بازمی‌گردد. فرم کنونی توشیبا در سال ۱۹۳۹ با ادغام شرکت‌های تاناکا سیزو-شا و توکیو دنکی (تأسیس: ۱۸۹۰) شکل گرفت. هم‌اکنون توشیبا، پس از شرکت‌های اچ‌پی، دل، ایسر و لنوو، در رتبه پنجم از بزرگترین تولیدکنندگان رایانه‌های شخصی قرار دارد. این شرکت همچنین پس از شرکت‌های اینتل، سامسونگ و تگزاس اینسترومنتس، به‌عنوان چهارمین تولیدکننده نیم‌رساناها در جهان، شناخته می‌شود.
  
  دفتر مرکزی شرکت توشیبا در شهر توکیو، ژاپن قرار دارد و بخشی از سهام آن در بازارهای بورس توکیو، بورس لندن، بورس ناگویا و بورس اوساکا معامله می‌شود و جزئی از شاخص نیکی ۲۲۵ و شاخص تاپیکس بشمار می‌آید.
  <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/TOSHIBA.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت توشیبا</p>
        <p class="about-brand-text">
        
  در سال ۱۸۷۵ نخستین کارخانجات تولید تجهیزات و دستگاه‌های تلگراف در ژاپن، با نام محلی تاناکا سیزو-شو و به معنی کارخانه مهندسی تاناکا، به کار افتاد. مؤسس آن تاناکا هیساشیگ (۱۷۹۹-۱۸۸۱) به خاطر اختراعاتش که شامل عروسک‌های مکانیکی و یک ساعت که به وسیله رزونانس (تشدید) عمل می‌کرد، بسیار معروف بود. تحت عنوان شیبورا سیزاکو شو، شرکت او به یکی از بزرگ‌ترین تولیدکنندگان تجهیزات و دستگاه‌های سنگین الکتریکی تبدیل شد. در سال ۱۸۹۰ میلادی هاکونتسو نخستین کمپانی بزرگ ژاپن در زمینه تولید لامپ‌های برقی تأسیس گردید. گام بعدی در راه توسعه این شرکت و تنوع محصولات، اضافه شدن کالاهای مصرفی به محصولات آن بود.

  در ۱۸۹۹ میلادی نام شرکت به توکیو دنکی یا همان شرکت برق توکیو تغییر پیدا کرد. در سال ۱۹۳۹ این دو کمپانی تقریباً معروف استراتژی‌های خود را نزدیک یافته و مدیران آن‌ها تصمیم به ادغام گرفتند. بدین ترتیب آن‌ها به یک کارخانجات مجتمع تجهیزات الکتریکی بدل شدند؛ با نام محلی توکیو شیبورا دنکی. این شرکت بزرگ به زودی تحت عنوان توشیبا مشهور شد و در سال ۱۹۷۸ نام رسمی این شرکت به‌فرم کنونی تبدیل گشت. توکیو شیبورا دنکی در سال ۱۹۳۰ نخستین ماشین لباس‌شویی برقی و نیز یخچال، در ژاپن را ساخت. سال بعد، نخستین جارو برقی ژاپنی به بازار عرضه شد. سال ۱۹۴۲ نخستین رادار توسط توکیو شیبورا دنکی تکمیل و عرضه گردید. در سال ۱۹۵۵ پلوپز برقی و چهار سال بعد، نخستین تلویزیون ترانزیستوری و اجاق مایکروویو توسط توشیبا ساخته شد.
  
  این در حالی است، که شرکت برق توکیو، پیش از ادغام و تشکیل رسمی توشیبا، نخستین موتور القایی و نیز ژنراتور برق چرخ آبی ۶۰ کیلووات را ساخته بود و در دهه ‎های ۱۹۱۰ و ۱۹۲۰ موفق  به تولید لوله پرتو اکس و پرتو کاتدیک شده بود.
  
  در سال ۱۹۶۳ نخستین توربین نیروگاه هسته‎ای به قدرت ۱۲٫۵۰۰ کیلووات توسط توشیبا تکمیل و به کار گرفته شد. در فاصله این دو دهه، آزمایشگاه‌های تحقیقاتی بسیاری توسط شرکت راه اندازی شد.
  
  تا سال ۱۹۷۸ که نخستین واژه‌پرداز ژاپنی توسط توشیبا به بازار آمد، کارخانه‎های نورد، توربین‌سازی، سیلیکون، لوازم خانگی و تجهیزات الکتریکی و تولید لامپ، توسط شرکت فعال شده و به کار مشغول بودند.
  
  نخستین سیستم پزشکی ام‌آرآی در سال ۱۹۸۲ توسط توشیبا عرضه شد. دو سال بعد، بزرگترین نیروگاه سلول‌های خورشیدی ۵۰ کیلوواتی در ژاپن راه‌اندازی شد. نخستین رایانه شخصی کیفی (لپ‌تاپ) در سال ۱۹۸۵ توسط توشیبا ارائه گردید.
  
  در ۱۹۹۵ دیسک‌های دی‌وی‌دی با چگالی بالا توسط شرکت توسعه یافت و سال بعد دستگاه دی‌وی‌دی و دی‌وی‌دی خوان عرضه شد. توشیبا نخستین تلویزیون تخت را نیز در سال ۱۹۹۸ به بازار ارائه کرد. با ورود به هزاره جدید تولید تلویزیون دیجیتالی در دستور کار شرکت قرار گرفت. در سال ۲۰۰۵، توشیبا در عرضه اچ‌دی – دی‌وی‌دی سرآمد گشت. امروزه شرکت توشیبا در حوزه صنعت الکترونیک و تجهیزات برقی پس از زیمنس، سامسونگ، هیتاچی، ماتسوشیت، سونی و توشیبا در مقام هفتم جهان ایستاده است.
  
  در سال‌های آغازین هزاره نو، توشیبا همکاری مشارکتی با پاناسونیک را برای یکپارچه سازی کسب‌وکار تولید ال‌سی‌دی در دستور کار قرار داد. تولید حافظه‎های کوچک فلش با ظرفیت‌های مختلف از فعالیت‌های شرکت توشیبا بود. ظرفیت ۸ گیگابایتی این نوع حافظه‌ها در سال ۲۰۰۵ توسط این شرکت به بازار عرضه شد.
  
  در سال ۲۰۰۴ کوچکترین سلول سوختی متانول با خروجی انرژی ۱۰۰ مگاوات تکمیل و توسعه یافت. توشیبا در سال ۲۰۰۶، کسب‎وکار نیروگاه هسته‌ای وستینگهاوس را خریداری کرد. این شرکت در سال ۲۰۰۹ بخش تولید دیسک سخت شرکت فوجیتسو را نیز، بدست آورد.

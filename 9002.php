...
<body class="styles-of-body-tag" onscroll="hide_menu_desktop()">
    ...
    <table class="blog-etelaat display-none-mo">
        <captiion>
            <h2 class="blog-titr">
                بررسی دلایل روشن نشدن ( کار نکردن ) ماشین لباسشویی 
            </h2>
        </captiion>
        <tr>
            <td class="blog-etelaat-left">
            اموزش / آموزش تعمیرات لوازم خانگی / آموزش تعمیرات لباسشویی
            </td>
    ...
    <br>
    <img class="style-of-orginal-brand-image" src="img/blog/9002/1.jpg" alt="تعمیرات کولرگازی ارج">
    <br>   
    <br> 
        <p class="blog-first-text-p">
        در گذشته انسان ها برای شستشوی لباس ها باید با دست اقدام به شستشو می کردند.
        </p>
        <br>
        <p class="blog-text-p">اختراع لباسشویی جایگزینی برای شستشوی لباس ها با دست شد. 
        <br>
        پس از این تحول بزرگ در زندگی روزمره انسان ها بحث پیشگیری از خرابی این تجهیزات مطرح بوده و هست . 
        <br>
        در این مقاله از مجله آموزشی تعمیر مارکت به بررسی دلایل روشن نشدن ماشین لباسشویی خواهیم پرداخت .
        </p>
        <br>

        <div  class="fehrest-blog">
        <p onclick="bbvbsm1()" class="fehrest-titr">فهرست</p>
            <ul id="bbvbsm1" class="ol-fehrest-blog">
                <li>
                    <a class="text-decoration-none text-color-darkblue-5" href="#f-1">دلایل روشن نشدن ماشین لباسشویی</a> 
                </li>
                <li>
                    <a class="text-decoration-none text-color-darkblue-5" href="#f-2">چرا ماشین لباسشویی پس از روشن شدن کار نمی کند؟</a> 
                </li>
            </ul>
        
        </div>
    <br>
        <p id="f-1" class="blog-alarm">ماشین های لباسشویی مانند همه ی لوازم الکترونیکی می توانند با مشکل روشن نشدن مواجه شوند .</p>
    <br>
        <p class="blog-text-p">
        در ادامه دلایل روشن نشدن ماشین لباسشویی را بررسی می کنیم :
        <br>
        <br>
        مهم ترین دلیل روشن نشدن ماشین لباسشویی اتصال نداشتن ان به برق می باشد
            <br> 
        مانند زمانی که پریز برق ایراد داشته باشد 
            <br>
        محافظی که لباسشویی را به ان متصل کردید ایراد داشته باشد 
            <br>
        دکمه ی روشن شدن دستگاه معیوب شده باشد 
            <br>
        سیم ورودی برق دستگاه مشکل داشته باشد
            <br>
        سوییچ درب دستگاه مشکل داشته باشد 
        <br>
        و...
        </p>
        <br><br>
        <br>
            <img class="style-of-orginal-brand-image" src="img/blog/9002/2.jpg" alt="تعمیرات کولرگازی ارج">
        <br>  
        <br><br>
        <div class="fehrest-blog">
        <a class="text-decoration-none text-color-darkblue-5" href="RepairWashingMachineOfBEKO.php">
        <p id="f-2" class="fehrest-titr">بیشتر بدانید : تعمیرات لباسشویی بکو</p>
        </a>
        </div>
        <br>
        <br>
        <p class="blog-alarm">چرا ماشین لباسشویی پس از روشن روشن کار نمی کند ؟</p>
        <br>
        <br>
        <p class="blog-text-p">
        در بعضی مواقع ماشین لباسشویی روشن می شود اما فعالیتی انجام نمی دهد یا به عبارتی برنامه های درخواستی شما را اجرا نمی کند. 
        دلایل این مشکل عبارتند از :
        <br>
        <br>
        خرابی دکمه های پنل نمایشگر ماشین لباسشویی 
            <br> 
        شکستگی پنل نمایشگر ماشین لباسشویی (این مورد باید توسط تکنسین تعمیرات لوازم خانگی بررسی شود)
        </p>
        <p class="blog-text-p">
        خرابی موتور ماشین لباسشویی 
        <br>
        موتور لباسشویی وظیفه ی تامین نیروی گشتاور دستگاه شما را بر عهده دارد . یکی از دلایل کار نکردن ماشین لباسشویی خرابی موتور آن است .
        </p>
        <br>
        <div class="fehrest-blog">
        <a class="text-decoration-none text-color-darkblue-5" href="RepairWashingMachineOfBEKO.php">
        ...
        <br>
        <p class="blog-text-p">
        خرابی برد اصلی ماشین لباسشویی 
        <br>
        برد الکترونیکی وظیفه ی فرماندهی دستگاه های الکترونیکی را بر عهده دارد . یکی دیگر از دلایل خرابی ماشین لباسشویی ایرادات مربوط به برد الکترونیکی دستگاه شماست .
        برای اطلاعات بیشتر در مورد برد الکترونیکی به <a class="text-decoration-none text-color-darkblue-5" href=""> این لینک </a> مراجعه کنید .
            <br> 
        و...
        </p>
        <br>
        <p class="blog-text-p">
        در برخی موارد مشکل عدم پاسخگویی ماشین لباسشویی به دستورات شما مربوط به دکمه های دستگاه شماست . 
        <br>
        ابتدا به موارد زیر دقت کنید :
        <br>
        در برخی از مدل های ماشین لباسشویی باید دکمه ها را چند ثانیه نگه دارید تا دستور شما ثبت شود 
            <br>
        تک تک دستورات شما باید از طریق پنل لمسی یا دکمه های پنل ماشین لباسشویی به دستگاه منتقل شود 
            <br> 
        یکی از روش های رفع مشکل کار نکردن دکمه های پنل نمایشگر ماشین لباسشویی ، ریست کردن دستگاه است . 
        <br>
        </p>
        <br>
        <div class="fehrest-blog">
        ...
        <br>
        <p class="blog-alarm">با استفاده از همین روش شما می توانید مشکل هنگ کردن دکمه های ماشین لباسشویی خود را نیز رفع نمایید.</p>
        <br>
        <div  class="fehrest-blog">
        <p onclick="bbvbsm2()" class="fehrest-titr text-color-red-5">مطالب پیشنهادی</p>

...
<head>
    ...
    <title> تعمیرات لوازم خانگی هیوندا | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی هیوندا 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/HYUNDAI.png"                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی هیوندا</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) هیوندا در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی هیوندا را در مدل ها و محصولات مختلف هیوندا، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/HYUNDAI.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/HYUNDAI/factory1.png" alt="کارخانه ی هیوندا">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/HYUNDAI/factory2.png" alt="کارخانه ی هیوندا">
        </div>
        <p class="about-brand-title">درباره شرکت هیوندا</p>
        <p class="about-brand-text">
        
  هیوندای موتور، (هانگول: 현대 자동차 주식회사 و هانجا: 現代自動車株式會社) شرکت خودروسازی کره‌ای و چندملیتی است، که در سال ۱۹۶۷ توسط چانگ جو-یانگ (بنیانگذار گروه شرکت‌های هیوندای) تأسیس شد.
  ...
  این شرکت مالک بزرگترین کارخانه یکپارچه تولید خودرو در جهان می‌باشد، که در شهر اولسان قرار دارد و سالیانه بالغ بر ۱٫۶ میلیون اتومبیل تولید می‌کند. امروزه شرکت هیوندای محصولات خود را از طریق ۶ هزار مرکز فروش و نمایندگی رسمی، که در ۱۹۳ کشور جهان مستقر می‌باشند، عرضه می‌دارد
        </p>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/HYUNDAI.png"                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت هیوندا</p>
        <p class="about-brand-text">
        
  هسته اولیه گروه شرکت‌های هیوندای در سال ۱۹۴۶ توسط چانگ جو-یانگ تأسیس شد و در طول دهه نخست فعالیتش، با استفاده از حمایت‌های دولتی، انواع فعالیت‌های صنعتی همچون: ساخت‌وساز، فولادسازی، کشتی‌سازی، خدمات پشتیبانی، تجارت، الکترونیک و خدمات مالی را تحت پوشش قرار داد و در ابتدای دهه ۱۹۶۰ به بزرگترین شرکت خوشه‌ای کره جنوبی تبدیل شد.

  چانگ جو-یانگ در سال ۱۹۶۷ هیوندای موتور را به‌عنوان شرکت تابعه گروه هیوندای و بازوی خودروسازی این گروه صنعتی تأسیس نمود. نخستین خودروی عرضه شده توسط این شرکت، فورد کورتینا بود، که با مشارکت مستقیم شرکت فورد، در کره جنوبی مونتاژ می‌شد. مالکین شرکت هیوندای با هدف ساخت خودرویی مستقل، مدیرعامل اسبق شرکت خودروسازی انگلیسی بریتیش لیلاند؛ جورج ترنبول را استخدام کردند. ترنبول نیز ۵ مهندس بریتانیایی را برای پیشبرد توسعه و ساخت اتومبیل بکار گرفت.
  
  مدیران هیوندای با مشارکت شرکت‌های ایتال‌دیزاین به منظور طراحی خودرو و میتسوبیشی موتورز برای تأمین اجزای تولیدی و اکسل، اولین اتومبیل کره‌ای، یعنی هیوندایی پونی را در سال ۱۹۷۵ تولید کردند، که در پی آن صادرات نخستین محصول بخش خودروسازی هیوندای، به کشور اکوادور نیز در همان سال آغاز شد. هیوندای پونی عنوان سازنده پرفروش‌ترین اتومبیل کره‌ای را برای شرکت هیوندای به ارمغان آورد و هنوز هم این اتومبیل بدون رقیب باقی‌مانده‌است.
  
  نسل دوم از خودروی هیوندای پونی در سال ۱۹۸۲ نقطه عطف دیگری را رقم زد و اولین صادرات در مقیاس وسیع خودروهای هیوندای شکل گرفت. اتومبیل کوچک پونی با بهره‌مندی از سود درآمد کارکنان کره‌ای، بازار اتومبیل کوچک کانادا را در سال ۱۹۸۳ دگرگون ساخت. پس از آن بود که دنیای خودروسازی از به وجود آمدن یک سازنده دیگر اتومبیل در آسیای جنوب شرقی مطلع شد.
  
  تا سال ۱۹۹۱ شرکت هیوندای طیف اتومبیل‌هایش را به هیوندای الانترا بزرگتر، هیوندایی سوناتا و اولین کوپه‌اش توسعه داده بود. در همان سال اولین موتور آلفا ۱٫۵ لیتر را تولید نمود. میزان فروش مخصوصاً در همه بازارهای مهم آمریکا سریعاً در حال افزایش بود. با این حال این رشد اساساً به دلیل قیمت معامله پائین خودروهای هیوندای بود. حتی در دهه ۱۹۹۰ اتومبیل‌های هیوندای هنوز برای کیفیت ضعیف ساخت و کم توجهی به جزئیات، انگشت‌نما بودند.
  
  در سال ۱۹۹۷ بحران مالی آسیا، ضرر زیادی به صنعت خودروسازی کره جنوبی وارد ساخت، اما شرکت هیوندای از این فرصت استفاده کرد، تا شرکت کیا موتورز که ورشکست شده بود را، خریداری و تصاحب نماید و موقعیت پیشتاز خود در بازار داخلی کره را تقویت کند. با این وجود، این بحران قسمت تاریک فروش چند صنعتی را در شرکت مادر؛ یعنی هیوندای آشکار ساخت.
  
  در پی فشارهای دولت وقت کره جنوبی، سرانجام مالکین هیوندای، اقدام به تفکیک گروه هیوندای نمودند، که پس از تکمیل فرایند تفکیک بخش‌های مختلف این گروه، در سال ۱۹۹۸ چانگ مونگ-کو، فرزند ارشد چانگ جو-یانگ (بنیانگذار شرکت‌های هیوندای) کنترل بخش خودروسازی را در دست گرفت، که امروزه همچنان نیز در جایگاه مدیر عامل اجرایی و رئیس هیئت مدیره هیوندای موتور، سکان رهبری آن را در دست دارد. چانگ پس از تحویل شرکت، در سال‌های نخست، مدیریت را از نو سازماندهی کرد، کنترل کیفی را ارتقا بخشید و سرمایه‌گذاری در زمینه تحقیق و توسعه را افزایش داد.
  
  پس از جدا شدن از گروه هیوندای در سال ۲۰۰۰ شرکت هیوندای موتور توانست به همراه کیا موتورز، زیر چتر هیوندای موتور گروپ، تنها بر روی صنعت خودروسازی تمرکز کند.[۳][۴] از آن زمان به بعد هیوندای موتور تحت مدیریت چانگ مونگ-کو، موفق شده تا حد چهارمین خودروساز بزرگ جهان، به همراه کیا و خود به تنهایی، تا رتبه هشتمین شرکت بزرگ خودروسازی جهان، رشد کند. برنامه هیوندای، پیشروی تا به دست آوردن مقام پنجم تا سال ۲۰۱۴ است.[۵] در اروپا نیز امروزه سایت‌های تولید و نیز طراحی توسط هیوندای ایجاد شده‌اند.
  
  در طول دهه ۲۰۰۰ میلادی، اتومبیل‌های هیوندای به صورت وسیع در کیفیت ساخت، تکنولوژی و حتی ظاهر، توسعه یافتند، که تغییر ظاهر اتومبیل‌ها و طراحی بدنه آنها، توسط مراکز طراحی جدیدی که از سال ۲۰۰۱ به بعد، راه‌اندازی شده بودند، انجام می‌شود.
  
  تولید نسل چهارم از هیوندای سوناتا، در ابتدای دهه ۲۰۰۰ میلادی، با اتومبیل‌های ژاپنی پُرفروش و جدید مخصوص خانواده، در بازار ایالات متحده آمریکا به رقابت پرداخت، در حالی‌که مدل‌های هیوندای آی۱۰، هیوندای آی۲۰ و هیوندای آی۳۰، بازار اروپا را هدف قرار داده بودند و فروش زیادی را در اروپا به خود اختصاص دادند. این شرکت در سال ۲۰۰۸ هیوندای جنسیس را عرضه کرد، که رقیب خودروهای سایز بزرگ لکسوس و ایهیونداینیتی به‌شمار می‌آید.
  
  کارخانه جدید در جمهوری چک طبق برنامه ظرفیت تولید سالانه‌ای در حدود ۳۰۰٫۰۰۰ خودرو را خواهد داشت. بعلاوه هیوندای هم‌اکنون بزرگترین کارخانه یکپارچه و سایت مجتمع تولید خودروی جهان، با ظرفیت تولیدی معادل ۱٫۶ میلیون دستگاه در سال را در اختیار دارد، که در شهر اولسان، کره جنوبی مستقر می‌باشد.
  
  امروزه در کره جنوبی، هیوندای موتور به تنهایی بیش از ۵۰٪ درصد از بازار فروش خودرو را به خود اختصاص داده‌است. شرکت هیوندای موتور با پشتیبانی مالی جام جهانی ۲۰۰۶ آلمان نیز وجهه خود را بخوبی بهبود بخشید. در حدود ۱٫۰۰۰ دستگاه خودروی هیوندای، در این دوره از جام جهانی فوتبال، در کشور آلمان، فعال بودند.
  
  لوک دانکروول، مدیر طراحی هیوندای است.
        </p>
    </div>
    <div class="left">

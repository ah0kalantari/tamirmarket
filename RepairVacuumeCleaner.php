...
<head>
    ...
    <title> تعمیرات جاروبرقی تعمیر مارکت | Tamir Market Washing Machine repair</title>
</head>
<body class="styles-of-body-tag">
                                         ...
                                         <ul id="style-of-zirmenu-of-tamirat" class="style-of-zirmenu-of-tamirat">
                                            <li onmouseover="showzirmajmoee2()" onmouseout="hidezirmajmoee2()" class="style-of-sdf background-color-0e4797-hover"><a class="style-of-text-of-zirmenus style-of-sdf"  >لوازم خانگی</a>
                                                <ul id="style-of-zirmenu-of-tamirat2" class="style-of-zirmenu-of-tamirat2" class="style-of-all-of-zirmajmoee">
                                                    ...
                                                    <li class="style-of-sdf"><a class="style-of-text-of-zirmenus style-of-sdf" href="RepairDishwasher.php"> جاروبرقی</a></li>
                                                    ...
                                                    <li class="style-of-sdf"><a class="style-of-text-of-zirmenus style-of-sdf" href="RepairVacuumeCleaner.php"> کولر آبی/گازی</a></li>
                                             ...
                                             <ul>
                                                <li class="style-of-menu-text-in-mo" onclick="displayOfZirMenuInMo2()"><a>لوازم خانگی</a><hr class="white-hr">
                                                    <ul id="display-of-zir-menu-in-mo2" class="display-of-zir-menu-in-mo2">
                                                        ...
                                                        <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="RepairDishwasher.php"> جاروبرقی</a></li><hr class="white-hr">
                                                        ...
                                                        <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="RepairVacuumeCleaner.php"> کولر آبی/گازی</a></li><hr class="white-hr">
                                                        <li class="style-of-sdf"><a class="style-of-text-of-zirmenus style-of-sdf" title="تعمیرات جاروبرقی | تعمیر مارکت" href="RepairVacuumeCleaner.php"> جاروبرقی </a></li>
    ...
    <h2 class="style-of-moarefi-shoql">
        ...
        <br>
        لباسشویی , جاروبرقی, ساید بای ساید , یخچال, کولر گازی و آبی, مایکروویو , جاروبرقی
    </h2>
    <br>
    <br>
    <div id="slider">
        <div class="slide activate">
            <img src="img/slide show/VC/1.webp" alt="تعمیرات جاروبرقی در استان های تهران و البرز">
        </div>

        <div class="slide">
            <img src="img/slide show/VC/2.webp" alt="تعمیرات جاروبرقی در استان های تهران و البرز">
        </div>
    ...
    <h1 class="animation-of-title-brand">
        تعمیرات تخصصی انواع جاروبرقی 
    </h1>
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات جاروبرقی تعمیر مارکت :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات انواع جاروبرقی</p>
        <p class="style-of-mazit-estfade-az-ma-text">  2) استفاده از لوازم و قطعات اصلی (اورجینال ) در تعمیرات جاروبرقی </p>
        ...
        <br><br>
            ...
            <br>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfLG.php">             <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/LG.webp"                    alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfSAMSUNG.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/SAMSUNG.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfDAEWOO.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/DAEWOO.webp"                alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfSNOWA.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/SNOWA.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfPARS.php">           <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PARS.webp"                  alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfBEHI.php">           <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/BEHI.webp"                  alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfAEG.php">            <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/AEG.webp"                   alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfBOSCH.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/BOSCH.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfSIEMENC.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/SIEMENC.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfKENWOOD.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/KENWOOD.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfINDESIT.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/INDESIT.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfCANDY.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/CANDY.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfARJ.php">            <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ARJ.webp"                   alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfHIMALIA.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HIMALIA.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfSEPEHRELECTRICE.php"><img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/SEPEHR ELECTRICE.webp"      alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfPAKSHOOMA.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PAKSHOOMA.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfEMERSAN.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/EMERSAN.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfHAIER.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HAIER.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfYAKHSARAN.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/YAKHSARAN.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfBARFAB.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/BARFAB.webp"                alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfBEKO.php">           <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/BEKO.webp"                  alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfELECTROLUX.php">     <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ELECTROLUX.webp"            alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfPHIVER.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PHILVER.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfSHARP.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/SHARP.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfMOULINEX.php">       <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/MOULINEX.webp"              alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfPANASONIC.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PANASONIC.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfHARDSTONE.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HARDSTONE.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfPHILIPS.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PHILIPS.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfCORAL.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/CORAL.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfTOSHIBA.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/TOSHIBA.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfKENMORE.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/KENMORE.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfHOOVER.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HOOVER.webp"                alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfZANUSSI.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ZANUSSI.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfZEROWATT.php">       <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ZEROWATT.webp"              alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfGENERALELECTRIC.php"><img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/GENERAL ELECTRIC.webp"      alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfBAUKNECHT.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/BAUKNECHT.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfMIDEA.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/MIDEA.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfWHIRLPOOL.php">      <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/WHIRLPOOL.webp"             alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfFAGOR.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/FAGOR.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfHOTPOINT.php">       <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HOTPOINT.webp"              alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfVESTEL.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/VESTEL.webp"                alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfARISTON.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ARISTON.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfMABE.php">           <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/MABE.webp"                  alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfGORENJE.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/GORENJE.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfPHILCO.php">         <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/PHILCO.webp"                alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfWESTINGHOUSE.php">   <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/WESTINGHOUSE.webp"          alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfAZMAYESH.php">       <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/AZMAYESH.webp"              alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfELECTROSTILL.php">   <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ELECTROSTILL.webp"          alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfOGENERAL.php">       <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/OGENERAL.webp"              alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfHYUNDAI.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/HYUNDAI.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfMAGIC.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/MAGIC.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfADMIRAL.php">        <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/ADMIRAL.webp"               alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfAMANA.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/AMANA.webp"                 alt="تعمیر مارکت"></a></div>
                    <div class="scale-brand-img"><a href="RepairVacuumeCleanerOfTEFAL.php">          <img class="style-of-brand-img-in-lavazem-khangy-page" src="img/brand images/TEFAL.webp"                 alt="تعمیر مارکت"></a></div>
            <br><br><br>
        ...
        (لباسشویی، جاروبرقی، یخچال، ماکروویو، جاروبرقی و جاروبرقی) در خدمت شماست.
        <br>
        ...
        <br><br>
        <p class="about-brand-title">کار هایی برای پیشگیری از خراب شدن جاروبرقی </p>
        <p class="about-brand-text">
            1) تعویض به موقع فیلتر جاروبرقی
            <br><br>
            2) جاروبرقی را بیشتر از ۱۵ دقیقه نگه ندارید!
            <br><br>
            3) خالی کردن به موقع کیسه جاروبرقی
            <br><br>
            4) مراقبت برای پاره نشدن لوله جاروبرقی.
            <br><br>
            5)  سیم جاروبرقی را تاانتها بیرون نکشید
            <br><br>
            6) مراقبت از چرخ های جاروبرقی در هنگام کار کردن با آن
            <br><br>
            7) از پا برای روشن و خاموش کردن جاروبرقی استفاده نکنید.
            <br><br>    
        </p>
        <p class="about-brand-title">درباره جاروبرقی</p>
        <p class="about-brand-text">
            جاروبرقی وسیله‌ای است که به وسیلهٔ مکش، کثافات و گرد و غبار را جمع‌آوری می‌کند. بعضی از جاروبرقی‌ها نیز به وسیله آب کار می‌کنند. اولین جاروبرقی توسط شخصی به نام آیوز مک‌گافی اختراع گردید و در ۸ ژوئن ۱۸۶۹ این اختراع، در آمریکا به ثبت رسید. باوجوداین، برخی بر این باورند که سازندهٔ این دستگاه فردی آمریکایی به‌نام دنیل هس می‌باشد. از سال ۲۰۱۴ میلادی و طبق قوانین اتحادیه اروپا تولید جاروبرقی با مصرف برق بیش از ۱۶۰۰ وات ممنوع و از سال ۲۰۱۷ نیز این میزان به ۹۰۰ وات تقلیل یافت.[۳] آزمایش‌ها نشان داده‌است که جاروبرقی می‌تواند تا ۱۰۰٪ کک‌های جوان و تا ۹۶٪ کک‌های بالغ و بزرگسال را از بین ببرد.

            خرده آشغال‌ها در یک کیسه گرد و غبار یا سیکلون جمع می‌شود تا بعداً دور ریخته شود. جاروبرقی‌ها که در خانه‌ها و همچنین در صنعت استفاده می‌شوند، در اندازه‌ها و مدل‌های مختلفی وجود دارد؛ از دستگاه‌های دستی کوچک باتری ای تا جاروبرقی‌های مرکزی خانگی.<br><br>
        <p class="about-brand-title">انواع جاروبرقی</p>
        <div class="style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/0001.webp"       alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/0002.webp"        alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/0003.webp"             alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/0004.webp"            alt="تعمیر مارکت">
         </div>
        <p class="about-brand-text">
            رایج‌ترین گونه‌های جاروبرقی عبارتند از
            <br>
            جاروبرقی خانگی
            <br>
            جاروبرقی هوشمند
        ...
        <br><br>
        <p class="about-brand-title">موتور جاروبرقی چیست ؟</p>
        <div class="style-of-ItemTamirat-radif style-of-ItemTamirat-radif-in-brand-page">
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/Q/1.webp"       alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/Q/2.webp"        alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/Q/3.webp"             alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/Q/4.webp"            alt="تعمیر مارکت">
            </div>
        </div>
        <p class="about-brand-text">
            موتور جاروبرقی به طور کلی وظیفه ی ایجاد مکش برای جمع کردن زباله ها را بر عهده دارد 
        </p>
        <br><br>
        <p class="about-brand-title">برس جاروبرقی</p>
        <div class=" style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/Q/9.webp"       alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/Q/10.webp"        alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/Q/11.webp"             alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/Q/12.webp"            alt="تعمیر مارکت">
         </div>
        <br><br>
         <p class="about-brand-text">
            برس جاروبرقی وظیفه ی هدایت مکش برای جمع کردن زباله ها را بر عهده دارد 
        </p>
        <br><br>
        <p class="about-brand-title">لوله خرطومی جاروبرقی</p>
        <div class="style-of-ItemTamirat-radif style-of-ItemTamirat-radif-in-brand-page">
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/Q/5.webp"       alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
               <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/Q/6.webp"        alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/Q/7.webp"             alt="تعمیر مارکت">
            </div>
            <div class=" style-of-ItemTamirat-div">
                <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/Q/8.webp"            alt="تعمیر مارکت">
            </div>
        </div>
        <br><br>
        <p class="about-brand-title">برد الکترونیکی جاروبرقی</p>
        <div class=" style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/Q/21.webp"       alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
            <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/Q/22.webp"        alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/Q/23.webp"             alt="تعمیر مارکت">
         </div>
         <div class=" style-of-ItemTamirat-div">
             <img class="style-of-ItemTamirat-img" src="img/Lavazem Khanegy Images/VC/Q/24.webp"            alt="تعمیر مارکت">
         </div>
        <p class="about-brand-text">
            وظیفه برد الکترونیکی کولر گازی کنترل و فرماندهی تمامی عملکرد های جاروبرقی شماست.
        </p>
        <br><br>
        <p class="about-brand-title">نکاتی در مورد نگهداری جاروبرقی</p>
        <p class="about-brand-text">
            1) تعویض به موقع فیلتر جاروبرقی
            <br><br>
            2) جاروبرقی را بیشتر از ۱۵ دقیقه نگه ندارید!

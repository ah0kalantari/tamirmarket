...
<head>
    ...
    <title> تعمیرات لوازم خانگی زیمنس | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی زیمنس 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/SIEMENC.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی زیمنس</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) زیمنس در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی زیمنس را در مدل ها و محصولات مختلف زیمنس، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/SIEMENC.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/SIEMENC/factory1.png" alt="کارخانه ی زیمنس">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/SIEMENC/factory2.png" alt="کارخانه ی زیمنس">
        </div>
        <p class="about-brand-title">درباره شرکت زیمنس</p>
        <p class="about-brand-text">
       
  زیمنس آگ (به آلمانی: Siemens AG)، ابرشرکت خوشه‌ای آلمانی و چندملیتی است، که در سال ۱۸۴۷ توسط ارنست فون زیمنس در شهر برلین تأسیس شد. امروزه ابرشرکت زیمنس در زمینه تولید تجهیزات مخابراتی و نورپردازی، لوازم خانگی، انواع قطار، انواع توربین، سامانه‌های خودکارسازی صنعتی، تجهیزات پزشکی و سامانه‌های اعلام حریق فعالیت می‌کند.
  ...
  عملیات ابرشرکت زیمنس به پنج بخش اصلی انرژی، صنعتی، پزشکی، موبیلیتی و زیرساخت‌های شهری تقسیم می‌شود. هم‌اکنون شمار کارکنان زیمنس بالغ بر ۳۶۰ هزار نفر می‌باشد، که در ۱۹۰ کشور جهان اشتغال دارند. دفتر مرکزی این ابرشرکت در شهر مونیخ، آلمان قرار دارد. 
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/SIEMENC.png""                    alt="سانیاران سرویس"></a></div>
        <p class="about-brand-title">تاریخچه شرکت زیمنس</p>
        <p class="about-brand-text">
  ...
  در سال‌های پس از این شرکت رشد و ترقی خود را با ساختن موتورهای برقی و لامپ ادامه داده و در سال ۱۸۹۷ نام شرکت از Bauanstalt von Siemens & Halske به (S&H) تغییر کرد.در سال ۱۹۱۹ شرکت زیمنس با همکاری دو شرکت دیگر به‌طور مشترک شرکت اوسرام OSRAM بنیان نهادند و در سال ۱۹۲۳ شرکت‌های فرعی و زیرمجموعه آن در ژاپن تأسیس گشت. </p>
    </div>
    <div class="left">

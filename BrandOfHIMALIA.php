...
<head>
    ...
    <title> تعمیرات لوازم خانگی هیمالیا | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی هیمالیا 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/HIMALIA.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی هیمالیا</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) هیمالیا در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی هیمالیا را در مدل ها و محصولات مختلف هیمالیا، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/HIMALIA.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/HIMALIA/factory1.png" alt="کارخانه ی هیمالیا">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/HIMALIA/factory2.png" alt="کارخانه ی هیمالیا">
        </div>
        <p class="about-brand-title">درباره شرکت هیمالیا</p>
        <p class="about-brand-text">
  شرکت هیمالیا با توجه به استقرار در یک موقعیت جغرافیایی مناسب و دسترسی آسان به راههای ارتباطی جهت توزیع سریع به سایر استانهای کشور و همچنین کشورهای همسایه در راستای برقراری یک رابطه شایسته به مشتریان (مصرف کنندگان ) خود می باشد. شرکت هیمالیا با ایجاد یک واحد لجستیک و داشتن تعداد زیادی خودروهای حمل محصولات توانسته هماهنگی خوبی را در جهت توزیع عمده و مویرگی خود ایجاد نماید که در این مهم از افراد متخصص در زمینه فروش نیز که سابقه طولانی در عرصه لوازم خانگی دارند بهره می برد.<div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/HIMALIA.png""                    alt="سانیاران سرویس"></a></div>
        </p>
    </div>
    <div class="left">

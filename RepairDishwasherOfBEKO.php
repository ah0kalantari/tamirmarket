...
<head>
    ...
    <title>تعمیرات ظرفشویی بکو | سانیاران سرویس</title>
</head>
<body class="styles-of-body-tag">
    ...
    <div id="slider"></div>
    <div class="right">
    <img class="style-of-orginal-brand-image" src="img/OrginalBrandImage/zarfshooi/ل بکو.jpg" alt="تعمیرات ظرفشویی بکو">
    <br><br>
        <h2 class="animation-of-title-brand">
            تعمیرات تخصصی ماشین ظرفشویی بکو 
        </h1>
        ...
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات ظرفشویی بکو</p>
        ...
        (ظرفشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) بکو در خدمت شماست.
        <br>
...
<table class="display-none-pc">
 ...
 <!-- ============================================================================================================================================================================================================================================================== -->
        ...
        <img class="style-of-orginal-brand-image" src="img/Lavazem Khanegy Images/DW/001.png" alt="تعمیرات ظرفشویی بکو">
        <br><br>

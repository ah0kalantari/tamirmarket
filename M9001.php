...
<body>
                                         ...
                                         <ul id="style-of-zirmenu-of-tamirat" class="style-of-zirmenu-of-tamirat">
                                            <li onmouseover="showzirmajmoee2()" onmouseout="hidezirmajmoee2()" class="style-of-sdf background-color-0e4797-hover"><a class="style-of-text-of-zirmenus style-of-sdf"  >لوازم خانگی</a>
                                                <ul id="style-of-zirmenu-of-tamirat2" class="style-of-zirmenu-of-tamirat2" class="style-of-all-of-zirmajmoee">
                                                    ...
                                                    <li class="style-of-sdf"><a class="style-of-text-of-zirmenus style-of-sdf" href="RepairDishwasher.php"> کولرگازی</a></li>
                                             ...
                                             <ul>
                                                <li class="style-of-menu-text-in-mo" onclick="displayOfZirMenuInMo2()"><a>لوازم خانگی</a><hr class="white-hr">
                                                    <ul id="display-of-zir-menu-in-mo2" class="display-of-zir-menu-in-mo2">
                                                        <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="RepairWashingMachine.php"> کولرگازی</a></li><hr class="white-hr">
                                                        ...
                                                        <li class="style-of-menu-text-in-mo"><a class="style-of-menu-text-in-mo" href="RepairDishwasher.php"> کولرگازی</a></li><hr class="white-hr">
    ...
    <div class="right">
    <br> 
    <table class="blog-etelaat display-none-mo">
        <captiion>
            <h1 class="blog-titr">
        ...
        <tr>
            <td class="blog-etelaat-left">
            آموزش / آموزش تعمیرات لوازم خانگی / آموزش تعمیرات لباسشویی
            </td>
            <td class="blog-etelaat-right">
            ۱۴۰۰ / ۱۰ / ۱۰
            </td>
        </tr>
        <tr>
            <td class="blog-etelaat-left">
            زمان مطالعه : در حال بررسی 
            </td>
            <td class="blog-etelaat-right">
            نویسنده : تیم توسعه و تولید محتوای تعمیر مارکت
            </td>
        </tr>
    </table>
    <!-- اطلاعات مقاله ابعاد کامپیوتر در بالا -->
    <!-- اطلاعات مقاله ابعاد موبایل در پایین -->
    <table class="blog-etelaat display-none-pc">
        <tr>
            <td class="blog-etelaat-left">
            آموزش / آموزش تعمیرات لوازم خانگی / آموزش تعمیرات لباسشویی
            </td>
    ...
    <br> 
    <br>
    <img class="style-of-orginal-brand-image" src="img/blog/9001/1.webp" alt="تعمیرات کولرگازی ارج">
    <br>   
    <br> 
        ...
        <a href="RepairWashingMachineOfZANUSSI.php">
            <img class="blog-tabliq-gif" src="img/blog/9001/3.webp" alt="zanussi tabliq تبلیغ زانوسی تعمیر تعمیرات">
        </a>
        <p class="blog-text-titr">صفحه کنترل  ( کنترل پنل )  ماشین لباسشویی <span class="text-color-green-4">زانوسی (ZANUSSI)</span></p>
        <br>
        <br>
        <img class="style-of-orginal-brand-image" src="img/blog/9001/1.webp" alt="برنامه های لباسشویی زانوسی">
        <br>
        <br> 
        <p class="blog-text-p">
            ...
            <br>
            <br>          
            5- 2 ماشین لباسشویی <span class="text-color-green-4">زانوسی (ZANUSSI)</span>
        ...
        <br>
        <p class="blog-text-titr">برنامه های موجود در 2 ماشین لباسشویی <span class="text-color-green-4">زانوسی (ZANUSSI)</span></p>
        <br>
        <img class="style-of-orginal-brand-image width-40-100-pc" src="img/blog/9001/2.webp" alt="تعمیرات کولرگازی ارج">
        <br> 
        <p class="blog-text-p">

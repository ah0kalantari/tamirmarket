...
<head>
    ...
    <title> تعمیرات لوازم خانگی تفال | تعمیرات لوازم خانگی چتر سبز</title>
</head>
<body class="styles-of-body-tag">
    ...
    <h2 class="animation-of-title-brand">
        تعمیرات تخصصی لوازم خانگی تفال 
    </h1>
    <div><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/TEFAL.png""                    alt="سانیاران سرویس"></a></div>    
    <div class="right">
        <p class="style-of-mazit-estfade-az-ma">مزیت استفاده از خدمات تعمیرات لوازم خانگی سانیاران سرویس :</p>
        <p class="style-of-mazit-estfade-az-ma-text">  1) استفاده از برترین تعمیرکاران(سرویس کاران) و متخصصین در تعمیرات لوازم خانگی تفال</p>
        ...
        (لباسشویی، ظرفشویی، یخچال، ماکروویو، جاروبرقی و کولرگازی) تفال در خدمت شماست.
        <br>
        ...
        <br>
        تمام تعمیرکاران و تکنسین های ما دوره های آموزشی تعمیرات لوازم خانگی تفال را در مدل ها و محصولات مختلف تفال، گذرانده اند.
        <br>
        ...
        <br><br>
        <div class="scale-brand-img"><a><img class="style-of-brand-img-in-brand-page style-of-brand-img" src="img/brand images/TEFAL.png"                    alt="سانیاران سرویس"></a></div>
        <br><br>
        <div>
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/TEFAL/factory1.png" alt="کارخانه ی تفال">
            <img class="style-of-factory-img-in-brand-page" src="img/brand images/TEFAL/factory2.png" alt="کارخانه ی تفال">
        </div>
        <p class="about-brand-title">درباره شرکت تفال</p>
        <p class="about-brand-text">
            تفال قسمتی از کمپانی گروپ سب SEB فرانسه است. این برند کار خود را از سال ۱۹۵۶ شروع کرد. جالب است بدانید که همه چیز از یک ایده ساده شروع شد! مارک گروگر در حالی که همسرش را سخت درگیر تخم مرغی که به ماهیتابه چسبیده بود دید، ایده‌ای به سرش زد. چرا ماهیتابه‌ای نداشته باشند که حتی با چربی خیلی کم هم غذا به آن نچسبد؟ بله این شروع انقلابی در تولید ظروف آشپزخانه بود؛ یعنی ایده اولیه ظروف تفلون. نام تفال (Tefal) از کنار هم قرار گرفتن ابتدای واژه‌های Teflon و Aluminium ساخته شده است.

            این برند که کارش را با محصولی برای سهولت در آشپزی شروع کرد، در ادامه هم همین مسیر را پیش گرفت. بر همین اساس تنها شعار این کمپانی این است که « زندگی روزمره خود را ساده‌تر کنید». این برند در طول سال‌های فعالیتش، سعی کرده راه حل‌های جدید و خلاقانه‌ای را برای مشتریان خود ارائه دهد. برند تفال سردمدار وسایل آشپزخانه نچسب و پیش‌قدم در تولید اتو، وسایل آشپزی، زودپز، ظروف نگهدارنده غذا و نوشیدنی است. تفال در حال حاضر در ۱۲۰ کشور حضور دارد و بیش از پیش به شما نزدیک‌ است.
